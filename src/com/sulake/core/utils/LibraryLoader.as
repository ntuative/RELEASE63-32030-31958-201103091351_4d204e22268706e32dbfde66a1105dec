package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_1686:uint = 1;
      
      protected static const const_1687:uint = 2;
      
      protected static const const_1688:uint = 4;
      ...
      public static const const_1055:Boolean = false;
      ...
      protected var var_700:XML;
      
      protected var var_573:Class;
      ...
      protected var var_2781:String = "";
      
      protected var var_2021:int;
      ...
      protected static function throttle() : void
      {
         ...
         if(const_1055)
         {
            ...
            while(var_786.length < const_1580 && false)
            {
               _loc1_ = var_987.shift() as LibraryLoader;
      ...
      {
         return !!this.var_1006 ? uint(this.var_1257 - this.var_2021) : uint(getTimer() - this.var_2021);
      }
      ...
      {
         if(!this.var_1006 && !_disposed && this.var_1256 > 0)
         {
            try
            {
               this.var_42.close();
            ...
            this.addRequestCounterToUrlRequest(this.var_232,const_1569 - this.var_1256);
            if(this.var_2782)
            {
      ...
      protected function prepareLibrary() : Boolean
      {
         ...
         this.var_573 = this.getDefinition(this._name) as Class;
         ...
         try
         {
            xmlClass = this.var_573.manifest as Class;
            if(xmlClass == null)
            {
               return false;
            }
         ...
         try
         {
            this.var_700 = new XML(bytes.readUTFBytes(bytes.length));
         }
         catch(e:Error)
         {
            if(!retry())
