package com.sulake.core.communication.connection
{
   ...
   public class SocketConnection extends EventDispatcher implements IConnection, IDisposable
   {
      ...
      public static const const_1437:int = 10000;
      ...
      private var var_1118:IEncryption;
      
      private var var_726:IProtocol;
      ...
      public function SocketConnection(param1:String, param2:ICoreCommunicationManager, param3:IConnectionStateListener)
      {
         ...
         this.var_355 = new Timer(const_1437,1);
      ...
      public function send(param1:IMessageComposer, param2:int = -1) : Boolean
      {
         ...
         var _loc5_:ByteArray = this.var_726.encoder.encode(_loc4_,param1.getMessageArray(),param2);
         if(this.var_488)
         {
            this.var_488.messageSent(String(_loc4_),_loc5_.toString());
         }
         if(this.var_1118 != null)
         {
            _loc3_ = this.var_1118.encipher(_loc5_);
         }
         else
         {
            _loc3_ = _loc5_;
      ...
      override public function toString() : String
      {
         ...
         _loc1_ += "Protocol Encoder: " + this.var_726.encoder + "\n";
         _loc1_ += "Protocol Decoder: " + this.var_726.decoder + "\n";
         return _loc1_ + ("Encryption: " + this.var_1118 + "\n");
      }
      ...
      public function processReceivedData() : void
      {
         ...
         var offset:uint = this.var_726.getMessages(this.var_487,receivedMessages);
         try
         {
      ...
      private function onRead(param1:ProgressEvent) : void
      {
         ...
         {
            this.var_487.writeByte(this.var_81.readUnsignedByte());
         }
      }
      ...
      private function onConnect(param1:Event) : void
      {
         ...
         this.var_355.stop();
         this.var_1733 = true;
         ErrorReportStorage.addDebugData("ConnectionTimer","Connected in " + (getTimer() - this.var_725));
      ...
      private function onClose(param1:Event) : void
      {
         ...
         this.var_1733 = false;
         ErrorReportStorage.addDebugData("ConnectionTimer","Closed in " + (getTimer() - this.var_725));
         dispatchEvent(param1);
      }
      ...
      private function onComplete(param1:Event) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","Completed in " + (getTimer() - this.var_725));
         dispatchEvent(param1);
      }
      ...
      private function onSecurityError(param1:SecurityErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","SecurityError in " + (getTimer() - this.var_725));
         dispatchEvent(param1);
      }
      ...
      private function onIOError(param1:IOErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","IOError in " + (getTimer() - this.var_725));
         switch(param1.type)
         {
      ...
      private function onTimeOutTimer(param1:TimerEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","TimeOut in " + (getTimer() - this.var_725));
