package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      public static const const_1201:uint = 4;
      ...
      private var var_478:InterfaceStructList;
      ...
      public function Component(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_478 = new InterfaceStructList();
      ...
      {
         var _loc3_:InterfaceStruct = this.var_478.getStructByInterface(param1);
         if(_loc3_ == null)
         {
      ...
      public function release(param1:IID) : uint
      {
         ...
         var _loc2_:InterfaceStruct = this.var_478.getStructByInterface(param1);
         if(_loc2_ == null)
         {
         ...
         if(this.var_1446 & const_1201)
         {
            if(_loc3_ == 0)
            {
               if(this.var_478.getTotalReferenceCount() == 0)
               {
      ...
      public function toXMLString(param1:uint = 0) : String
      {
         ...
         var _loc7_:uint = this.var_478.length;
         var _loc8_:int = 0;
         while(_loc8_ < _loc7_)
         {
            _loc6_ = this.var_478.getStructByIndex(_loc8_);
