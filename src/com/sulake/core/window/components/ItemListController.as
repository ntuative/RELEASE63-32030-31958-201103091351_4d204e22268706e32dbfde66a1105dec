package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow, IInputProcessorRoot
   {
      ...
      protected var var_2005:int = 0;
      
      protected var var_2004:int = 0;
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         var_167 = var_450 || !testParamFlag(WindowParam.const_32);
         this._container = _context.create("_CONTAINER","",WindowType.const_378,WindowStyle.const_688,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[TAG_INTERNAL,TAG_EXCLUDE]) as IWindowContainer;
         this._container.addEventListener(WindowEvent.const_49,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_481,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_284,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_547,this.containerEventHandler);
         this._container.clipping = clipping;
         this.resizeOnItemUpdate = this.var_1245;
      }
      ...
      {
         return new Rectangle(this.var_653 * this.maxScrollH,this.var_654 * this.maxScrollV,width,height);
      }
      ...
      public function set scrollH(param1:Number) : void
      {
         ...
         {
            this.var_653 = param1;
            this._container.x = -this.var_653 * this.maxScrollH;
            _context.invalidate(this._container,this.visibleRegion,WindowRedrawFlag.const_72);
            dispatchEvent(new WindowEvent(WindowEvent.const_493,this,null));
         }
      }
      ...
      public function set scrollV(param1:Number) : void
      {
         ...
         {
            this.var_654 = param1;
            this._container.y = -this.var_654 * this.maxScrollV;
            _context.invalidate(this._container,this.visibleRegion,WindowRedrawFlag.const_72);
            dispatchEvent(new WindowEvent(WindowEvent.const_493,this,null));
         }
      }
      ...
      public function set resizeOnItemUpdate(param1:Boolean) : void
      {
         ...
         if(this._container)
         {
            if(this._horizontal)
            {
               this._container.setParamFlag(WindowParam.const_448,param1);
            }
            else
            {
               this._container.setParamFlag(WindowParam.const_475,param1);
            }
         }
      }
      ...
      override public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            this._container.removeEventListener(WindowEvent.const_481,this.containerEventHandler);
            this._container.removeEventListener(WindowEvent.const_284,this.containerEventHandler);
            this._container.removeEventListener(WindowEvent.const_547,this.containerEventHandler);
            super.dispose();
         }
      }
      ...
      public function process(param1:WindowEvent) : Boolean
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_174:
               if(this.var_1242)
               {
                  this.var_1243 = this.var_2005 - _loc3_;
                  this.var_1244 = this.var_2004 - _loc4_;
                  if(this._horizontal)
                  {
                  ...
                  else if(this.var_1244 != 0 && this.var_94 != 0)
                  {
                     this.scrollV += this.var_1244 / this.var_94;
                  }
                  this.var_2005 = _loc3_;
                  this.var_2004 = _loc4_;
                  _loc2_ = true;
            ...
            case WindowMouseEvent.const_185:
               if(this.var_1242)
               {
                  ...
                  {
                     _context.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,0,-this.var_1244);
                  }
                  this.var_1242 = false;
                  _loc2_ = true;
               }
      ...
      protected function updateScrollAreaRegion() : void
      {
         ...
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         if(this.var_999 && !this.var_532 && this._container)
         {
            this.var_532 = true;
      ...
      override public function get properties() : Array
      {
         ...
         if(this._spacing != PropertyDefaults.const_798)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_349,this._spacing,PropertyStruct.const_40,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1139);
         }
         if(this.var_999 != PropertyDefaults.const_1231)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_870,this.var_999,PropertyStruct.const_36,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1621);
         }
         if(this.var_445 != PropertyDefaults.const_1130)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_803,this.var_445,PropertyStruct.const_36,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1671);
         }
         if(this.var_1245 != PropertyDefaults.const_1084)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_679,this.var_1245,PropertyStruct.const_36,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1430);
         }
         return _loc1_;
      }
