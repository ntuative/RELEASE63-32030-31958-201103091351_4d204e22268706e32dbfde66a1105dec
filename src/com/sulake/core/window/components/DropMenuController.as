   ...
   public class DropMenuController extends InteractiveController implements IDropMenuWindow, ITouchAwareWindow
   {
      ...
      public function set selection(param1:int) : void
      {
         ...
         if(!_loc2_.isWindowOperationPrevented())
         {
            this.var_618 = param1;
            this.closeMenuView();
            this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_351,this,null));
         }
      }
      ...
      private function getSubMenu() : DropMenuController
      {
         ...
         if(this.var_181 == null || this.var_181.disposed)
         {
            this.var_181 = context.create(name + "::submenu","",WindowType.const_440,var_84,0 | 0,_loc1_,this.subMenuEventProc,null,0,null,[WindowController.TAG_EXCLUDE]) as DropMenuController;
         }
         else
         {
      ...
      protected function closeMenuView() : void
      {
         if(this.close())
         {
            ...
            this.var_953 = false;
            this.getTitleLabel().text = this.var_618 < this.var_258.length && this.var_618 > -1 ? this.var_258[this.var_618] : caption;
         }
      }
      ...
      protected function populateMenuItemContainer(param1:Array, param2:DropMenuController, param3:Function) : void
      {
         ...
         while(_loc9_ < _loc5_)
         {
            _loc6_ = context.create(name + "::menu_item_" + _loc9_,param1[_loc9_],WindowType.const_535,var_84,0 | 0 | 0 | 0 | 0,null,param3,null,_loc9_,null,["_EXCLUDE"]) as DropMenuItemController;
         ...
         var _loc10_:IWindow = context.create(name + "::padding","",WindowType.const_378,var_84,0 | 0 | 0 | 0,new Rectangle(0,0,1,2),null,null,0,null,["_EXCLUDE"]);
         _loc4_.addListItem(_loc10_);
         _loc4_.autoArrangeItems = true;
         this.fitToDesktop(param2);
         param2.activate();
         if(this.var_618 > -1 && _loc5_)
         {
            _loc4_.getListItemAt(this.var_618).setStateFlag(WindowState.const_52,true);
         }
      }
      ...
      {
         var _loc3_:* = 0;
         if(param1.type == WindowMouseEvent.const_45 || param1.type == WindowTouchEvent.const_504)
         {
      ...
      private function subMenuEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowTouchEvent.const_1081:
            case WindowMouseEvent.const_59:
               ...
               break;
            case WindowTouchEvent.const_841:
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_258.length)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_770,this.var_258,PropertyStruct.const_133,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1638);
         }
         return _loc1_;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            if(_loc2_.key == PropertyDefaults.const_770)
            {
