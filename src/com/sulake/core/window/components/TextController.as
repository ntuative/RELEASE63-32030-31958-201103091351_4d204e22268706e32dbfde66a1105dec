package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static const const_1236:Dictionary = createPropertySetterTable();
       
      
      protected var _field:TextField;
      
      protected var var_806:Number;
      ...
      protected var var_1002:Boolean = false;
      ...
      public function TextController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         setTextFormatting(this._field,this.var_410,this._explicitStyle);
      ...
      private static function setTextStyle(param1:TextController, param2:TextStyle) : void
      {
         ...
         if(_loc3_)
         {
            param1.var_410 = _loc3_.name;
            setTextFormatting(param1._field,param1.var_410,param1._explicitStyle);
            param1.refreshTextImage();
         }
      }
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_886 ? true : null;
         }
      ...
      {
         this.var_806 = param1;
         this._field.scrollH = this.var_806 * Number(this._field.maxScrollH);
      ...
      {
         return new Rectangle(this.var_806 * this.maxScrollH,this.var_535 * this.maxScrollV,width,height);
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push((_loc2_.antiAliasType != null ? this._field.antiAliasType != _loc2_.antiAliasType : this._field.antiAliasType != PropertyDefaults.const_1154) ? new PropertyStruct(PropertyDefaults.const_633,this._field.antiAliasType,PropertyStruct.const_55,this._field.antiAliasType != AntiAliasType.NORMAL,PropertyDefaults.const_1157) : PropertyDefaults.const_1394);
         _loc1_.push(this._autoSize != PropertyDefaults.const_991 ? new PropertyStruct(PropertyDefaults.const_861,this._autoSize,PropertyStruct.const_55,true,PropertyDefaults.const_1144) : PropertyDefaults.const_1391);
         ...
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_998 ? new PropertyStruct(PropertyDefaults.const_1155,this._field.gridFitType,PropertyStruct.const_55,true,PropertyDefaults.const_1111) : PropertyDefaults.const_1387);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_864) ? new PropertyStruct(PropertyDefaults.const_376,this._field.textColor,PropertyStruct.const_150,true) : PropertyDefaults.const_1195);
         ...
         _loc1_.push(this.var_40.left != PropertyDefaults.const_727 ? new PropertyStruct(PropertyDefaults.const_238,this.var_40.left,PropertyStruct.const_40,true) : PropertyDefaults.const_508);
         _loc1_.push(this.var_40.top != PropertyDefaults.const_673 ? new PropertyStruct(PropertyDefaults.const_230,this.var_40.top,PropertyStruct.const_40,true) : PropertyDefaults.const_531);
         _loc1_.push(this.var_40.right != PropertyDefaults.const_784 ? new PropertyStruct(PropertyDefaults.const_218,this.var_40.right,PropertyStruct.const_40,true) : PropertyDefaults.const_516);
         _loc1_.push(this.var_40.bottom != PropertyDefaults.const_686 ? new PropertyStruct(PropertyDefaults.const_214,this.var_40.bottom,PropertyStruct.const_40,true) : PropertyDefaults.const_572);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_1098 ? new PropertyStruct(PropertyDefaults.const_755,this._field.mouseWheelEnabled,PropertyStruct.const_36,true) : PropertyDefaults.const_1633);
