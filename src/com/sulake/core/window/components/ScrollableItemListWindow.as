package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_408:IScrollbarWindow;
      ...
      override public function dispose() : void
      {
         if(this.var_408)
         {
            this.var_408.removeEventListener(WindowEvent.const_300,this.scrollBarEventProc);
            this.var_408.removeEventListener(WindowEvent.const_229,this.scrollBarEventProc);
            this.var_408 = null;
         }
         if(this.var_1089)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_1089)
         {
            this.var_1089 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_408)
         {
            this.var_408 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(this.var_408)
            {
               this.var_408.addEventListener(WindowEvent.const_300,this.scrollBarEventProc);
               this.var_408.addEventListener(WindowEvent.const_229,this.scrollBarEventProc);
            }
         }
         return this.var_408;
      }
