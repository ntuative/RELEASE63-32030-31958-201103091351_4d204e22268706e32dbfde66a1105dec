package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      protected var var_1001:ITabSelectorWindow;
      
      protected var var_2007:IWindowContainer;
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_1001 = findChildByTag(const_1289) as ITabSelectorWindow;
            if(this.var_1001 != null)
            {
               this.var_1001.procedure = this.selectorEventProc;
            }
         }
      ...
      public function get container() : IWindowContainer
      {
         ...
         {
            this.var_2007 = findChildByTag(const_1290) as IWindowContainer;
         }
      ...
      {
         return this.var_1001.numSelectables;
      }
