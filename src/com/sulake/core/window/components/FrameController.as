package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1240:String = "_TITLE";
      
      private static const const_1239:String = "_HEADER";
      
      private static const const_1238:String = "_CONTENT";
      
      private static const const_1241:String = "_SCALER";
       
      
      private var _title:ILabelWindow;
      
      private var var_1259:IHeaderWindow;
      ...
      public function get title() : ILabelWindow
      {
         if(this._title == null)
         {
            this._title = findChildByTag(const_1240) as ILabelWindow;
            if(!this._title)
            {
      ...
      public function get header() : IHeaderWindow
      {
         ...
         {
            this.var_1259 = findChildByTag(const_1239) as IHeaderWindow;
            if(!this.var_1259)
            {
      ...
      public function get content() : IWindowContainer
      {
         ...
         {
            this.var_185 = findChildByTag(const_1238) as IWindowContainer;
            if(!this.var_185)
            {
      ...
      {
         return findChildByTag(const_1241) as IScalerWindow;
      }
      ...
      override public function set color(param1:uint) : void
      {
         ...
         groupChildrenWithTag(const_1235,_loc2_,false);
      ...
      private function setupScaling() : void
      {
         ...
         var _loc2_:Boolean = testParamFlag(WindowParam.const_321);
      ...
      private function marginsCallback(param1:IMargins) : void
      {
         ...
         if(_loc5_)
         {
            _loc2_.setParamFlag(WindowParam.const_279,false);
         }
      ...
      override public function get properties() : Array
      {
         ...
         if(_loc2_)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_238,_loc3_.left,PropertyStruct.const_40,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_230,_loc3_.top,PropertyStruct.const_40,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_218,0 - _loc3_.right,PropertyStruct.const_40,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_214,0 - _loc3_.bottom,PropertyStruct.const_40,_loc2_));
         }
         else
         {
