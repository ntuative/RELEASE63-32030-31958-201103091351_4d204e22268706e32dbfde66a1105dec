package com.sulake.core.window.components
{
   ...
   public class HTMLTextController extends TextFieldController implements IHTMLTextWindow
   {
      ...
      private static var var_873:String = PropertyDefaults.HTML_LINK_TARGET_VALUE;
       
      
      private var var_874:String = "default";
      
      private var var_1081:String = null;
      
      private var var_1645:StyleSheet = null;
      ...
      private static function setHtmlStyleSheetString(param1:HTMLTextController, param2:String) : void
      {
         ...
         if(param1.var_1081 == param2)
         {
            return;
         }
         param1.var_1081 = param2;
         param1.var_1645 = null;
         if(param1.var_1081 != null)
         {
            _loc3_ = new StyleSheet();
            _loc3_.parseCSS(param1.var_1081);
            param1.var_1645 = _loc3_;
         }
      }
      ...
      {
         if(PropertyDefaults.const_889.indexOf(param1) > -1)
         {
            this.var_874 = param1;
         }
      }
      ...
      override public function set htmlText(param1:String) : void
      {
         ...
         {
            _field.htmlText = convertLinksToEvents(var_20);
            _field.styleSheet = this.var_1645;
            refreshTextImage();
         }
      }
      ...
      override protected function immediateClickHandler(param1:Event) : void
      {
         ...
         if(param1 is TextEvent)
         {
            ...
            if(!_loc2_.isWindowOperationPrevented() && this.linkTarget != LinkTarget.const_623)
            {
      ...
      override public function get properties() : Array
      {
         ...
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_848,this.var_874,PropertyStruct.const_55,true,PropertyDefaults.const_889));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1421);
         }
         return _loc1_;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            if(_loc2_.key == PropertyDefaults.const_848)
            {
