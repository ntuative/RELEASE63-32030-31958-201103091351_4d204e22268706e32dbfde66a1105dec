package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      protected var var_1509:uint = 500;
      ...
      {
         if(param1.type == WindowTouchEvent.const_504)
         {
            this.focus();
         }
      ...
      private function onKeyDownEvent(param1:KeyboardEvent) : void
      {
         ...
         {
            _context.handleError(WindowContext.const_377,e);
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(true ? new PropertyStruct(PropertyDefaults.const_909,false,PropertyStruct.const_36,true) : PropertyDefaults.const_1399);
         _loc1_.push(this.var_1251 != PropertyDefaults.const_988 ? new PropertyStruct(PropertyDefaults.const_901,this.var_1251,PropertyStruct.const_36,true) : PropertyDefaults.const_1634);
         _loc1_.push(_field.selectable != PropertyDefaults.const_994 ? new PropertyStruct(PropertyDefaults.const_691,_field.selectable,PropertyStruct.const_36,true) : PropertyDefaults.const_1530);
         _loc1_.push(_field.displayAsPassword != PropertyDefaults.const_997 ? new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_36,true) : PropertyDefaults.const_1395);
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_901:
                  this.var_1251 = _loc2_.value as Boolean;
                  if(this.var_1251)
                  {
               ...
               case PropertyDefaults.const_909:
                  ...
                  break;
               case PropertyDefaults.const_1204:
