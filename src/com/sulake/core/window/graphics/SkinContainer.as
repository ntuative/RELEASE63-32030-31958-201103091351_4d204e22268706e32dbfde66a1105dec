package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_1274:String = "skin";
      
      private static const const_1277:String = "bitmap";
      
      private static const const_1278:String = "fill";
      
      private static const const_1275:String = "text";
      
      private static const const_1276:String = "label";
      
      private static const const_1273:String = "shape";
      ...
      private var var_2162:Dictionary;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         TypeCodeTable.fillTables(this.var_1585,this.var_2164);
         this.var_2163 = new Dictionary();
         this.var_2162 = new Dictionary();
         StateCodeTable.fillTables(this.var_2163,this.var_2162);
         this.var_397 = new Dictionary();
         this.var_397[const_1274] = BitmapSkinRenderer;
         this.var_397[const_1277] = BitmapDataRenderer;
         this.var_397[const_1278] = FillSkinRenderer;
         this.var_397[const_1275] = TextSkinRenderer;
         this.var_397[const_1276] = LabelRenderer;
         this.var_397[const_1273] = ShapeSkinRenderer;
         this.var_397[RENDERER_TYPE_UNKNOWN] = SkinRenderer;
         this.var_397[RENDERER_TYPE_NULL] = NullSkinRenderer;
         if(var_323 == null)
         {
            var_323 = new Array();
            var_323.push(WindowState.const_71);
            var_323.push(WindowState.const_84);
            var_323.push(WindowState.const_98);
            var_323.push(WindowState.const_52);
            var_323.push(WindowState.const_96);
            var_323.push(WindowState.const_83);
            var_323.push(WindowState.const_110);
            var_323.push(WindowState.const_101);
         }
         if(param1 != null)
         {
            ...
            if(_loc4_ > 0)
            {
               ...
               while(_loc18_ < _loc4_)
               {
                  ...
                  _loc17_.var_2765 = !!_loc5_.@treshold[0] ? uint(uint(_loc5_.@treshold[0])) : uint(10);
                  _loc17_.background = !!_loc5_.@background[0] ? _loc5_.@background[0] == "HabboHelpCom_help_faq_entry_xml" : false;
                  ...
                  this.addSkinRenderer(this.var_1585[_loc7_],uint(_loc8_),_loc14_,_loc17_);
                  _loc18_++;
               }
            }
         }
      ...
      public function addSkinRenderer(param1:uint, param2:uint, param3:ISkinRenderer, param4:DefaultAttStruct) : void
      {
         ...
         {
            this.var_845[param1] = new Array(const_928);
         }
         this.var_845[param1][param2] = param3;
         if(this.var_846[param1] == null)
         {
            this.var_846[param1] = new Array(const_928);
         }
         this.var_846[param1][param2] = param4;
      }
      ...
      public function getSkinRendererByTypeAndStyle(param1:uint, param2:uint) : ISkinRenderer
      {
         ...
         if(_loc3_)
         {
            ...
            if(!_loc4_ && param2 != WindowStyle.const_190)
            {
               _loc4_ = _loc3_["null"];
            }
         }
      ...
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_846[param1];
         if(_loc3_)
         {
            _loc4_ = _loc3_[param2];
            if(!_loc4_ && param2 != WindowStyle.const_190)
