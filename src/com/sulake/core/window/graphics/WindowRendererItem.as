package com.sulake.core.window.graphics
{
   ...
   public class WindowRendererItem implements IDisposable
   {
      ...
      private static const const_947:uint = 1;
      ...
      public function WindowRendererItem(param1:WindowRenderer, param2:DrawBufferAllocator, param3:ISkinContainer)
      {
         ...
         this.var_1341 = 4294967295;
         this.var_884 = 0;
         this.var_1661 = new ColorTransform();
         this.var_1003 = new Matrix();
      ...
      public function render(param1:IWindow, param2:Point, param3:Rectangle) : Boolean
      {
         ...
         var _loc12_:* = 0;
         var _loc5_:uint = !!param1.background ? uint(const_946) : uint(const_602);
         var _loc6_:Boolean = this.var_176.width > 0 && this.var_176.height > 0;
         var _loc7_:ISkinRenderer = this.resolveSkinRenderer(param1);
         if(_loc7_ != null)
         {
            if(_loc7_.isStateDrawable(this.var_884))
            {
               _loc5_ = const_947;
            }
         }
            ...
            if(_loc4_ != null)
            {
               ...
               if(_loc5_ == const_947)
               {
                  ...
                  if(this.var_582)
                  {
                     ...
                     _loc7_.draw(param1,this.var_98,this.var_98.rect,this.var_884,false);
                  ...
                  {
                     this.var_1003.tx = param2.x;
                     this.var_1003.ty = param2.y;
                     this.var_1661.alphaMultiplier = param1.blend;
                     param3.offset(param2.x,param2.y);
                     _loc4_.draw(this.var_98,this.var_1003,this.var_1661,null,param3,false);
                     param3.offset(-param2.x,-param2.y);
                  }
                  else
                  {
      ...
      {
         var _loc2_:ISkinRenderer = this.var_821.getSkinRendererByTypeAndStyle(param1.type,param1.style);
         if(_loc2_ == null)
         {
            if(param1.style != WindowStyle.const_190)
            {
               _loc2_ = this.var_821.getSkinRendererByTypeAndStyle(param1.type,WindowStyle.const_190);
            }
         }
         return _loc2_;
      }
      ...
      {
         return this.var_821.getTheActualState(param1.type,param1.style,param1.state) != this.var_1341;
      }
      ...
      public function invalidate(param1:IWindow, param2:Rectangle, param3:uint) : Boolean
      {
         ...
         switch(param3)
         {
            ...
            case WindowRedrawFlag.const_1176:
               this.var_884 = this.var_821.getTheActualState(param1.type,param1.style,param1.state);
               if(this.var_884 != this.var_1341)
               {
                  this.var_582 = true;
                  _loc4_ = true;
               }
