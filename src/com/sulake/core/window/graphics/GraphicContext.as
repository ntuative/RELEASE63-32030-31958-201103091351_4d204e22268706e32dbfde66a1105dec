package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_1401:uint = 0;
      
      public static const const_799:uint = 1;
      
      public static const const_1146:uint = 2;
      
      public static const const_794:uint = 4;
      
      public static const const_1521:uint = 8;
      
      public static const const_1434:uint = 16;
      
      public static const const_1752:uint = 64;
      
      public static const const_1816:uint = 128;
      
      public static const const_1059:uint = 256;
         ...
         if(this.var_812)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new TrackedBitmapData(this,width,height,this.var_2018,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new TrackedBitmapData(this,1,1,var_2018,16777215);
                  }
                  var_325 += bitmap.width * bitmap.height * 4;
               }
