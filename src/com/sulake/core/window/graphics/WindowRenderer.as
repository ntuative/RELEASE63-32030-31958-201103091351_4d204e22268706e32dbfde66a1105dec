   ...
   public class WindowRenderer implements IWindowRenderer
   {
      ...
      public function addToRenderQueue(param1:IWindow, param2:Rectangle, param3:uint) : void
      {
         ...
         if(this.getWindowRendererItem(param1).invalidate(param1,param2,param3))
         {
            ...
            this.getWindowRendererItem(param1).invalidate(param1,this.var_294,WindowRedrawFlag.const_1009);
      ...
      {
         var _loc2_:WindowRendererItem = this.var_358[param1] as WindowRendererItem;
         if(_loc2_ == null)
         {
            this.registerRenderable(param1);
            _loc2_ = this.var_358[param1];
         }
         return _loc2_;
      }
      ...
      public function registerRenderable(param1:IWindow) : void
      {
         ...
         if(_loc2_ == null)
         {
            _loc2_ = new WindowRendererItem(this,this._drawBufferAllocator,this.var_821);
            this.var_358[param1] = _loc2_;
            param1.addEventListener(WindowDisposeEvent.const_892,this.windowDisposedCallback);
         }
      }
      
      public function removeRenderable(param1:IWindow) : void
      {
         param1.removeEventListener(WindowDisposeEvent.const_892,this.windowDisposedCallback);
         var _loc2_:WindowRendererItem = this.var_358[param1] as WindowRendererItem;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            delete this.var_358[param1];
         }
      }
      ...
      private function renderWindowBranch(param1:WindowController, param2:Rectangle, param3:Rectangle) : void
      {
         ...
         if(param1.visible)
         {
            if(getDrawLocationAndClipRegion(param1,param2,this.var_1753,this.var_1391))
            {
               if(this.getWindowRendererItem(param1).render(param1,this.var_1753,this.var_1391))
               {
