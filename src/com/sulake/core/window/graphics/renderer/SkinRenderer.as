package com.sulake.core.window.graphics.renderer
{
   ...
   public class SkinRenderer implements ISkinRenderer
   {
      ...
      protected var var_384:Dictionary;
      
      protected var _templatesByState:Dictionary;
      
      protected var var_534:Dictionary;
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            {
               ISkinLayout(this.var_534[_loc1_]).dispose();
            ...
            {
               ISkinTemplate(this.var_384[_loc1_]).dispose();
      ...
      {
         var _loc3_:ISkinLayout = this.var_534[param2];
         if(_loc3_ == null)
         {
      ...
      {
         var _loc3_:ISkinTemplate = this.var_384[param2];
         if(_loc3_ == null)
         {
      ...
      {
         this.var_534[param1.name] = param1;
         return param1;
      }
      ...
      public function removeLayout(param1:ISkinLayout) : ISkinLayout
      {
         var _loc2_:* = null;
         var _loc3_:* = 0;
         param1 = this.var_384[param1.name];
         if(param1 != null)
         {
            ...
            delete this.var_534[param1.name];
         }
         return param1;
      }
      ...
      public function removeTemplate(param1:ISkinTemplate) : ISkinTemplate
      {
         ...
         if(param1 != null)
         {
            ...
            delete this.var_384[param1.name];
         }
         return param1;
      }
   }
