package com.sulake.core.window.graphics.renderer
{
   ...
   public class BitmapSkinRenderer extends SkinRenderer implements ISkinRenderer
   {
      ...
      protected var var_803:Dictionary;
      ...
      {
         super(param1);
         this.var_803 = new Dictionary(false);
      ...
      override public function dispose() : void
      {
         ...
         if(!disposed)
         {
            super.dispose();
            this.var_843 = null;
            for(_loc1_ in this.var_803)
            {
               _loc2_ = this.var_803[_loc1_] as BitmapData;
               _loc2_.dispose();
               delete this.var_803[_loc1_];
            }
            this.var_803 = null;
         ...
         if(_loc7_ != null && _loc9_ > 0)
         {
            ...
            while(_loc16_ < _loc9_)
            {
               ...
               if(_loc11_ != null)
               {
                  ...
                  if(_loc10_.scaleH == SkinLayoutEntity.const_310)
                  {
                     var_33.x += _loc14_;
                  }
                  else if(_loc10_.scaleH == SkinLayoutEntity.const_449)
                  {
                     _loc12_ = true;
                  ...
                  else if(_loc10_.scaleH == SkinLayoutEntity.const_327)
                  {
                     _loc12_ = true;
                     var_33.right += _loc14_;
                     if(true)
                  ...
                  if(_loc10_.scaleV == SkinLayoutEntity.const_310)
                  {
                     var_33.y += _loc15_;
                  }
                  else if(_loc10_.scaleV == SkinLayoutEntity.const_449)
                  {
                     _loc13_ = true;
                  ...
                  else if(_loc10_.scaleV == SkinLayoutEntity.const_327)
                  {
                     _loc13_ = true;
                     var_33.bottom += _loc15_;
                     if(true)
                  ...
                  else if(_loc10_.scaleV == SkinLayoutEntity.const_327 || _loc10_.scaleH == SkinLayoutEntity.const_327)
                  {
                  ...
                  {
                     this.var_843.a = 0 / _loc17_.width;
                     this.var_843.d = 0 / _loc17_.height;
                     _loc30_ = new BitmapData(var_33.width,var_33.height,false);
                     _loc30_.draw(_loc17_,this.var_843);
                     _loc31_ = new BitmapData(var_33.width,var_33.height,true,0);
                     _loc31_.draw(_loc18_,this.var_843,null);
      ...
      protected function drawStaticLayoutEntity(param1:BitmapData, param2:Rectangle, param3:ISkinLayout, param4:ISkinLayoutEntity, param5:ISkinTemplate, param6:ISkinTemplateEntity) : void
      {
         ...
         switch(param6.type)
         {
            case "bitmap":
               ...
               if(param4.scaleH == SkinLayoutEntity.const_310)
               {
                  _loc7_.x += param2.width - param3.width;
               }
               if(param4.scaleV == SkinLayoutEntity.const_310)
               {
      ...
      private function getBitmapFromCache(param1:ISkinTemplate, param2:String) : BitmapData
      {
         ...
         var _loc4_:BitmapData = this.var_803[_loc3_];
         if(_loc4_ == null)
         {
