package com.sulake.core.window.utils
{
   ...
   public class TextFieldCache implements IDisposable
   {
      ...
      private static var var_818:Map = new Map();
      ...
      {
         var _loc2_:TextField = var_818[param1.name];
         if(_loc2_)
         {
            return _loc2_;
         }
         ...
         _loc3_.underline = param1.textDecoration == TextStyle.const_886 ? true : null;
