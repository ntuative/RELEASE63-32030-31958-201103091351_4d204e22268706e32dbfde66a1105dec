package com.sulake.core.window.utils
{
   ...
   public class PropertyStruct
   {
      ...
      public function PropertyStruct(param1:String, param2:Object, param3:String, param4:Boolean, param5:Array = null)
      {
         ...
         this.var_2794 = param3 == const_272 || param3 == const_133 || param3 == const_235 || param3 == const_260;
      ...
      public function toString() : String
      {
         switch(this._type)
         {
            ...
            case const_36:
               return Boolean(this.var_172) == true ? "HabboHelpCom_help_faq_entry_xml" : "false";
            case const_235:
      ...
      public function toXMLString() : String
      {
         ...
         switch(this._type)
         {
            case const_272:
               ...
               _loc1_ = "<var key=\"" + this.var_557 + "\">\r<value>\r<" + this._type + ">\r";
               _loc2_ = 0;
            ...
            case const_260:
               ...
               break;
            case const_150:
               _loc1_ = "<var key=\"" + this.var_557 + "\" value=\"" + "0x" + uint(this.var_172).toString(16) + "\" type=\"" + this._type + "\" />";
               break;
            default:
               _loc1_ = "<var key=\"" + this.var_557 + "\" value=\"" + this.var_172 + "\" type=\"" + this._type + "\" />";
         }
         return _loc1_;
      }
   }
