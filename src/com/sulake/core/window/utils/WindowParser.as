package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1924:String = "_INCLUDE";
      
      public static const const_1823:String = "_TEMP";
      
      private static const const_1257:String = "layout";
      
      private static const const_911:String = "window";
      
      private static const const_912:String = "variables";
      
      private static const const_913:String = "filters";
      
      private static const const_589:String = "name";
      
      private static const const_1247:String = "style";
      
      private static const const_590:String = "params";
      
      private static const const_1256:String = "tags";
      ...
      private static const const_1245:String = "visible";
      
      private static const const_1258:String = "caption";
      
      private static const ID:String = "id";
      
      private static const const_4:String = "background";
      
      private static const const_1214:String = "blend";
      
      private static const const_1249:String = "clipping";
      
      private static const COLOR:String = "color";
      
      private static const const_1250:String = "treshold";
      
      private static const const_1252:String = "children";
      
      private static const const_1242:String = "width_min";
      
      private static const WIDTH_MAX:String = "width_max";
      
      private static const const_1248:String = "height_min";
      
      private static const const_1251:String = "height_max";
      
      private static const const_588:String = "HabboHelpCom_help_faq_entry_xml";
      
      private static const const_167:String = "0";
      
      private static const const_1243:String = "$";
      
      private static const const_1254:String = ",";
      
      private static const const_48:String = "";
      
      private static const const_1253:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      ...
      {
         param1 = param1.replace(const_1246,const_48);
         return param1.replace(const_1253,const_48);
      }
      ...
      public function parseAndConstruct(param1:XML, param2:IWindow, param3:Map) : IWindow
      {
         ...
         var _loc12_:* = null;
         var _loc13_:int = 0;
         if(param1.localName() == const_1257)
         {
            _loc8_ = param1.child(const_912);
            if(_loc8_.length() > 0)
            {
               _loc10_ = _loc8_[0];
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         style = uint(this.parseAttribute(xml,const_1247,variables,style));
         params = uint(this.parseAttribute(xml,const_590,variables,params));
         tag = unescape(String(this.parseAttribute(xml,const_1256,variables,tag)));
         rect = new Rectangle();
         rect.x = Number(this.parseAttribute(xml,X,variables,const_167));
         rect.y = Number(this.parseAttribute(xml,Y,variables,const_167));
         rect.width = Number(this.parseAttribute(xml,const_1244,variables,const_167));
         rect.height = Number(this.parseAttribute(xml,const_1255,variables,const_167));
         visible = this.parseAttribute(xml,const_1245,variables,visible.toString()) == const_588;
         id = int(this.parseAttribute(xml,ID,variables,id.toString()));
         if(xml.child(const_590).length() > 0)
         {
            list = xml.child(const_590).children();
            length = list.length();
            i = 0;
            while(i < length)
            {
         ...
         caption = unescape(String(this.parseAttribute(xml,const_1258,variables,caption)));
         if(tag != const_48)
         {
            tags = tag.split(const_1254);
            length = tags.length;
            i = 0;
            while(i < length)
            {
         ...
         window = this._context.create(name,null,type,style,params,rect,null,parent is IIterable ? null : parent,id,this.parseProperties(xml.child(const_912)[0]),tags) as WindowController;
         window.limits.minWidth = int(this.parseAttribute(xml,const_1242,variables,window.limits.minWidth));
         window.limits.maxWidth = int(this.parseAttribute(xml,WIDTH_MAX,variables,window.limits.maxWidth));
         window.limits.minHeight = int(this.parseAttribute(xml,const_1248,variables,window.limits.minHeight));
         window.limits.maxHeight = int(this.parseAttribute(xml,const_1251,variables,window.limits.maxHeight));
         background = this.parseAttribute(xml,const_4,variables,window.background.toString()) == const_588;
         blend = Number(this.parseAttribute(xml,const_1214,variables,window.blend.toString()));
         clipping = this.parseAttribute(xml,const_1249,variables,window.clipping.toString()) == const_588;
         color = String(this.parseAttribute(xml,COLOR,variables,window.color.toString()));
         treshold = uint(this.parseAttribute(xml,const_1250,variables,window.mouseThreshold.toString()));
