package com.sulake.core.window.utils
{
   public class DefaultAttStruct
   {
      ...
      public static var var_1977:Boolean = false;
      ...
      {
         return var_1977 && (this.width_min > int.MIN_VALUE || this.height_min > int.MIN_VALUE || this.width_max < int.MAX_VALUE || this.height_max < int.MAX_VALUE);
      }
   }
}
