package com.sulake.core.assets.loaders
{
   ...
   public class BitmapFileLoader extends AssetLoaderEventBroker implements IAssetLoader
   {
      ...
      public function BitmapFileLoader(param1:String, param2:URLRequest = null)
      {
         ...
         this.var_1008 = new LoaderContext();
         this.var_1008.checkPolicyFile = true;
         ...
         {
            this.var_42.load(param2,this.var_1008);
         }
      }
      ...
      public function load(param1:URLRequest) : void
      {
         ...
         var_321 = 0;
         this.var_42.load(param1,this.var_1008);
      }
      ...
      override protected function retry() : Boolean
      {
         if(!_disposed)
         {
            if(++var_321 < var_2766)
            {
               ...
               this.var_42.load(new URLRequest(this.var_1005 + (this.var_1005.indexOf("?") == -1 ? "?" : "&") + "retry=" + var_321),this.var_1008);
               return true;
            }
         }
         return false;
