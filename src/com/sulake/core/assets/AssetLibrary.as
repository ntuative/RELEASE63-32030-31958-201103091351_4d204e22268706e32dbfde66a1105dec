package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_1209:String = "AssetLibraryReady";
      
      public static const const_856:String = "AssetLibraryLoaded";
      
      public static const const_1618:String = "AssetLibraryUnloaded";
      
      public static const const_1490:String = "AssetLibraryLoadError";
      
      private static const const_589:String = "name";
      
      private static const const_938:String = "asset";
      
      private static const const_939:String = "param";
      
      private static const TYPE:String = "mimeType";
      
      private static const const_940:String = "library";
      
      private static var var_285:Dictionary;
      
      private static var var_1629:LazyAssetProcessor = new LazyAssetProcessor();
      ...
      private static function fetchLibraryContents(param1:AssetLibrary, param2:XML, param3:Class) : Boolean
      {
         ...
         if(param3 == null)
         {
            throw new Error("Library " + param1.var_572 + " doesn\'t contain valid resource class!");
         }
         var _loc4_:XMLList = param2.child(const_940);
         if(_loc4_ == null)
         {
         ...
         if(_loc4_ != null)
         {
            _loc4_ = _loc4_.child(const_938);
            _loc10_ = _loc4_.length();
            _loc11_ = 0;
            while(_loc11_ < _loc10_)
            {
               _loc5_ = _loc4_[_loc11_];
               _loc6_ = _loc5_.attribute(const_589);
               ...
               {
                  Logger.log("Failed to extract asset " + _loc6_ + " from Library " + param1.var_572 + "!");
               }
               _loc11_++;
            }
         }
      ...
      {
         if(this.var_572 == param1.url && this.var_868)
         {
            if(!this.var_869 && param2)
            {
               AssetLibrary.fetchLibraryContents(this,this.var_700,this.var_573);
            }
            this.var_869 = param2;
            dispatchEvent(new Event(AssetLibrary.const_1209));
         }
         else
         {
      ...
      {
         var _loc2_:Class = this.var_867[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_1034,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1135,this.assetLoadEventHandler);
      ...
      {
         return this.var_150[param1] != null || (this.var_573 != null ? this.var_573[param1] != null : false);
      }
      ...
      public function setAsset(param1:String, param2:IAsset, param3:Boolean = true) : Boolean
      {
         ...
         if((param3 || _loc4_) && param2)
         {
            ...
            {
               var_1629.push(param2 as ILazyAsset);
            }
            return true;
         }
         return false;
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         this.var_700 = _loc2_.manifest.copy();
         this.var_573 = _loc2_.resource;
         this.var_572 = _loc2_.url;
         if(this.var_869)
         {
            AssetLibrary.fetchLibraryContents(this,this.var_700,this.var_573);
         }
      ...
      private function loadErrorHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1490));
         this.var_42 = null;
      }
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = this.var_700.child(const_940);
         if(_loc2_ == null)
         {
         ...
         if(_loc2_ != null)
         {
            ...
            while(_loc8_ < _loc7_)
            {
               ...
               if(_loc3_.attribute(const_589).toString() == param1)
               {
                  _loc4_ = this.getAssetTypeDeclarationByMimeType(_loc3_.attribute(TYPE));
                  if(_loc4_ == null)
                  {
                     throw new Error("Failed to extract asset " + param1 + " from Library " + this.var_572 + "!");
                  }
                  _loc5_ = new _loc4_.assetClass(_loc4_) as IAsset;
                  _loc5_.setUnknownContent(this.var_573[param1]);
                  _loc6_ = _loc3_.child(const_939);
                  if(_loc6_.length())
                  {
