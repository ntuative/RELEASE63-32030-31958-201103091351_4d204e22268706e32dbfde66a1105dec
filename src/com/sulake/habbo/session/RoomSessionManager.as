package com.sulake.habbo.session
{
   ...
   public class RoomSessionManager extends Component implements IRoomSessionManager, IRoomHandlerListener
   {
      ...
      private function createHandlers() : void
      {
         ...
         this.var_71.push(new WelcomeGiftHandler(this._connection,this));
      }
      ...
      private function initializeManager() : void
      {
         ...
         if(this.initialized && this.var_1832)
         {
            this.gotoRoom(this.var_2571,this.var_2572,this.var_1831);
            this.var_1832 = false;
            this.var_1831 = "";
         }
      }
      ...
      public function sessionUpdate(param1:int, param2:int, param3:String) : void
      {
         ...
         if(_loc4_ != null)
         {
            switch(param3)
            {
               case RoomSessionHandler.const_1184:
                  break;
               case RoomSessionHandler.const_1020:
                  break;
               case RoomSessionHandler.const_735:
