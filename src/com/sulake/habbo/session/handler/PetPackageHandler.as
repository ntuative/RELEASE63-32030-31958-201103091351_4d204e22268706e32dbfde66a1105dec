package com.sulake.habbo.session.handler
{
   ...
   public class PetPackageHandler extends BaseHandler
   {
      ...
      private function onOpenPetPackageRequested(param1:IMessageEvent) : void
      {
         ...
         if(listener && false)
         {
            listener.events.dispatchEvent(new RoomSessionPetPackageEvent(RoomSessionPetPackageEvent.const_487,_loc3_,_loc2_.objectId,_loc2_.petType,_loc2_.breed,_loc2_.color,0));
         }
      }
      ...
      private function onOpenPetPackageResult(param1:IMessageEvent) : void
      {
         ...
         if(listener && false)
         {
            listener.events.dispatchEvent(new RoomSessionPetPackageEvent(RoomSessionPetPackageEvent.const_559,_loc3_,_loc2_.objectId,-1,-1,"",_loc2_.nameValidationStatus));
         }
      }
   }
}
