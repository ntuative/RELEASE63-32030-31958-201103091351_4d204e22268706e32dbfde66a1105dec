package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private var var_1474:LogoutController;
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         if(this._config && this._config.getKey("client.logout.enabled","false") == "HabboHelpCom_help_faq_entry_xml")
         {
            this.var_1474 = new LogoutController(this._windowManager,this._assetLibrary,events);
         }
         if(this.var_17 == null)
         {
            return;
         ...
         events.addEventListener(HabboToolbarShowMenuEvent.const_990,this.onDisplayWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_1035,this.onHideWindowEvent);
         this._state = true;
