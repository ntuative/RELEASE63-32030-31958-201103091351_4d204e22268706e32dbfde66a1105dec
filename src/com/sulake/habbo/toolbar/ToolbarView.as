package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private var var_1184:Boolean = true;
      
      private var var_1185:Number = 1;
      
      private var var_1463:Number = 0;
      
      private var var_1874:Number = 15;
      
      private var var_1873:Number = 5;
      ...
      public function ToolbarView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IEventDispatcher)
      {
         ...
         this.var_227 = param1.createWindow("extrabar_container_window","",HabboWindowType.const_63,HabboWindowStyle.const_1142,0 | 0,new Rectangle(0,0,1,1),null,0,0) as IWindowContainer;
         ...
         this.var_1184 = String(_loc6_.relocate_by_drag.@state) == "HabboHelpCom_help_faq_entry_xml";
         if(this.var_1184)
         {
         ...
         this.var_1185 = _loc6_.toolbar.@margin_top;
         this.var_1463 = _loc6_.toolbar.@margin_bottom;
         this.var_1874 = _loc6_.toolbar.@min_group_margin;
         this.var_1873 = _loc6_.toolbar.@margin_to_extrabar;
         this.var_281 = new ToolbarBarMenuAnimator(param1,this);
         var _loc7_:XMLList = XMLList(_loc6_.toolbar).children();
         var _loc8_:XMLList = XMLList(_loc6_.extras).children();
         this.createGroupsFromXmlList(_loc7_,this.var_262,param1,param2,this._window,this.var_281);
         this.createGroupsFromXmlList(_loc8_,this.var_630,param1,param2,this.var_227,this.var_281);
         this.alignWindows();
      }
      ...
      private function createGroupsFromXmlList(param1:XMLList, param2:Array, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IWindowContainer, param6:ToolbarBarMenuAnimator) : void
      {
         ...
         while(_loc10_ < param1.length())
         {
            ...
            _loc9_ = new ToolbarIconGroup(param3,param4,_loc10_,this._events,param5,param6,this.var_161);
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Point = null) : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.animateWindowIn(param1,param2,this.var_161,this.var_507,param3);
         }
      }
      ...
      public function animateWindowOut(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.animateWindowOut(param1,param2,this.var_507);
         }
      }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.positionWindow(param1,param2,this.var_161,this.var_507);
         }
      }
      ...
      public function hideWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.hideWindow(param1,param2,this.var_161,this.var_507);
         }
      }
      ...
      {
         this.alignWindows();
         var _loc2_:HabboToolbarEvent = new HabboToolbarEvent(HabboToolbarEvent.const_1096);
      ...
      private function getGroupForIcon(param1:String) : ToolbarIconGroup
      {
         ...
         _loc3_ = 0;
         while(_loc3_ < this.var_630.length)
         {
            _loc2_ = this.var_630[_loc3_];
            if(_loc2_.acceptsIcon(param1))
            {
               return _loc2_;
            }
      ...
      private function alignWindows() : void
      {
         ...
         if(this._window == null || this.var_227 == null)
         {
            return;
         }
         ...
         switch(this.orientation)
         {
            case "LEFT":
               ...
               this._window.x = 0;
               this._window.y = 0;
               this.var_227.x = this.var_161 + this.var_1873;
               this.var_227.y = 0;
            ...
            case "TOP":
               ...
               this._window.y = 0;
               this.var_227.x = 0;
               this.var_227.y = this.var_161 + this.var_1873;
         ...
         _loc4_ -= this.var_1463;
         _loc4_ -= this.var_1185;
         var _loc5_:* = 0;
         _loc2_ = 0;
         ...
         var _loc6_:* = 0;
         var _loc7_:Number = this.var_1185;
         var _loc8_:* = 1;
         if(_loc5_ > _loc4_)
         {
         ...
         else
         {
            ...
            if(this.var_262.length > 1)
            {
               ...
               {
                  _loc6_ = Number(Math.max(this.var_1874,(this._window.height - _loc5_ * _loc8_ - this.var_1185 - this.var_1463) / (this.var_262.length - 1)));
               }
               else
               {
                  _loc6_ = Number(Math.max(this.var_1874,(this._window.width - _loc5_ * _loc8_ - this.var_1185 - this.var_1463) / (this.var_262.length - 1)));
               }
            }
         }
         _loc2_ = 0;
         while(_loc2_ < this.var_262.length)
         {
            ...
            if(_loc3_ != null)
            {
               _loc3_.orientation = this.var_507;
