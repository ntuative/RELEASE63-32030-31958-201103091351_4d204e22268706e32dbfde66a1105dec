package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconAnimator
   {
      ...
      public function ToolbarIconAnimator(param1:StateItem, param2:IAssetLibrary, param3:IBitmapWrapperWindow, param4:Number, param5:Number, param6:BitmapData = null)
      {
         ...
         this.var_1382 = param1.loop;
         if(param1.background != null)
         {
            this.var_728 = this.getBitmapDataFromAsset(param1.background,param2);
         }
         ...
         else
         {
            ...
            if(_loc8_ != null)
            {
               this.var_921.push(new XML());
               this.var_923.push(_loc8_);
            }
         }
         if(param6 != null)
         {
            this.var_923[this._frame] = param6.clone();
         }
      ...
      {
         if(this.var_1382 == true || this.var_922 == 0)
         {
      ...
      {
         return this.var_1382 == false && this.var_922 == 1 && this.var_1712 != this._state;
      }
      ...
      private function updateAssetInWindow(param1:IBitmapWrapperWindow) : void
      {
         ...
         {
            _loc2_ = this.var_923[this._frame];
      ...
      private function setAsset(param1:IBitmapWrapperWindow, param2:BitmapData) : void
      {
         ...
         {
            _loc3_ = new BitmapData(Math.max(param2.width,this.var_728.width),Math.max(param2.height,this.var_728.height),true,0);
            _loc4_ = _loc3_.height - this.var_728.rect.height;
            _loc3_.copyPixels(this.var_728,this.var_728.rect,new Point(0,_loc4_),null,null,true);
