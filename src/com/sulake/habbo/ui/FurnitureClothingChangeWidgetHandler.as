package com.sulake.habbo.ui
{
   ...
   public class FurnitureClothingChangeWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver
   {
      ...
      private static const const_1268:String = "hr-165-45.hd-208-2.ch-250-64.lg-285-82.sh-290-64";
      
      private static const const_1269:String = "hr-681-41.hd-620-9.ch-879-90.lg-700-85.sh-735-68";
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         var _loc2_:RoomWidgetClothingChangeUpdateEvent = new RoomWidgetClothingChangeUpdateEvent(RoomWidgetClothingChangeUpdateEvent.const_395);
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_849,RoomWidgetClothingChangeMessage.const_363,RoomWidgetAvatarEditorMessage.const_345];
      }
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetClothingChangeMessage.const_363:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc4_ != null)
                  {
                     this.var_364 = _loc7_.objectId;
                     _loc9_ = "null";
                     _loc10_ = _loc4_.getString(RoomObjectVariableEnum.const_1138);
                     if(_loc10_ == null)
                     {
                        _loc10_ = const_1268;
                     }
                     ...
                     {
                        _loc9_ = "null";
                        _loc10_ = _loc4_.getString(RoomObjectVariableEnum.const_1114);
                        if(_loc10_ == null)
                        {
                           _loc10_ = const_1269;
                        }
                     }
                     if(this._container.avatarEditor.openEditor(_loc7_.window,this,[AvatarEditorFigureCategory.const_269,AvatarEditorFigureCategory.const_700],true))
                     {
                        _loc11_ = 0;
            ...
            case RoomWidgetAvatarEditorMessage.const_345:
               _loc5_ = new RoomWidgetClothingChangeUpdateEvent(RoomWidgetClothingChangeUpdateEvent.const_395);
               this._container.events.dispatchEvent(_loc5_);
         }
         return null;
      }
      ...
      public function saveFigure(param1:String, param2:String) : void
      {
         ...
         this._container.roomSession.sendUpdateClothingChangeFurniture(this.var_364,param2,param1);
