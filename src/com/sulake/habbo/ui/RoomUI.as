package com.sulake.habbo.ui
{
   ...
   public class RoomUI extends Component implements IRoomUI, IUpdateReceiver
   {
      ...
      private var var_1065:IRoomWidgetFactory;
      ...
      private var var_1108:IHabboHelp;
      ...
      {
         this.var_1410 = RoomDesktop.const_505;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_1065.release(new IIDHabboRoomWidget());
            this.var_1065 = null;
         }
         ...
         {
            this.var_475.release(new IIDAvatarRenderManager());
            this.var_475 = null;
         }
         ...
         {
            this.var_1108.release(new IIDHabboHelp());
            this.var_1108 = null;
         }
         ...
         {
            this.var_939.release(new IIDHabboModeration());
            this.var_939 = null;
         }
      ...
      private function onRoomWidgetFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1065 = param2 as IRoomWidgetFactory;
      }
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_475 = param2 as IAvatarRenderManager;
      }
      ...
      private function onAvatarEditorReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1798 = param2 as IHabboAvatarEditor;
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_300 != null && this.var_300.events != null)
         {
            this.var_300.events.addEventListener(AdEvent.const_507,this.adEventHandler);
            this.var_300.events.addEventListener(AdEvent.const_517,this.adEventHandler);
            this.var_300.events.addEventListener(AdEvent.const_541,this.adEventHandler);
         }
      }
      ...
      private function onHabboHelpReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1108 = param2 as IHabboHelp;
      }
      ...
      private function onHabboModerationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_939 = param2 as IHabboModeration;
         Logger.log("XXXX GOT HABBO MODERATION: " + this.var_939);
      }
      ...
      private function registerSessionEvents() : void
      {
         if(this.var_15)
         {
            ...
            this.var_15.events.addEventListener(RoomSessionChatEvent.const_585,this.roomSessionEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionDoorbellEvent.const_140,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionDoorbellEvent.const_46,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionPresentEvent.const_280,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionPetPackageEvent.const_487,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionPetPackageEvent.const_559,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionViralFurniStatusEvent.const_464,this.roomSessionEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_749,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_1001,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_1177,this.roomSessionDialogEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_625,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionQueueEvent.const_496,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionVoteEvent.const_139,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionVoteEvent.const_151,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionPollEvent.const_128,this.roomSessionEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionDimmerPresetsEvent.const_472,this.roomSessionEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionWelcomeGiftEvent.const_114,this.roomSessionEventHandler);
         }
      }
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_94:
               if(param1.session != null)
               {
                  ...
                  this.var_179.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_149,HabboToolbarIconEnum.ZOOM));
                  this.var_179.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_149,HabboToolbarIconEnum.MEMENU));
                  this.var_179.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_149,HabboToolbarIconEnum.INVENTORY));
               }
         }
      }
      ...
      private function initializeRoomEngineEvents() : void
      {
         ...
         {
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_739,this.roomEngineEventHandler);
            ...
            this._roomEngine.events.addEventListener(RoomEngineRoomColorEvent.const_628,this.roomEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_831,this.roomObjectEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_441,this.roomObjectEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_307,this.roomObjectEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_695,this.roomObjectEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_270,this.roomObjectEventHandler);
      ...
      private function roomEngineEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         if(param1.type == RoomEngineEvent.const_739)
         {
            if(this.var_15 != null)
            {
               this.var_15.roomEngineReady = true;
         ...
         else if(param1.type == RoomEngineEvent.const_574 || param1.type == RoomEngineEvent.const_532)
         {
      ...
      private function roomEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineEvent.const_668:
               ...
               if(this.var_1410 != RoomDesktop.const_505)
               {
                  _loc3_.initializeWidget(RoomWidgetEnum.const_318,this.var_1410);
               }
               if(this.var_300 != null)
               {
                  this.var_300.showRoomAd();
               }
               break;
      ...
      public function createDesktop(param1:IRoomSession) : IRoomDesktop
      {
         ...
         _loc3_.roomWidgetFactory = this.var_1065;
         _loc3_.sessionDataManager = this.var_287;
         _loc3_.roomSessionManager = this.var_15;
         _loc3_.friendList = this._friendList;
         _loc3_.avatarRenderManager = this.var_475;
         _loc3_.inventory = this._inventory;
         _loc3_.toolbar = this.var_179;
         _loc3_.navigator = this._navigator;
         _loc3_.avatarEditor = this.var_1798;
         _loc3_.catalog = this._catalog;
         _loc3_.adManager = this.var_300;
         _loc3_.localization = this._localization;
         _loc3_.habboHelp = this.var_1108;
         _loc3_.moderation = this.var_939;
      ...
      public function disposeDesktop(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != RoomDesktop.const_505)
            {
