   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.sessionDataManager.events.removeEventListener(UserTagsReceivedEvent.const_170,this.onUserTags);
         ...
         if(this._container.sessionDataManager != null)
         {
            this._container.sessionDataManager.events.addEventListener(UserTagsReceivedEvent.const_170,this.onUserTags);
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_622.length - 1;
            while(_loc1_ >= 0)
            {
               _loc2_ = this.var_622.getWithIndex(_loc1_);
               if(_loc2_)
               {
                  _loc2_.dispose();
               }
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_825);
         _loc1_.push(RoomWidgetGiveBadgeMessage.GIVE_BADGE);
         _loc1_.push(RoomWidgetFurniActionMessage.const_246);
         _loc1_.push(RoomWidgetFurniActionMessage.const_834);
         _loc1_.push(RoomWidgetFurniActionMessage.const_793);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_676);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_871);
         _loc1_.push(RoomWidgetGetBadgeImageMessage.const_618);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_1384);
         _loc1_.push(RoomWidgetPetCommandMessage.const_445);
         _loc1_.push(RoomWidgetPetCommandMessage.const_898);
         _loc1_.push(RoomWidgetUserActionMessage.const_439);
         _loc1_.push(RoomWidgetUserActionMessage.const_336);
         _loc1_.push(RoomWidgetChangeMottoMessage.const_762);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_538)
            {
               _loc3_ = this._container.roomSession.userDataManager.getUserDataByIndex(_loc2_);
            }
            else if(param1.type == RoomWidgetUserActionMessage.const_336 || param1.type == RoomWidgetUserActionMessage.const_439 || param1.type == RoomWidgetUserActionMessage.const_581)
            {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetUserActionMessage.const_719:
               ...
               break;
            case RoomWidgetUserActionMessage.const_825:
            ...
            case RoomWidgetGiveBadgeMessage.GIVE_BADGE:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_834:
            ...
            case RoomWidgetFurniActionMessage.const_793:
               ...
               break;
            case RoomWidgetUserActionMessage.const_336:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_676:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_871:
               ...
               break;
            case RoomWidgetGetBadgeImageMessage.const_618:
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               {
                  _loc24_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_339);
               ...
               _loc9_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_1048);
               _loc10_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_1039);
            ...
            case RoomObjectCategoryEnum.const_33:
               ...
               if(_loc11_.type == RoomObjectTypeEnum.const_200)
               {
                  this._container.roomSession.userDataManager.requestPetInfo(_loc11_.webID);
                  return null;
               }
               if(_loc11_.type == RoomObjectTypeEnum.const_184)
               {
                  _loc12_ = "null";
               ...
               {
                  if(_loc11_.type != RoomObjectTypeEnum.const_808)
                  {
                     return null;
                  }
                  _loc12_ = "null";
               ...
               if(_loc17_ != null)
               {
                  _loc13_.carryItem = _loc17_.getModel().getNumber(RoomObjectVariableEnum.const_584);
               }
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_122)
               {
                  _loc13_.realName = this._container.sessionDataManager.realName;
               }
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_142)
               {
                  ...
                  if(_loc17_ != null)
                  {
                     _loc31_ = _loc17_.getModel().getString(RoomObjectVariableEnum.const_863);
                  ...
                  if(!_loc27_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1230;
                  }
                  if(!_loc28_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1190;
                  }
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc14_.push(RoomWidgetUserInfoUpdateEvent.const_1403);
               }
               else
               {
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc7_:BitmapData = this.var_622.getValue(_loc4_) as BitmapData;
         if(_loc7_ == null)
         {
            _loc7_ = this.getPetImage(_loc4_);
            this.var_622.add(_loc4_,_loc7_);
         }
         if(this._container != null && this._container.events != null)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_863);
