package com.sulake.habbo.roomevents.userdefinedroomevents.help
{
   ...
   public class UserDefinedRoomEventsHelp
   {
      ...
      private var var_1844:IWindowContainer;
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1844 = IWindowContainer(this.find(this._window,"help_container"));
         this.var_1173 = this.var_1844.findChildByName("button_previous") as IContainerButtonWindow;
         if(this.var_1173)
         {
            this.var_1173.procedure = this.onButtonClick;
         }
         this.var_1174 = this.var_1844.findChildByName("button_next") as IContainerButtonWindow;
         if(this.var_1174)
         {
