package com.sulake.habbo.roomevents.userdefinedroomevents.common
{
   ...
   public class SliderWindowController extends EventDispatcher
   {
      ...
      public function setValue(param1:Number, param2:Boolean = true) : void
      {
         ...
         param1 = Math.min(this.var_1086,param1);
         this.var_879 = param1;
         if(param2)
         {
      ...
      private function updateSliderPosition() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.x = this.getSliderPosition(this.var_879);
         }
      ...
      {
         return int(this.var_1653 * (Number(param1 - this._minValue) / (this.var_1086 - this._minValue)));
      }
      
      private function getValueAtPosition(param1:Number) : Number
      {
         return param1 / this.var_1653 * (this.var_1086 - this._minValue) + this._minValue;
      }
      ...
      private function sliderProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_880)
         {
            if(param1.type == WindowMouseEvent.const_59 || param1.type == WindowMouseEvent.const_185)
            {
               this.var_880 = false;
            }
         }
         if(!this.var_880 || param1.type != WindowEvent.const_386)
         {
            return;
         }
         if(this.var_580 != 0)
         {
            ...
            _loc4_ = Math.round(_loc3_ / this.var_580) * this.var_580;
      ...
      private function sliderButtonRightProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            if(this.var_580 != 0)
            {
               _loc3_ = this.var_879 + this.var_580;
      ...
      private function displaySlider() : void
      {
         ...
         {
            _loc2_.bitmap = new BitmapData(this.var_704.width,this.var_704.height,true,16777215);
            _loc2_.bitmap.copyPixels(this.var_704,this.var_704.rect,new Point(0,0),null,null,true);
         }
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null && this.var_705 != null)
            {
               ...
               this.var_1653 = _loc1_.width - _loc2_.width;
            }
         }
      ...
      private function storeAssets(param1:IAssetLibrary) : void
      {
         ...
         this.var_704 = BitmapData(_loc2_.content);
