package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      private static var var_1497:int = 2;
      ...
      private var var_1942:TriggerConfs;
      
      private var var_1941:ActionTypes;
      
      private var var_1943:ConditionTypes;
      
      private var var_271:Dictionary;
      
      private var var_36:Triggerable;
      
      private var var_791:RoomObjectHightLighter;
      
      private var var_127:UserDefinedRoomEventsHelp;
      
      private var var_1226:SliderWindowController;
      
      public function UserDefinedRoomEventsCtrl(param1:HabboUserDefinedRoomEvents)
      {
         this.var_1942 = new TriggerConfs();
         this.var_1941 = new ActionTypes();
         this.var_1943 = new ConditionTypes();
         this.var_271 = new Dictionary();
         super();
         this.var_83 = param1;
         this.var_791 = new RoomObjectHightLighter(param1);
         this.var_127 = new UserDefinedRoomEventsHelp(param1);
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1226 = new SliderWindowController(this.var_83,IWindowContainer(this.find(this.var_52,"delay_slider_container")),this.var_83.assets,0,20,1);
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_791.hideAll(this.var_271);
         }
      }
      ...
      public function prepareForUpdate(param1:Triggerable) : void
      {
         ...
         this.var_791.showAll(this.var_271);
         if(this.var_36 as ActionDefinition != null)
         {
      ...
      private function onHelp(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_127.open(this._window.x + this._window.width + 5,this._window.y);
      }
      ...
      private function onDecStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.stuffTypeSelectionCode = this.var_36.stuffTypeSelectionCode < 1 ? int(var_1497) : int(this.var_36.stuffTypeSelectionCode - 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function onIncStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.stuffTypeSelectionCode = (this.var_36.stuffTypeSelectionCode + 1) % (var_1497 + 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function refresh() : void
      {
         ...
         this.refreshConfigureElement(this.var_1942);
         this.refreshConfigureElement(this.var_1941);
         this.refreshConfigureElement(this.var_1943);
      ...
      private function refreshHeader(param1:Element, param2:String) : void
      {
         ...
         this.setText(_loc3_,"conf_name_txt",this.method_4(this.var_36.stuffTypeId));
      ...
      private function refreshConflictingTriggers() : void
      {
         ...
         {
            _loc2_ += (!!_loc3_ ? "" : ", ") + "\'" + this.method_4(_loc4_) + "\'";
            _loc3_ = false;
         }
