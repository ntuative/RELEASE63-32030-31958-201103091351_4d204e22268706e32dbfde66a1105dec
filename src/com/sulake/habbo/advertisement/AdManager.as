package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_1205:BitmapData = null;
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_2700 = this._config.getKey("interstitial.enabled","false") == "HabboHelpCom_help_faq_entry_xml";
         this.var_2699 = int(this._config.getKey("interstitial.interval","30000"));
         this.var_2698 = int(this._config.getKey("interstitial.show.time","5000"));
         this.var_1915 = int(this._config.getKey("interstitial.max.displays.flash","-1"));
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(this.var_1915 > 0 && this.var_1917 >= this.var_1915)
         {
            return false;
         }
         var _loc1_:int = getTimer() - this.var_1206;
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         if(this.var_1487 != "")
         {
            ...
            {
               this.var_230 = new Timer(this.var_2698,1);
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_517,0,0,param1.bitmapData,this.var_2697));
            this.var_1206 = getTimer();
         }
         else
         {
      ...
      private function stopInterstitial() : void
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_507));
         }
      }
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         this.var_1916 = _loc2_.clickUrl;
         if(this.var_1486 != "" && this.var_1916 != "")
         {
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(this.isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_541,0,0,_loc4_,this.var_1916,this.var_1205,this.var_1204));
         }
      }
      ...
      private function adWarningLeftReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            this.var_1205 = this.emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
