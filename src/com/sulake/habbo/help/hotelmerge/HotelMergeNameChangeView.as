package com.sulake.habbo.help.hotelmerge
{
   ...
   public class HotelMergeNameChangeView
   {
      ...
      private function showSelectionView() : void
      {
         if(!this.var_661)
         {
            this.var_661 = this.createWindow("hotel_merge_name_selection_xml") as IWindowContainer;
            if(!this.var_661)
            {
               return;
            }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_662)
         {
            this.var_662 = this.createWindow("hotel_merge_name_confirmation_xml") as IWindowContainer;
            if(!this.var_662)
            {
               return;
            }
