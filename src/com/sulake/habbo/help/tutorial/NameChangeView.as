package com.sulake.habbo.help.tutorial
{
   ...
   public class NameChangeView
   {
      ...
      private static var var_1516:uint = 11129827;
      ...
      private function showSelectionView() : void
      {
         if(!this.var_661)
         {
            this.var_661 = this._controller.buildXmlWindow("welcome_name_selection") as IWindowContainer;
            if(!this.var_661)
            {
               return;
            }
            this._window.content.addChild(this.var_661);
         }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_662)
         {
            this.var_662 = this._controller.buildXmlWindow("welcome_name_confirmation") as IWindowContainer;
            if(!this.var_662)
            {
               return;
            }
            this._window.content.addChild(this.var_662);
         }
         this._window.caption = this._controller.localization.getKey("tutorial.name_change.title.confirm");
         var _loc1_:ITextWindow = this.var_662.findChildByName("final_name") as ITextWindow;
         if(_loc1_)
         {
            _loc1_.text = this.var_454;
         }
         this.showView(this.var_662);
      }
      ...
      public function setNameAvailableView() : void
      {
         ...
         this._controller.localization.registerParameter("help.tutorial.name.available","name",this.var_454);
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            ...
            case "keep_name_button":
               this.var_454 = this._controller.myName;
               this.showConfirmationView();
               break;
            ...
            case "confirm_name_button":
               this._controller.changeName(this.var_454);
               break;
