package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialUI implements INameChangeUI
   {
      ...
      public static const const_287:String = "TUI_NAME_VIEW";
      
      public static const const_348:String = "TUI_CLOTHES_VIEW";
      ...
      public function TutorialUI(param1:HabboHelp, param2:Boolean = true)
      {
         ...
         this.var_34.events.addEventListener(HabboHelpTutorialEvent.const_540,this.onTaskDoneEvent);
         this.var_34.events.addEventListener(HabboHelpTutorialEvent.const_537,this.onTaskDoneEvent);
         ...
         {
            this.var_34.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_324,this.onFigureUpdate);
         }
      }
      ...
      {
         return this.var_1110 && this.var_1111 && this.var_1359;
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_34)
         {
            this.var_34.events.removeEventListener(HabboHelpTutorialEvent.const_540,this.onTaskDoneEvent);
            this.var_34.events.removeEventListener(HabboHelpTutorialEvent.const_537,this.onTaskDoneEvent);
            this.var_34.events.removeEventListener(HabboHelpTutorialEvent.const_526,this.onTaskDoneEvent);
            if(this.var_34.sessionDataManager != null)
            {
               this.var_34.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_324,this.onFigureUpdate);
            }
            this.var_34 = null;
         }
      }
      ...
      public function onTaskDoneEvent(param1:HabboHelpTutorialEvent) : void
      {
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_540:
               this.var_1359 = true;
               if(this.var_43 != null && this.var_43.id == const_568)
               {
                  this.showView(const_91);
               }
               break;
            case HabboHelpTutorialEvent.const_537:
               if(this.var_43 != null && this.var_43.id == const_348)
               {
                  this.var_1705 = true;
                  this.disposeWindow();
               }
      ...
      public function showView(param1:String) : void
      {
         ...
         if(this._window == null)
         {
            ...
            this.var_2301 = this._window.width - _loc2_.width;
         ...
         this._window.height = _loc2_.height + this.var_2303;
         this._window.width = _loc2_.width + this.var_2301;
         if(_loc3_)
         {
            if(this._window == null)
            {
      ...
      public function prepareForTutorial() : void
      {
         ...
         this.var_34.hideUI();
         this.var_34.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_123));
      }
      ...
      public function onUserNameChanged(param1:String) : void
      {
         ...
         if(this.var_43 != null && (this.var_43.id == const_287 || this.var_43.id == const_91))
         {
            this.showView(const_91);
         }
      }
      ...
      {
         this.var_1110 = true;
         if(this.var_43 != null && (this.var_43.id == const_348 || this.var_43.id == const_91))
         {
            this.showView(const_91);
         }
      }
