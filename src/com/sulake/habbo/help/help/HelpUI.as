package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      {
         this.var_341 = this._defaultViewId;
         ...
         this._windowManager.registerLocalizationParameter("info.client.version","version",new String(201103091347));
         this.var_179 = param5;
         this.var_108 = new Map();
         this.var_108.add(HabboHelpViewEnum.const_1655,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         this.var_108.add(HabboHelpViewEnum.const_172,IHelpViewController(new HelpMainView(this,this._windowManager,this._assetLibrary)));
         this.var_108.add(HabboHelpViewEnum.const_503,IHelpViewController(new FaqBrowseTopView(this,this._windowManager,this._assetLibrary)));
         this.var_108.add(HabboHelpViewEnum.const_291,IHelpViewController(new FaqBrowseCategoryView(this,this._windowManager,this._assetLibrary)));
         this.var_108.add(HabboHelpViewEnum.const_226,IHelpViewController(new FaqBrowseEntry(this,this._windowManager,this._assetLibrary)));
         this.var_108.add(HabboHelpViewEnum.const_355,IHelpViewController(new CallForHelpTopicSelection(this,this._windowManager,this._assetLibrary)));
         this.var_108.add(HabboHelpViewEnum.const_732,IHelpViewController(new CallForHelpTextInput(this,this._windowManager,this._assetLibrary)));
         this.var_108.add(HabboHelpViewEnum.const_227,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_thanks")));
         this.var_108.add(HabboHelpViewEnum.const_1052,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_abusive")));
         this.var_108.add(HabboHelpViewEnum.const_1103,IHelpViewController(new CallForHelpPendingItemView(this,this._windowManager,this._assetLibrary)));
         this.var_108.add(HabboHelpViewEnum.const_774,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         {
            if(this.var_472.length == 0 || param1 != this.var_341)
            {
               this.var_472.push(this.var_341);
            }
         }
         this.var_341 = param1;
         ...
         if(_loc4_ == null)
         {
            Logger.log("* No view controller found for " + this.var_341);
            return;
         }
         ...
         if(_loc3_)
         {
            ...
            {
               this.var_179.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_53,HabboToolbarIconEnum.HELP,this._window));
            }
         }
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_227:
               ...
               break;
            case CallForHelpResultEnum.const_1065:
               this.showUI(HabboHelpViewEnum.const_1103);
               break;
            case CallForHelpResultEnum.const_1038:
               this.showUI(HabboHelpViewEnum.const_1052);
         }
      }
      ...
      public function updateCallForGuideBotUI(param1:Boolean) : void
      {
         ...
         var _loc2_:IHelpViewController = this.var_108.getValue(HabboHelpViewEnum.const_172) as IHelpViewController;
      ...
      public function handleCallGuideBot() : void
      {
         ...
         this.hideUI();
         this._component.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_540));
      }
      ...
      {
         return this.var_108.getValue(this.var_341);
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_2301 = this._window.width - _loc4_.width;
         this.var_2303 = this._window.height;
      }
      ...
      public function updateWindowDimensions() : void
      {
         ...
         this._window.height = _loc1_.height + this.var_2303;
         this._window.width = _loc1_.width + this.var_2301;
      }
      ...
      {
         var _loc3_:* = null;
         if(this.var_341 == HabboHelpViewEnum.const_172)
         {
            return;
         }
         if(this.var_581.length < 2)
         {
            _loc3_ = this._assetLibrary.getAssetByName("back_png") as BitmapDataAsset;
            this.var_581.push(_loc3_.content as BitmapData);
            _loc3_ = this._assetLibrary.getAssetByName("back_hi_png") as BitmapDataAsset;
            this.var_581.push(_loc3_.content as BitmapData);
         }
         var _loc2_:IBitmapWrapperWindow = this.var_340.findChildByName("back_image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(this.var_581[1],this.var_581[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(this.var_581[0],this.var_581[0].rect,new Point(0,0));
         }
      }
      ...
      private function addBackButtonWindow() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(this.var_341 == HabboHelpViewEnum.const_172 || this.var_472.length == 0)
         {
            return;
         }
         if(this.var_340 == null)
         {
            ...
            this.var_340 = _loc2_.buildFromXML(XML(_loc3_.content)) as IWindowContainer;
            _loc4_ = this.var_340.findChildByName("back_image");
            if(_loc4_ != null)
            {
            ...
            _loc5_ = this.var_340.findChildByName("back_text");
            if(_loc5_ != null)
            {
         ...
         var _loc1_:IItemListWindow = this._window.findChildByName("content_list") as IItemListWindow;
         if(_loc1_ == null || this.var_340 == null)
         {
            return;
         }
         if(_loc1_.getListItemIndex(this.var_340 as IWindow) > -1)
         {
            return;
         }
         _loc1_.addListItem(this.var_340 as IWindow);
         this.setBackButtonActiveState(false);
      }
   }
}
