package com.sulake.habbo.help
{
   ...
   public class WelcomeScreenController implements IUpdateReceiver
   {
      ...
      public function WelcomeScreenController(param1:HabboHelp, param2:IHabboWindowManager, param3:IHabboConfigurationManager)
      {
         ...
         this.var_127.toolbar.events.addEventListener(HabboToolbarEvent.const_1096,this.onToolbarResized);
         var _loc4_:Boolean = Boolean(parseInt(this._config.getKey("new.identity","0")));
         this.var_1565 = Boolean(parseInt(this._config.getKey("welcome.screen.enabled","0"))) && _loc4_;
         this.var_2431 = parseInt(this._config.getKey("welcome.screen.delay","5000"));
         this.var_375 = new Point(72,10);
         this.var_204 = new Timer(this.var_2431,1);
         this.var_204.addEventListener(TimerEvent.TIMER_COMPLETE,this.onTimerComplete);
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_204.stop();
            this.var_204.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onTimerComplete);
            this.var_204 = null;
         }
         this._disposed = true;
      }
      ...
      public function setCategory(param1:String, param2:String = "", param3:String = "") : void
      {
         ...
         {
            this.var_1739 = "welcome.screen.title";
         }
         if(param3.length > 0)
         {
         ...
         {
            this.var_1738 = "welcome.screen.message";
         }
      }
      ...
      private function onTimerComplete(param1:TimerEvent) : void
      {
         ...
         _loc5_.content.setParamFlag(WindowParam.const_277,false);
         _loc5_.height -= 20;
         ...
         this.var_1565 = false;
         this.var_375.y = this.var_127.toolbar.getIconLocation(this.var_1381) - this._window.height / 2;
         this._window.y = this.var_375.y;
         this._window.findChildByName("title").caption = "${" + this.var_1739 + "}";
         this._window.findChildByName("text").caption = "${" + this.var_1738 + "}";
         this.highlightToolbarIcon(true);
      }
      
      private function highlightToolbarIcon(param1:Boolean) : void
      {
         var _loc2_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_92,this.var_1381);
