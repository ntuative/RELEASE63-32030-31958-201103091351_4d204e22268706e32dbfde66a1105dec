package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IFurniDataListener, IDisposable
   {
      ...
      public static const const_867:String = "RCL_LOADER_READY";
      
      private static const const_334:String = "RCL_PUBLICROOM_";
      
      private static const const_1737:int = 0;
      
      private static const const_983:int = 1;
      
      private static const name_3:int = 2;
      
      private static const const_419:String = "place_holder";
      
      private static const const_614:String = "wall_place_holder";
      
      private static const const_612:String = "pet_place_holder";
      
      private static const PLACE_HOLDER_DEFAULT:String = const_419;
      
      private static const const_613:String = "room";
      
      private static const TILE_CURSOR:String = "tile_cursor";
      
      private static const const_982:String = "selection_arrow";
      ...
      public function RoomContentLoader()
      {
         ...
         this.var_2714 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
      ...
      {
         if(this._state >= const_983)
         {
            return;
         }
         this._stateEvents = param1;
         this.var_2712 = param2.getKey("flash.dynamic.download.url","furniture/");
         this.var_2713 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
         this.var_2715 = param2.getKey("public.room.dynamic.download.url","");
         this._publicRoomLoadNameTemplate = param2.getKey("public.room.dynamic.download.name.template","%typeid%.swf");
         this._state = const_983;
         this.initFurnitureData();
      }
      ...
      private function initPetData() : void
      {
         ...
         {
            this.var_439[_loc3_] = _loc2_;
            this.var_988.add(_loc2_,_loc3_);
            _loc2_++;
         }
      ...
      private function initFurnitureData() : void
      {
         ...
         var _loc1_:Array = this.var_287.getFurniData(this);
         if(_loc1_ == null)
         {
            return;
         }
      ...
      public function dispose() : void
      {
         ...
         {
            _loc2_ = this.var_520.length;
            _loc3_ = 0;
            while(_loc3_ < _loc2_)
            {
               _loc4_ = this.var_520.getWithIndex(_loc3_) as AssetLibrary;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
      ...
      private function populateFurniData(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            if(_loc6_.length > 0)
            {
               this.var_790.add(_loc4_,_loc6_);
            }
            _loc7_ = _loc2_.name;
            if(_loc2_.type == "s")
            {
               this.var_438.add(_loc3_,_loc4_);
               if(this.var_379[_loc7_] == null)
               {
                  this.var_379[_loc7_] = 1;
               }
            }
      ...
      private function continueInitilization() : void
      {
         if(this.var_2716)
         {
            ...
            {
               this._stateEvents.dispatchEvent(new Event(const_867));
            }
         }
      }
      ...
      public function setRoomObjectAlias(param1:String, param2:String) : void
      {
         ...
         if(this.var_521 != null)
         {
            this.var_521.remove(param2);
            this.var_521.add(param2,param1);
         }
      }
      ...
      {
         return [const_419,const_614,const_612,const_613,TILE_CURSOR,const_982];
      }
      ...
      {
         return this.var_988.getValue(param1) as String;
      }
      ...
      public function getRoomObjectAdURL(param1:String) : String
      {
         ...
         {
            return this.var_790.getValue(param1);
         }
         return "";
      }
      ...
      {
         if(this.var_205 != null && this.var_205.hasWorldType(const_334 + param1))
         {
      ...
      {
         if(param1 == RoomObjectVisualizationEnum.const_177 || param1 == RoomObjectVisualizationEnum.const_67 || param1 == RoomObjectVisualizationEnum.BOT)
         {
            return true;
         }
         return false;
         ...
         switch(_loc2_)
         {
            ...
            default:
               ...
               while(_loc9_ < _loc7_.length)
               {
                  ...
                  _loc8_.push(this.var_2715 + _loc10_);
                  _loc9_++;
               }
               return _loc8_;
         }
      ...
      public function insertObjectContent(param1:int, param2:int, param3:IAssetLibrary) : Boolean
      {
         ...
         if(_loc5_)
         {
            ...
            if(this.initializeGraphicAssetCollection(_loc4_,param3))
            {
               ...
               {
                  case RoomObjectCategoryEnum.const_29:
                     if(this.var_379[_loc4_] == null)
                     {
                        this.var_379[_loc4_] = 1;
                     }
                     break;
                  case RoomObjectCategoryEnum.const_26:
               ...
               _loc6_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_391,_loc4_);
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         if(this.var_1490.getValue(param1) != null)
         {
            this.var_205 = this.var_1490.getValue(param1) as PublicRoomData;
         }
         ...
         {
            _loc4_.addEventListener(AssetLibrary.const_856,this.onContentLoaded);
            _loc6_ = 0;
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         {
            if(_loc3_[_loc5_].toString().length > 0 && this.var_2714.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,Core.const_1451);
               return;
            }
         }
      }
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            ...
            else if(this.var_439[_loc5_] != null)
            {
               this.extractPetDataFromLoadedContent(_loc5_);
            }
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_391,_loc5_);
         }
         else
         {
      ...
      private function extractPublicRoomDataFromLoadedContent(param1:String, param2:IAssetLibrary) : void
      {
         ...
         this.var_1490.add(param1,_loc4_);
         this.var_205 = _loc4_;
      ...
      public function extractObjectContent(param1:String, param2:String) : Boolean
      {
         ...
         this.var_789.add(param2,param1);
         if(this.initializeGraphicAssetCollection(param2,_loc3_))
         {
            return true;
         }
         this.var_789.remove(param2);
         return false;
      }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         var _loc3_:IAssetLibrary = this.var_520.getValue(this.getAssetLibraryName(_loc2_)) as IAssetLibrary;
         if(_loc3_ == null)
         {
            _loc4_ = this.var_789.getValue(_loc2_);
            if(_loc4_ != null)
            {
               _loc2_ = this.getContentType(_loc4_);
               _loc3_ = this.var_520.getValue(this.getAssetLibraryName(_loc2_)) as IAssetLibrary;
            }
         }
         return _loc3_;
      }
      ...
      private function addAssetLibraryCollection(param1:String, param2:IEventDispatcher) : IAssetLibrary
      {
         ...
         this.var_520.add(_loc5_,_loc4_);
      ...
      public function getLogicType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectLogicEnum.const_247 && _loc5_ != RoomObjectLogicEnum.const_177)
         {
            _loc6_ = "@shadow";
      ...
      private function extractPublicRoomFromXML(param1:String, param2:XML) : PublicRoomData
      {
         ...
         {
            _loc6_ = _loc3_[_loc5_];
            _loc7_ = const_334 + String(_loc6_.@name);
            _loc8_ = 32;
            _loc9_ = 1;
      ...
      {
         if(this.getObjectCategory(const_334 + param1) == RoomObjectCategoryEnum.const_74)
         {
            return true;
         }
         return false;
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         ...
         {
            return this.var_205.getWorldHeightScale(const_334 + param1);
         }
         return 1;
      }
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(this.var_205 != null)
         {
            return this.var_205.getWorldScale(const_334 + param1);
         }
         return 32;
      }
