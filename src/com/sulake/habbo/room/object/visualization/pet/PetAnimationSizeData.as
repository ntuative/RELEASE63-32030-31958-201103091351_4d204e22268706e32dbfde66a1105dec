package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class PetAnimationSizeData extends AnimationSizeData
   {
      ...
      public function definePostures(param1:XML) : Boolean
      {
         ...
         {
            this.var_960 = param1.@defaultPosture;
         }
         else
         {
            this.var_960 = null;
         ...
         while(_loc4_ < _loc3_.length())
         {
            ...
            this.var_1172.add(_loc6_,_loc7_);
         ...
         if(this.var_1172.getValue(this.var_960) == null)
         {
            return false;
         }
         return true;
      ...
      public function defineGestures(param1:XML) : Boolean
      {
         ...
         while(_loc4_ < _loc3_.length())
         {
            ...
            _loc6_ = String(_loc5_.@id);
            _loc7_ = int(_loc5_.@animationId);
            this.var_1451.add(_loc6_,_loc7_);
            _loc4_++;
         }
         return true;
      }
      ...
      {
         if(this.var_1172.getValue(param1) == null)
         {
            param1 = this.var_960;
         }
         return int(this.var_1172.getValue(param1));
      }
      
      public function getAnimationForGesture(param1:String) : int
      {
         if(this.var_1451.getValue(param1) == null)
         {
            return const_656;
         }
         return int(this.var_1451.getValue(param1));
      }
