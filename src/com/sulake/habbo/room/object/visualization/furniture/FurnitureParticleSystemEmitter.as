package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureParticleSystemEmitter extends FurnitureParticleSystemParticle
   {
      ...
      public static const const_1470:String = "cone";
      
      public static const const_1417:String = "plane";
      
      public static const const_1658:String = "sphere";
      ...
      private var var_863:Number = 0.1;
      ...
      public function setup(param1:int, param2:int, param3:Number, param4:Vector3D, param5:Number, param6:Number, param7:String, param8:Number, param9:int, param10:int) : void
      {
         ...
         this.var_243 = param6;
         this.var_2228 = param7;
         this.var_2227 = param9;
         this._energy = param8;
         this.var_2231 = param10;
         this.reset();
      }
      ...
      public function reset() : void
      {
         ...
         this.var_862 = 0;
         this.var_878 = false;
         this.init(0,0,0,this._direction,this.var_2232,this.var_863,this.var_2227,true);
      }
      ...
      public function configureParticle(param1:int, param2:Boolean, param3:Array, param4:Boolean) : void
      {
         ...
         _loc5_["fade"] = param4;
         this.var_1072.push(_loc5_);
      }
      
      override protected function ignite() : void
      {
         this.var_878 = true;
         if(this.var_862 < this.var_1319)
         {
            if(this.age > 1)
            {
      ...
      private function releaseParticles(param1:FurnitureParticleSystemParticle, param2:Vector3D = null) : void
      {
         ...
         while(_loc10_ < this.var_2230)
         {
            ...
            _loc4_.init(param1.x,param1.y,param1.z,_loc3_,this._energy,this.var_863,_loc6_,_loc7_,_loc9_,_loc8_);
      ...
      {
         var _loc1_:int = Math.floor(Math.random() * this.var_1072.length);
         return this.var_1072[_loc1_];
      }
      ...
      override public function update() : void
      {
         ...
         if(!isAlive && this.var_862 < this.var_1319)
         {
            if(this.age % this.var_2231 == 0)
            {
               this.releaseParticles(this,this.direction);
            }
         }
      ...
      public function verlet() : void
      {
         ...
         if(isAlive || this.var_862 < this.var_1319)
         {
            ...
            this.y = (2 - this.var_243) * this.y - (1 - this.var_243) * this.lastY + this.var_1621 * this.var_863 * this.var_863;
         ...
         for each(_loc2_ in this.var_338)
         {
            ...
            _loc2_.y = (2 - this.var_243) * _loc2_.y - (1 - this.var_243) * _loc2_.lastY + this.var_1621 * this.var_863 * this.var_863;
