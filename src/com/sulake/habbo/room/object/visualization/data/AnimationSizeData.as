package com.sulake.habbo.room.object.visualization.data
{
   ...
   public class AnimationSizeData extends SizeData
   {
      ...
      {
         var _loc3_:AnimationData = this.var_295.getValue(param1) as AnimationData;
         if(_loc3_ != null)
         {
      ...
      {
         var _loc6_:* = null;
         var _loc5_:AnimationData = this.var_295.getValue(param1) as AnimationData;
         if(_loc5_ != null)
         {
      ...
      {
         var _loc8_:* = null;
         var _loc7_:AnimationData = this.var_295.getValue(param1) as AnimationData;
         if(_loc7_ != null)
         {
