package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1452:int = 16777215;
      
      public static const const_1552:int = 13421772;
      
      private static const const_963:int = 16777215;
      
      private static const const_965:int = 13421772;
      
      private static const const_966:int = 10066329;
      
      private static const const_964:int = 10066329;
      
      public static const const_1497:int = 16777215;
      
      public static const const_1479:int = 13421772;
      
      public static const const_1531:int = 10066329;
      ...
      private var var_2582:int = 255;
      
      private var var_2583:int = 255;
      ...
      private const const_2014:int = 250;
      ...
      private var var_2477:Number = 0.0;
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_1119);
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_1115);
         var _loc7_:int = 0;
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_211,true,_loc11_,_loc6_);
               if(_loc14_.z != 0)
               {
            ...
            else if(_loc12_ == RoomPlaneData.const_166)
            {
               ...
               {
                  _loc13_.color = const_965;
               }
               else
               {
                  _loc13_.color = const_966;
               }
               if(this._data != null)
               {
            ...
            else if(_loc12_ == RoomPlaneData.const_1602)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_113,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean) : void
      {
         ...
         if(_loc8_ < this._lastUpdateTime + this.const_2014 && !_loc5_ && !_loc7_)
         {
            return;
         }
         ...
         {
            _loc9_ = 0;
            while(_loc9_ < this.var_371.length)
            {
               _loc10_ = this.var_619[_loc9_];
               _loc11_ = getSprite(_loc10_);
               _loc12_ = this.var_371[_loc9_] as RoomPlane;
               if(_loc11_ != null && _loc12_ != null && _loc12_.type != RoomPlane.const_95)
               {
                  if(this.var_1838)
                  {
                     _loc13_ = uint(_loc12_.color);
                     _loc14_ = uint((_loc13_ & 255) * this.var_2584 / 255);
                     _loc15_ = uint((_loc13_ >> 8 & 255) * this.var_2583 / 255);
                     _loc16_ = uint((_loc13_ >> 16 & 255) * this.var_2582 / 255);
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1696)
         {
            ...
            if(_loc3_ != null && (_loc3_.x != this.var_1398 || _loc3_.y != this.var_2479 || _loc3_.z != this.var_2480 || param1.scale != this.var_2477))
            {
               this.var_1398 = _loc3_.x;
               this.var_2479 = _loc3_.y;
               this.var_2480 = _loc3_.z;
               this.var_2477 = param1.scale;
               _loc2_ = true;
            }
         }
         return _loc2_;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         {
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_1172);
            ...
            _loc4_ = uint(param1.getNumber(RoomObjectVariableEnum.const_758));
            if(_loc4_ != this.var_1171)
            {
               this.var_1171 = _loc4_;
               this.var_2584 = this.var_1171 & 255;
               this.var_2583 = this.var_1171 >> 8 & 255;
               this.var_2582 = this.var_1171 >> 16 & 255;
               _loc2_ = true;
            }
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_1175));
            if(_loc5_ != this.var_1838)
            {
               this.var_1838 = _loc5_;
               _loc2_ = true;
            }
         }
         return _loc2_;
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_169 != param1.getUpdateID())
         {
            _loc2_ = param1.getString(RoomObjectVariableEnum.const_736);
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_703);
            _loc4_ = param1.getString(RoomObjectVariableEnum.const_854);
            this.updatePlaneTextureTypes(_loc3_,_loc2_,_loc4_);
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_753));
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_876));
      ...
      protected function updatePlaneTextureTypes(param1:String, param2:String, param3:String) : Boolean
      {
         ...
         while(_loc4_ < this.var_132.length)
         {
            ...
            if(_loc5_ != null)
            {
               if(_loc5_.type == RoomPlane.const_211 && param1 != null)
               {
                  _loc5_.id = param1;
               }
               ...
               if(_loc12_ != null)
               {
                  if(_loc12_.update(param1,_loc5_))
                  {
                     if(_loc12_.visible)
                     {
                        ...
                        if(_loc12_.type != RoomPlane.const_211)
                        {
      ...
      private function updateSprite(param1:IRoomObjectSprite, param2:RoomPlane, param3:String, param4:Number) : void
      {
         ...
         param1.assetName = param3 + "_" + this.var_1752;
      }
         ...
         while(_loc8_ < this.var_500.maskCount)
         {
            ...
            if(_loc11_ != null)
            {
               ...
               while(_loc13_ < this.var_132.length)
               {
                  ...
                  if(_loc3_.type == RoomPlane.const_113 || _loc3_.type == RoomPlane.const_95)
                  {
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_113 || _loc3_.type == RoomPlane.const_95 && _loc12_ == RoomPlaneBitmapMaskData.const_250)
                              {
