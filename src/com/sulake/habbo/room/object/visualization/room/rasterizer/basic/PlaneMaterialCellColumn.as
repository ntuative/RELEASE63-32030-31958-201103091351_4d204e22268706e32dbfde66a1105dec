   ...
   public class PlaneMaterialCellColumn
   {
      ...
      public function render(param1:int, param2:IVector3d) : BitmapData
      {
         ...
         if(this.isStatic)
         {
            if(this.var_31 != null)
            {
               if(this.var_31.height == param1 && Vector3d.isEqual(this.var_712,param2))
               {
                  return this.var_31;
               }
               this.var_31.dispose();
         ...
         if(this.var_31 == null)
         {
            this.var_31 = new BitmapData(this._width,param1,true,16777215);
         }
