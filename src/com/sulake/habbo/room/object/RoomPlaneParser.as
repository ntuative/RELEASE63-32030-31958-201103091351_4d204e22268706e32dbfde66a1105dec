package com.sulake.habbo.room.object
{
   ...
   public class RoomPlaneParser
   {
      ...
      private var var_1920:Number = 0.0;
      
      private var var_1209:Number = 0.0;
      
      private var var_133:Number = 0.0;
      
      private var var_871:Number = 0.0;
      ...
      public function initializeTileMap(param1:int, param2:int) : Boolean
      {
         ...
         this._width = param1;
         this._height = param2;
         this.var_516 = this._width;
         this.var_517 = -1;
         this.var_515 = this._height;
         this.var_514 = -1;
         return true;
      }
      ...
      public function setTileHeight(param1:int, param2:int, param3:Number) : Boolean
      {
         ...
         if(param1 >= 0 && param1 < this._width && param2 >= 0 && param2 < this._height)
         {
            ...
            {
               if(param1 == this.var_516 || param1 == this.var_517)
               {
                  _loc5_ = false;
                  _loc6_ = this.var_515;
                  while(_loc6_ < this.var_514)
                  {
               ...
               if(param2 == this.var_515 || param2 == this.var_514)
               {
                  _loc7_ = false;
                  _loc8_ = this.var_516;
                  while(_loc8_ < this.var_517)
                  {
      ...
      public function initializeFromTileData(param1:Boolean = false) : Boolean
      {
         ...
         this.var_871 = getFloorHeight(this.var_162);
         if(!param1)
         {
      ...
      {
         var _loc11_:* = null;
         this.addPlane(RoomPlaneData.const_166,param1,param2,param3,[param4]);
         ...
         this.addPlane(RoomPlaneData.const_166,Vector3d.sum(param1,param3),param2,_loc10_,[_loc9_,param4]);
         if(param5)
         {
            this.addPlane(RoomPlaneData.const_166,Vector3d.sum(Vector3d.sum(param1,param2),param3),Vector3d.product(param3,-(param3.length + this.var_133) / param3.length),_loc10_,[_loc9_,param4]);
         }
         if(param6)
         {
            this.addPlane(RoomPlaneData.const_166,Vector3d.sum(param1,Vector3d.product(param3,-this.var_133 / param3.length)),Vector3d.product(param3,(param3.length + this.var_133) / param3.length),_loc10_,[_loc9_,param4]);
            if(param7)
            {
               _loc11_ = Vector3d.product(param2,this.var_1209 / param2.length);
               this.addPlane(RoomPlaneData.const_166,Vector3d.sum(Vector3d.sum(param1,param3),Vector3d.product(_loc11_,-1)),_loc11_,_loc10_,[_loc9_,param2,param4]);
            }
         }
      }
      ...
      private function addFloor(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean, param8:Number, param9:Number, param10:Number, param11:Number) : void
      {
         ...
         if(_loc12_)
         {
            ...
            if(param6)
            {
               ...
               _loc14_ = this.addPlane(RoomPlaneData.const_202,_loc13_,new Vector3d(0,0,-this.var_133),param2);
               if(_loc14_ != null)
               {
                  if(param8 > 0)
                  {
            ...
            if(param7)
            {
               ...
               _loc14_ = this.addPlane(RoomPlaneData.const_202,_loc13_,new Vector3d(0,0,-this.var_133),Vector3d.product(param2,-1));
               if(_loc14_ != null)
               {
                  if(param9 > 0)
                  {
            ...
            if(param4)
            {
               ...
               _loc15_ = this.addPlane(RoomPlaneData.const_202,_loc13_,new Vector3d(0,0,-this.var_133),Vector3d.product(param3,-1));
               if(_loc15_ != null)
               {
                  if(param11 > 0)
                  {
            ...
            if(param5)
            {
               ...
               _loc15_ = this.addPlane(RoomPlaneData.const_202,_loc13_,new Vector3d(0,0,-this.var_133),param3);
               if(_loc15_ != null)
               {
                  if(param10 > 0)
                  {
      ...
      public function getPlaneType(param1:int) : int
      {
         if(param1 < 0 || param1 >= this.planeCount)
         {
            return RoomPlaneData.const_992;
         }
         var _loc2_:RoomPlaneData = this.var_132[param1] as RoomPlaneData;
         if(_loc2_ != null)
         {
