package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1513:int = 255;
      
      private var var_1268:uint = 16777215;
      
      private var var_1522:int = 255;
      
      private var var_1012:uint = 16777215;
      
      private var var_1520:int = 255;
      
      private var var_1013:int = 0;
      
      private var var_1521:int = 1500;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_1119,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_758,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_753,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_876,1);
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1013)
         {
            _loc2_ = param1;
            _loc3_ = this._color;
            _loc4_ = this.var_1513;
            if(_loc2_ - this.var_1013 >= this.var_1521)
            {
               _loc3_ = this.var_1012;
               _loc4_ = this.var_1520;
               this.var_1013 = 0;
            }
            else
            {
               _loc7_ = this.var_1268 >> 16 & 255;
               _loc8_ = this.var_1268 >> 8 & 255;
               _loc9_ = this.var_1268 & 255;
               _loc10_ = this.var_1012 >> 16 & 255;
               _loc11_ = this.var_1012 >> 8 & 255;
               _loc12_ = this.var_1012 & 255;
               _loc13_ = (_loc2_ - this.var_1013) / this.var_1521;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_1522 + (this.var_1520 - this.var_1522) * _loc13_;
               this._color = _loc3_;
               this.var_1513 = _loc4_;
            }
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_758,_loc3_);
         }
      }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_622:
               param2.setString(RoomObjectVariableEnum.const_703,param1.value);
               break;
            ...
            case RoomObjectRoomUpdateMessage.const_852:
               param2.setString(RoomObjectVariableEnum.const_854,param1.value);
         }
      }
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         if(_loc4_)
         {
            ...
            param2.setString(RoomObjectVariableEnum.const_1172,_loc7_);
         }
      }
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1021:
               param2.setNumber(RoomObjectVariableEnum.const_876,_loc3_);
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_1175,int(param1.bgOnly));
         this.var_1268 = this._color;
         this.var_1522 = this.var_1513;
         this.var_1012 = _loc3_;
         this.var_1520 = _loc4_;
         this.var_1013 = getTimer();
         this.var_1521 = 1500;
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > this._planeParser.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_491,0);
            }
            return;
         }
         _loc5_--;
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1501,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1532,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1645,_loc22_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_491,_loc5_ + 1);
            var _loc23_:String = "";
            var _loc24_:int = 0;
            var _loc25_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  {
                     if(_loc13_ == RoomPlaneData.const_202)
                     {
                        _loc25_ = new RoomObjectTileMouseEvent(_loc26_,param1.eventId,_loc24_,_loc23_,_loc20_,_loc21_,_loc22_);
                     }
                     else if(_loc13_ == RoomPlaneData.const_166 || _loc13_ == RoomPlaneData.const_317)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
