package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureScoreBoardLogic extends FurnitureLogic
   {
      ...
      private static const const_954:int = 3000;
      ...
      private function updateScore(param1:int) : void
      {
         ...
         {
            _loc3_ = this.var_730 - _loc2_;
            if(_loc3_ < 0)
            {
               _loc3_ = -_loc3_;
            }
            if(_loc3_ * const_416 > const_954)
            {
               this.var_1123 = const_954 / _loc3_;
            }
            else
            {
               this.var_1123 = const_416;
            }
      ...
      override public function update(param1:int) : void
      {
         ...
         if(object != null)
         {
            ...
            if(_loc2_ != this.var_730 && param1 >= this.var_1385 + this.var_1123)
            {
               ...
               if(_loc4_ > _loc5_ * (this.var_730 - _loc2_))
               {
                  _loc4_ = _loc5_ * (this.var_730 - _loc2_);
               }
               object.setState(_loc2_ + _loc5_ * _loc4_,0);
               this.var_1385 = param1 - (_loc3_ - _loc4_ * this.var_1123);
            }
         }
      }
   }
