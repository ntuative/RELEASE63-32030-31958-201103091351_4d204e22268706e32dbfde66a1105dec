package com.sulake.habbo.room.utils
{
   public class TileHeightMap
   {
      ...
      {
         var _loc3_:* = null;
         if(param1 >= 0 && param1 < this.var_147 && param2 >= 0 && param2 < this.var_148)
         {
      ...
      public function isRoomTile(param1:int, param2:int) : Boolean
      {
         ...
         if(param1 >= 0 && param1 < this.var_147 && param2 >= 0 && param2 < this.var_148)
         {
            _loc3_ = this.var_1043[param2] as Array;
            return Boolean(_loc3_[param1]);
         }
         return true;
      }
      ...
      public function setIsRoomTile(param1:int, param2:int, param3:Boolean) : void
      {
         ...
         if(param1 >= 0 && param1 < this.var_147 && param2 >= 0 && param2 < this.var_148)
         {
            _loc4_ = this.var_1043[param2] as Array;
            _loc4_[param1] = param3;
            if(!param3)
            {
      ...
      public function validateLocation(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int, param7:int, param8:int) : Boolean
      {
         ...
         if(param3 > this.var_147)
         {
            return false;
         }
         if(param4 > this.var_148)
         {
            return false;
         }
         if(param1 + param3 > this.var_147 || param2 + param4 > this.var_148)
         {
            return false;
         }
         if(param5 < 0 || param5 >= this.var_147)
         {
            param5 = 0;
         }
         if(param6 < 0 || param6 >= this.var_148)
         {
            param6 = 0;
         }
         if(param7 > this.var_147)
         {
            param7 = this.var_147;
         }
         if(param8 > this.var_148)
         {
            param8 = this.var_148;
         }
         if(param5 + param7 >= this.var_147)
         {
            param7 = this.var_147 - param5;
         }
         if(param6 + param8 >= this.var_148)
         {
            param8 = this.var_148 - param6;
         }
         var _loc9_:int = 0;
         var _loc10_:int = 0;
         var _loc11_:* = null;
