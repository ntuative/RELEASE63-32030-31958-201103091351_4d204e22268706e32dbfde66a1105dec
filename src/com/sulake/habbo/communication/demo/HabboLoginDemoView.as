package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      private function createWindow() : void
      {
         ...
         this._window = this.var_142.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_135,HabboWindowStyle.const_42,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         ...
         var _loc7_:SharedObject = SharedObject.getLocal(this.const_1690,"/");
         if(_loc5_ != null)
         {
         ...
         if(_loc8_)
         {
            ...
            {
               if(this.var_142.habboConfiguration.getKey("use.sso","false") == "HabboHelpCom_help_faq_entry_xml")
               {
                  _loc8_.select();
               }
            }
      ...
      private function windowEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(this.const_1690,"/");
      ...
      private function initSSOTicket(param1:Boolean) : void
      {
         ...
         {
            this.var_122.removeEventListener(SSOTicket.const_356,this.onParsedTicketSuccess);
            this.var_122.removeEventListener(SSOTicket.const_293,this.onParsedTicketFailure);
            this.var_122 = null;
         }
         var _loc2_:String = "";
         ...
         this.var_122 = new SSOTicket(this.var_142.assets,_loc3_,_loc2_,param1);
         this.var_122.addEventListener(SSOTicket.const_356,this.onParsedTicketSuccess);
         this.var_122.addEventListener(SSOTicket.const_293,this.onParsedTicketFailure);
      }
      
      private function onParsedTicketSuccess(param1:Event) : void
      {
         Logger.log("Got ticket: " + this.var_122.ticket);
         Logger.log("Has Facebook: " + this.var_122.isFacebookUser);
         if(this.var_122.isFacebookUser)
         {
            this.var_142.habboConfiguration.setKey("facebook.user","1");
         }
         this.var_142.shockwaveClientUrl = this.var_122.shockwaveClientUrl;
         this.var_142.ssoTicket = this.var_122.ticket;
         this.var_122.removeEventListener(SSOTicket.const_356,this.onParsedTicketSuccess);
         this.var_122.removeEventListener(SSOTicket.const_293,this.onParsedTicketFailure);
         this.var_122 = null;
         dispatchEvent(new Event(const_536));
