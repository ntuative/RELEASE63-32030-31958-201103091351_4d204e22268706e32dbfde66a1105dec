package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_2349:PseudoRandom;
      ...
      private const const_1690:String = "fuselogin";
      ...
      public function setSSOTicket(param1:String) : void
      {
         ...
         {
            this.var_587 = param1;
            this.var_55.initConnection(HabboConnectionType.const_231);
         }
      }
      ...
      {
         if(this.var_55 && this.var_152 && this.var_15 && this._windowManager)
         {
      ...
      private function componentsAreRunning() : void
      {
         ...
         var _loc1_:String = this.var_152.getKey("client.hotel_view.image");
         var _loc2_:String = this.var_152.getKey("image.library.url");
         if(_loc1_ != null && _loc2_ != null)
         {
            this.var_214.loadHotelViewImage(_loc2_ + _loc1_);
         }
         var _loc3_:* = this.var_152.getKey("use.sso.ticket") == "1";
         this.var_587 = this.var_152.getKey("sso.ticket",null);
         this.var_1687 = this.var_152.getKey("flash.client.url","");
         this.var_2348 = this.var_152.getKey("external.variables.txt","");
         if(this.var_214 == null)
         {
            this.var_214 = new HabboHotelView(this._windowManager,assets,Component(context).events);
         }
         if(_loc3_)
         {
            this.var_55.mode = HabboConnectionType.const_86;
            if(this.var_587)
            {
               this.var_55.initConnection(HabboConnectionType.const_231);
            }
         ...
         else if(this._windowManager != null)
         {
            ...
            if(_loc4_)
            {
               ...
               this.var_17.addEventListener(HabboLoginDemoView.const_536,this.onInitConnection);
            }
         }
      }
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               this.var_55.mode = HabboConnectionType.const_1121;
            }
         }
         this.var_55.initConnection(HabboConnectionType.const_231);
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_781);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         this.var_2349 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(this.var_55.mode)
         {
            case HabboConnectionType.const_86:
               _loc6_ = "";
               ...
               this.var_1350 = _loc4_;
               this.var_214.loadBannerImage(_loc7_ + "?token=" + this.var_1350,this.onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1121:
               this.sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1574:
               this.var_891 = this.generateRandomHexString(30);
               this.var_477 = new DiffieHellman(new BigInteger(this.var_152.getKey("connection.development.prime"),16),new BigInteger(this.var_152.getKey("connection.development.generator"),16));
               this.var_477.init(this.var_891);
               _loc8_ = this.var_477.getPublicKey(10);
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         this.var_477.generateSharedKey(_loc4_,10);
         var _loc5_:String = this.var_477.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,this.var_2349);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         connection.send(new VersionCheckMessageComposer(401,this.var_1687,this.var_2348));
         var machineId:String = "";
         try
         {
            so = SharedObject.getLocal(this.const_1690,"/");
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_587 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(this.var_587);
            _loc2_.send(_loc4_);
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !this.var_2347)
         {
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,this.var_1350);
         ...
         this.var_477 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 10;
         var _loc14_:* = null;
         while(_loc13_ > 0)
         {
            _loc14_ = this.generateRandomHexString(30);
            this.var_477.init(_loc14_);
            _loc15_ = this.var_477.getPublicKey(10);
            if(_loc15_.length >= 64)
            {
               _loc12_ = _loc15_;
               this.var_891 = _loc14_;
            }
