package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_1613:uint = 9;
      
      public static const const_180:uint = 0;
      
      public static const const_182:uint = 1;
      
      public static const const_368:uint = 2;
      
      public static const const_314:uint = 3;
      
      public static const const_570:uint = 4;
      ...
      public function startTrading(param1:int, param2:String, param3:Boolean, param4:int, param5:String, param6:Boolean) : void
      {
         ...
         this.var_54.updateItemList(this.var_660);
         this.var_54.updateItemList(this.var_1260);
      ...
      public function close() : void
      {
         if(this.var_782)
         {
            if(this._state != const_180 && this._state != const_234)
            {
      ...
      {
         this.var_54.setMinimized(param1 != InventoryCategory.const_75);
         this._inventory.updateSubView();
      }
      
      public function set state(param1:uint) : void
      {
         Logger.log("OLD STATE: " + this._state + " NEW STATE: " + param1 + " OWN: " + this.var_659 + " OTHER: " + this.var_1009);
         ...
         {
            case const_180:
               if(param1 == const_182 || param1 == const_234)
               {
                  this._state = param1;
                  _loc2_ = true;
               }
      ...
      public function getOwnItemIdsInTrade() : Array
      {
         ...
         var _loc4_:int = 0;
         while(_loc4_ < this.var_233.length)
         {
            _loc2_ = this.var_233.getWithIndex(_loc4_) as GroupItem;
            if(_loc2_ != null)
            {
               _loc5_ = 0;
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            this.var_54.alertPopup(TradingView.const_1105);
         }
         else if(param1 is TradingAcceptEvent)
         {
            Logger.log("TRADING::TradingAcceptEvent");
            if(TradingAcceptEvent(param1).userID == this.var_660)
            {
               this.var_659 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
               this.var_1009 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            this.var_54.updateUserInterface();
         }
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            if(_loc2_.userID != this.var_660)
            {
               this.var_54.alertPopup(TradingView.const_1043);
            }
            this.close();
         }
      ...
      public function requestAddItemToTrading(param1:int, param2:int, param3:int, param4:Boolean, param5:String = "") : Boolean
      {
         ...
         if(this.var_233.length < const_1613)
         {
