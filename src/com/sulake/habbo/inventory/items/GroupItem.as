package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_813:int = 0;
      
      protected var var_658:BitmapData;
      
      protected var var_2671:int;
      
      protected var var_1511:Boolean;
      
      protected var var_2019:Boolean;
      
      protected var var_2778:BitmapData;
      
      private const const_1986:int = 8947848;
      
      private const const_1987:int = 13421772;
      
      private const const_1729:Number = 1;
      
      private const const_1730:Number = 0.2;
      ...
      public function initImage(param1:Boolean = true) : void
      {
         ...
         if(this.var_2779 == FurniModel.const_43)
         {
            _loc2_ = this._roomEngine.getFurnitureIcon(this._type,this,String(this.var_1443));
         }
         else
         {
            _loc2_ = this._roomEngine.getWallItemIcon(this._type,this,this.var_2020);
         }
         if(_loc2_.id > 0)
         {
            if(param1)
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               this._window.blend = this.const_1730;
               _loc1_.blend = this.const_1730;
            }
            else
            {
         ...
         if(_loc5_)
         {
            if(this.var_2019 && this.getRecyclableCount() > 0)
            {
               _loc5_.bitmap = this.var_2778;
               _loc5_.visible = true;
            }
            else
            {
