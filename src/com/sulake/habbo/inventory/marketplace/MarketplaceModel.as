package com.sulake.habbo.inventory.marketplace
{
   ...
   public class MarketplaceModel implements IInventoryModel
   {
      ...
      public function getItemStats() : void
      {
         ...
         this.var_2429 = _loc2_;
         this.var_2430 = this.var_220.type;
      ...
      public function proceedOfferMaking(param1:int, param2:int) : void
      {
         ...
         switch(param1)
         {
            ...
            case 3:
               ...
               break;
            case 4:
               this.var_17.showBuyTokens(this.var_1736,this.var_1737);
         }
      }
      ...
      public function endOfferMaking(param1:int) : void
      {
         ...
         this.var_17.method_7(param1);
      }
      
      public function setAveragePrice(param1:int, param2:int, param3:int) : void
      {
         if(param1 != this.var_2429 || param2 != this.var_2430)
         {
            return;
         }
         if(!this.var_17)
         ...
         this.var_17.updateAveragePrice(param3,this.var_2151);
      }
