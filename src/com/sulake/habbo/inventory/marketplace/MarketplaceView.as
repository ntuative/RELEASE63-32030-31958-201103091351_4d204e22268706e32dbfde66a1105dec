package com.sulake.habbo.inventory.marketplace
{
   ...
   public class MarketplaceView implements IGetImageListener
   {
      ...
      public function showMakeOffer(param1:IItem) : void
      {
         ...
         this.var_2050 = this._localization.getKey(_loc5_);
      ...
      {
         this._localization.registerParameter("inventory.marketplace.confirm_offer.info","furniname",this.var_2050);
         this._localization.registerParameter("inventory.marketplace.confirm_offer.info","price",this.var_1531.toString());
      ...
      private function confirmationCallback(param1:IConfirmDialog, param2:WindowEvent) : void
      {
         ...
         {
            this.var_68.makeOffer(this.var_1531);
         }
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               ...
               case "make_offer_button":
                  ...
                  if(_loc3_ != null)
                  {
                     this.var_1531 = parseInt(_loc3_.text);
      ...
      {
         var _loc1_:* = null;
         if(false && "HabboHelpCom_help_faq_entry_xml" == this._config.getKey("client.credits.embed.enabled"))
         {
      ...
      public function method_7(param1:int) : void
      {
         var _loc2_:* = null;
         if(param1 == 1)
         {
