package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      public static const const_388:String = "pets";
      ...
      private var var_1828:Vector.<Array>;
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboCatalog, param8:IHabboSoundManager)
      {
         ...
         this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_270,this.onObjectPlaced);
         this._catalog = param7;
         this.var_504 = param8;
         this.var_616 = new Timer(const_1351,1);
         this.var_616.addEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
         var _loc9_:IAsset = this._assets.getAssetByName("inventory_thumb_xml");
         var _loc10_:XmlAsset = XmlAsset(_loc9_);
         this.var_2563 = XML(_loc10_.content);
         this.clearFurniList();
         this.var_17 = new FurniView(this,param2,this._windowManager,this._assets,this._roomEngine,this.var_504);
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._roomEngine != null)
            {
               ...
               {
                  this._roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_270,this.onObjectPlaced);
               }
            ...
            {
               this.var_616.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
               this.var_616.stop();
               this.var_616 = null;
            }
      ...
      public function insertFurniList(param1:String, param2:Array, param3:int, param4:int) : void
      {
         ...
         if(param3 >= param4 && param3 > 1)
         {
            ...
            else
            {
               ...
               {
                  this.var_1828 = new Vector.<Array>(param3,true);
               }
               _loc15_ = this.var_1828;
            }
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         else if(param3 == FurniCategory.const_408)
         {
         ...
         if(this.var_952 == null)
         {
            this.var_952 = this._windowManager.buildFromXML(this.var_2563) as IWindowContainer;
         }
         var _loc11_:IWindowContainer = this.var_952.clone() as IWindowContainer;
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_617.add(const_43,new Array());
         this.var_617.add(const_50,new Array());
         if(this.var_17 != null)
         {
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_335 || _loc3_.category == FurniCategory.const_385 || _loc3_.category == FurniCategory.const_408)
         {
            if(param1)
            {
               return false;
      ...
      {
         if(this.var_1433 && param1.type == RoomEngineObjectEvent.const_270)
         {
            this.var_1433 = false;
         }
      }
      ...
      public function getAllStripIds(param1:String, param2:Array) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            while(_loc4_ < _loc3_.length)
            {
               ...
               if(_loc5_.category == FurniCategory.const_894)
               {
                  _loc6_ = 1;
               }
               _loc7_ = 0;
