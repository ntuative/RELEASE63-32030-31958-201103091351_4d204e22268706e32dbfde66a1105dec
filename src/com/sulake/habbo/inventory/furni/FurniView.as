package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private const const_2031:int = 0;
      
      private const const_983:int = 1;
      
      private const const_1708:int = 2;
      
      private const const_1707:int = 3;
      
      private const const_1722:int = 42;
      
      private const const_1723:int = 120;
      ...
      private var var_691:MarketplaceModel;
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine, param6:IHabboSoundManager)
      {
         ...
         this.var_504 = param6;
         this.var_504.events.addEventListener(SongInfoReceivedEvent.const_801,this.onSongInfoReceivedEvent);
         this.var_432 = new Map();
         this.var_432.add(FurniModel.const_43,new FurniGridView(this.var_68,FurniModel.const_43,this._windowManager,this._assetLibrary,this._roomEngine));
         this.var_432.add(FurniModel.const_50,new FurniGridView(this.var_68,FurniModel.const_50,this._windowManager,this._assetLibrary,this._roomEngine));
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this.var_504)
            {
               this.var_504.events.removeEventListener(SongInfoReceivedEvent.const_801,this.onSongInfoReceivedEvent);
               this.var_504 = null;
            }
            this.var_624 = null;
            this._disposed = true;
      ...
      private function showCategoryGrid(param1:String = null) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_432.getValue(this.var_433);
         if(_loc3_)
         {
      ...
      {
         var _loc2_:int = 0;
         var _loc1_:Array = this.var_68.getCategoryContent(this.var_433);
         if(!this.var_68.isListInited())
         {
            _loc2_ = this.const_983;
         }
         ...
         {
            _loc2_ = this.const_1707;
         }
         if(this.var_2516 == _loc2_)
         {
            return;
         }
      ...
      public function clearViews() : void
      {
         ...
         while(_loc4_ < _loc1_.length)
         {
            ...
            _loc3_ = this.var_432.getValue(_loc2_);
            if(_loc3_ != null)
            {
               _loc3_.clearGrid();
            }
      ...
      public function updateItem(param1:String, param2:GroupItem, param3:int) : void
      {
         ...
         var _loc4_:FurniGridView = this.var_432.getValue(param1);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function addItemToBottom(param1:String, param2:GroupItem) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_432.getValue(param1);
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function updateActionView() : void
      {
         ...
         _loc4_ = this.var_68.getGroupItemInIndex(_loc3_,this.var_433);
         if(_loc3_ > -1 && _loc4_ != null && _loc4_.peek() != null)
         {
            ...
            else if(_loc5_.category == FurniCategory.const_408)
            {
         ...
         if(_loc11_)
         {
            if(_loc1_ && this.var_691 && this.var_691.isEnabled && _loc5_.sellable)
            {
               _loc11_.enable();
            }
            else
         ...
         if(_loc13_ != null)
         {
            ...
            if(_loc5_ != null)
            {
               if(_loc5_.category == FurniCategory.const_1171)
               {
                  _loc21_ = this.var_504.musicController.getSongInfo(_loc5_.extra);
                  if(_loc21_ != null)
                  {
                  ...
                  {
                     this.var_504.musicController.requestSongInfoWithoutSamples(_loc5_.extra);
                     this.var_624.push(_loc5_.extra);
                  }
               }
            }
         ...
         if(_loc14_ != null)
         {
            ...
            if(_loc5_ != null)
            {
               if(_loc5_.category == FurniCategory.const_1171)
               {
                  _loc22_ = this.var_504.musicController.getSongInfo(_loc5_.extra);
                  if(_loc22_ != null)
                  {
      ...
      private function setPreviewImage(param1:BitmapData) : void
      {
         ...
         if(_loc3_ > this.const_1723)
         {
            _loc3_ = this.const_1723;
         }
         else if(_loc3_ < this.const_1722)
         {
            _loc3_ = this.const_1722;
         }
         else
         {
         ...
         else if(param1.type == WindowEvent.const_61)
         {
            switch(param2.name)
            {
               ...
               case "tab_wall":
                  ...
                  break;
               case "tab_pets":
                  this.switchCategory(FurniModel.const_388);
            }
         }
      }
      ...
      {
         if(this.var_624.indexOf(param1.id as Number) != -1)
         {
            this.updateActionView();
            while(this.var_624.indexOf(param1.id as Number) != -1)
            {
               this.var_624.splice(this.var_624.indexOf(param1.id as Number),1);
            }
         }
      }
   }
