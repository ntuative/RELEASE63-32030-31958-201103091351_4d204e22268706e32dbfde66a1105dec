package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      private var var_1318:IThumbListDataProvider;
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         this.var_91 = this.var_569.height;
         this.var_1069 = param5;
         this.var_857 = param6;
         this.var_210 = Math.floor(this.var_1069 / this._thumbWidth);
         this.var_26 = new BitmapData(this.var_1069,this.var_857);
      }
      ...
      public function updateImageFromList() : void
      {
         ...
         this.var_26 = new BitmapData(Math.max(this.var_210 * this._thumbWidth,this.var_1069),Math.max(this.var_568 * this.var_91,this.var_857),true,16777215);
      ...
      public function addItemAsFirst(param1:IThumbListDrawableItem) : void
      {
         ...
         if(_loc3_.x == this.var_210 && this.var_26.height < _loc3_.y * this.var_91)
         {
         ...
         _loc4_ = new Rectangle(0,0,this._thumbWidth * (this.var_210 - 1),this.var_91);
         _loc2_.copyPixels(this.var_26,_loc4_,new Point(this._thumbWidth,0),null,null,true);
         _loc4_ = new Rectangle(this._thumbWidth * (this.var_210 - 1),0,this._thumbWidth,this.var_26.height);
         _loc2_.copyPixels(this.var_26,_loc4_,new Point(0,this.var_91),null,null,true);
         _loc4_ = new Rectangle(0,this.var_91,this._thumbWidth * (this.var_210 - 1),this.var_26.height - this.var_91);
      ...
      private function getList() : Array
      {
         ...
         {
            _loc1_ = this.var_1318.getDrawableList();
         }
      ...
      private function resolveRowCountFromList() : int
      {
         ...
         return int(Math.ceil(_loc1_.length / this.var_210));
      }
      ...
      {
         var _loc2_:Point = this.resolveGridLocationFromImage(param1);
         return int(_loc2_.y * this.var_210 + _loc2_.x);
      }
      ...
      {
         var _loc2_:int = Math.floor(param1 / this.var_210);
         var _loc3_:int = param1 % this.var_210;
         return new Point(_loc3_,_loc2_);
      }
      ...
      private function removeItemInImage(param1:Point) : void
      {
         ...
         var _loc4_:int = this.var_210 - param1.x - 1;
         ...
         if(this.var_26.height < this.var_857)
         {
            _loc12_ = new BitmapData(this.var_26.width,this.var_857);
