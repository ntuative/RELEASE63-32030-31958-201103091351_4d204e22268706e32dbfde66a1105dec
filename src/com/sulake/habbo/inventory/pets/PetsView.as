package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView, IPetImageListener, IGetImageListener
   {
      ...
      private var var_241:IItemGridWindow;
      ...
      private var var_363:PetsGridItem;
      ...
      public function PetsView(param1:PetsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IRoomEngine, param6:IAvatarRenderManager)
      {
         ...
         this.var_241 = this.var_17.findChildByName("grid") as IItemGridWindow;
      ...
      {
         this.updateGrid();
         this.updatePreview(this.var_363);
      }
      
      public function removePet(param1:int) : void
      {
         var _loc2_:PetsGridItem = this.var_608.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
         this.var_241.removeGridItem(_loc2_.window);
         if(this.var_363 == _loc2_)
         {
            this.var_363 = null;
            this.selectFirst();
         }
      ...
      {
         if(this.var_608 == null || this.var_608.length == 0)
         {
            this.updatePreview();
            return;
         }
         this.setSelectedGridItem(this.var_608.getWithIndex(0));
      }
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(this.var_608.getValue(param1.id) != null)
         {
            return;
         }
         ...
         if(_loc2_ != null)
         {
            this.var_241.addGridItem(_loc2_.window);
            this.var_608.add(param1.id,_loc2_);
      ...
      private function placeButtonClickHandler(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:PetData = this.var_363.pet;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      public function setSelectedGridItem(param1:PetsGridItem) : void
      {
         if(this.var_363 != null)
         {
            this.var_363.setSelected(false);
         }
         this.var_363 = param1;
         if(this.var_363 != null)
         {
            this.var_363.setSelected(true);
         }
