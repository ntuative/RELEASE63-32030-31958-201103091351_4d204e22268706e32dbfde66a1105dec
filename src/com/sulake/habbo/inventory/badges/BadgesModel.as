package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesModel implements IInventoryModel
   {
      ...
      {
         var _loc2_:int = 0;
         while(_loc2_ < this.var_986.length)
         {
            if(this.var_986[_loc2_] == param1)
            {
               this.var_986.splice(_loc2_,1);
      ...
      public function updateBadge(param1:String, param2:Boolean) : void
      {
         ...
         else
         {
            ...
            _loc8_.iconImage = this.var_287.getBadgeImage(param1);
      ...
      {
         if(param1 == InventoryCategory.const_298 && this._controller.isVisible)
         {
