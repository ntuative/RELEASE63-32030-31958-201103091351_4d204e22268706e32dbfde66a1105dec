package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationItemView implements IUpdateReceiver
   {
      ...
      public static const const_751:int = 70;
      ...
      private static const const_917:int = 2;
      
      private static const const_916:int = 3;
      ...
      private var var_2665:Map;
      
      private var var_393:Map;
      
      private var var_1034:uint;
      ...
      public function HabboNotificationItemView(param1:IAsset, param2:IHabboWindowManager, param3:Map, param4:Map, param5:IHabboToolbar, param6:HabboNotificationItem)
      {
         ...
         if(_loc8_ != null)
         {
            this.var_1562 = this._window.height - _loc8_.rectangle.bottom;
         }
         else
         {
            this.var_1562 = 15;
         }
         this.var_1560 = this._window.height;
         this.var_675 = 4;
         this.var_674 = 0;
         this._state = name_2;
         this.var_179 = param5;
      ...
      public function update(param1:uint) : void
      {
         ...
         switch(this._state)
         {
            ...
            case const_447:
               ...
               _loc2_ = Number(this.var_1034) / Number(this.var_393["time_fade_in"]);
               if(this.var_1034 > int(this.var_393["time_fade_in"]))
               {
                  this.startDisplay();
               }
            ...
            case const_917:
               ...
               if(this.var_1291 > int(this.var_393["time_display"]) && !this.var_1561)
               {
                  this.startFadeOut();
               }
               break;
            case const_916:
               ...
               _loc3_ = 1 - Number(this.var_1033) / Number(this.var_393["time_fade_out"]);
               this.adjustBlend(_loc3_);
               if(this.var_1033 > int(this.var_393["time_fade_in"]))
               {
                  this.startIdling();
               }
         }
      ...
      private function setNotificationText(param1:String) : void
      {
         ...
         _loc2_.text = param1;
         _loc2_.height = _loc2_.textHeight + this.var_1562;
         if(this._window.height < this.var_1560)
         {
            this._window.height = this.var_1560;
         }
      }
      ...
      public function reposition(param1:int = -1) : void
      {
         ...
         var _loc3_:int = this.var_179.orientation == "TOP" ? int(const_412) : 0;
         var _loc4_:int = this.var_179.orientation == "BOTTOM" ? int(_loc2_.height - const_412) : int(_loc2_.height);
         var _loc5_:int = this.var_179.orientation == "LEFT" ? int(const_412) : 0;
         var _loc6_:int = this.var_179.orientation == "RIGHT" ? int(_loc2_.width - const_412) : int(_loc2_.width);
         if(this.var_393["position_horizontal_follow_toolbar"] == "HabboHelpCom_help_faq_entry_xml" && (this.var_179.orientation != "TOP" && this.var_179.orientation != "BOTTOM"))
         {
         ...
         else if(this.var_393["position_horizontal"] == "left")
         {
            this._window.x = _loc5_ + const_432;
         }
         else
         ...
         if(this.var_393["position_vertical_follow_toolbar"] == "HabboHelpCom_help_faq_entry_xml" && (this.var_179.orientation != "RIGHT" && this.var_179.orientation != "LEFT"))
         {
            if(this.var_179.orientation == "TOP")
            {
               this._window.y = _loc3_ + this.var_675;
            }
            else
            {
               this._window.y = _loc4_ - this._window.height - this.var_675;
            }
         }
         else if(this.var_393["position_vertical"] == "top")
         {
            this._window.y = _loc3_ + this.var_675;
         }
         else
      ...
      private function adjustBlend(param1:Number) : void
      {
         ...
         this._window.blend = this.var_674;
      }
   }
}
