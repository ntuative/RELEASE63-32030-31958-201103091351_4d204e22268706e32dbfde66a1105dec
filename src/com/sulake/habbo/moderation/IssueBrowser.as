package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_2008:String = "my_issues";
      
      private const const_2006:String = "open_issues";
      
      private const const_2007:String = "picked_issues";
      ...
      private function selectView(param1:String) : void
      {
         ...
         if(this.var_356 == _loc2_)
         {
            return;
         }
         if(this.var_356 != null)
         {
            this.var_356.visible = false;
         }
         this.var_356 = _loc2_;
         if(this.var_356 == null)
         {
         ...
         this.var_356.view.width = this.var_250.container.width;
         this.var_356.view.height = this.var_250.container.height;
         this.var_356.visible = true;
         this.var_356.update();
      }
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_2008:
               if(this.var_1748 == null)
               {
                  this.var_1748 = new MyIssuesView(this.issueManager,this,this.var_250.container);
               }
               return this.var_1748;
            case this.const_2006:
               if(this.var_1747 == null)
               {
                  this.var_1747 = new OpenIssuesView(this.issueManager,this,this.var_250.container);
               }
               return this.var_1747;
            case this.const_2007:
               if(this.var_1746 == null)
               {
                  this.var_1746 = new PickedIssuesView(this.issueManager,this,this.var_250.container);
               }
