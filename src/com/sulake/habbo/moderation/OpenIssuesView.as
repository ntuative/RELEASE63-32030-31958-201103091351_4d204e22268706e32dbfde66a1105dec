package com.sulake.habbo.moderation
{
   ...
   public class OpenIssuesView implements IIssueBrowserView
   {
      ...
      private var var_2317:IssueListView;
      ...
      public function OpenIssuesView(param1:IssueManager, param2:IssueBrowser, param3:IWindowContainer)
      {
         ...
         this.var_589 = param2;
         this._window = this.var_589.createWindow("open_issues_xml") as IWindowContainer;
         param3.addChild(this._window);
         var _loc4_:IItemListWindow = this._window.findChildByName("issue_list") as IItemListWindow;
         this.var_2317 = new IssueListView(param1,param2,_loc4_,"open_issues_list_item_xml");
      }
      ...
      {
         var _loc1_:Array = this._issueManager.getBundles(IssueManager.const_1082);
         this.var_2317.update(_loc1_);
      }
   }
}
