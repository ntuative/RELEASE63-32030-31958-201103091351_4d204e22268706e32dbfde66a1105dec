package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_934:Array = [];
      
      private static var var_1782:int = 1000;
      
      private static var var_935:Array = [];
      
      private static var var_1783:int = 200;
      ...
      private var var_1763:IMessageComposer;
      ...
      {
         this.var_743 = IWindowContainer(this.var_34.getXmlWindow("chatlog_roomheader"));
         this.var_742 = IWindowContainer(this.var_34.getXmlWindow("chatlog_chatline"));
         this.var_468 = new Timer(1000,1);
         ...
         this.var_34.connection.send(this.var_1763);
      ...
      private function getChatLineWindow() : IWindowContainer
      {
         if(false)
         {
            return var_934.pop() as IWindowContainer;
         }
      ...
      private function getChatHeaderWindow() : IWindowContainer
      {
         if(false)
         {
            return var_935.pop() as IWindowContainer;
         }
      ...
      private function populateChatline(param1:IItemListWindow, param2:ChatlineData, param3:Boolean) : void
      {
         ...
         if(param2.chatterId > 0)
         {
            ...
            if(!this.var_1404.getValue(param2.chatterName))
            {
               this.var_1404.add(param2.chatterName,param2.chatterId);
            }
         }
      ...
      private function onChatLogUserClick(param1:WindowMouseEvent) : void
      {
         ...
         var _loc3_:int = this.var_1404.getValue(_loc2_);
      ...
      public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_1403)
         {
