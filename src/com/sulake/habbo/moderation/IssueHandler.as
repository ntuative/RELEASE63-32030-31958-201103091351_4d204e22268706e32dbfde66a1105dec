package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_480:UserInfoCtrl;
      
      private var var_1105:UserInfoCtrl;
      ...
      private function createView() : void
      {
         ...
         this.var_480 = new UserInfoCtrl(this._window,this.var_65,_loc3_.message);
         this.var_1105 = new UserInfoCtrl(this._window,this.var_65,_loc3_.message);
         this.var_480.load(IWindowContainer(this._window.findChildByName("caller_user_info")),_loc3_.reporterUserId);
         ...
         {
            this.var_1105.load(_loc4_,this.var_153.reportedUserId);
         }
         else
         {
      ...
      {
         if(this.var_65 != null && this.var_65.issueManager != null && this.var_153 != null)
         {
            this.var_65.issueManager.removeHandler(this.var_153.id);
         }
         this.dispose();
      }
      ...
      private function onCloseUseless(param1:WindowMouseEvent) : void
      {
         ...
         this.var_65.issueManager.closeBundle(this.var_153.id,1);
      ...
      private function onCloseAbusive(param1:WindowMouseEvent) : void
      {
         ...
         this.var_65.issueManager.closeBundle(this.var_153.id,2);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onCloseResolved(param1:WindowMouseEvent) : void
      {
         ...
         this.var_65.issueManager.closeBundle(this.var_153.id,3);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onRelease(param1:WindowMouseEvent) : void
      {
         ...
         this.var_65.issueManager.releaseBundle(this.var_153.id);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         this.var_65.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),this.var_65,WindowTracker.const_1077,_loc2_),this._window,false,false,true);
      }
      ...
      private function onReporterClicked(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc2_ != 0)
         {
            ...
            this.var_480 = new UserInfoCtrl(this._window,this.var_65,_loc3_.message);
            this.var_480.load(IWindowContainer(this._window.findChildByName("caller_user_info")),_loc2_);
         }
      }
