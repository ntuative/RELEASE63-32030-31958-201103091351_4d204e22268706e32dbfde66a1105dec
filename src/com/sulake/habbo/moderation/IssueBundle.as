package com.sulake.habbo.moderation
{
   ...
   public class IssueBundle
   {
      ...
      private var var_671:IssueMessageData = null;
      
      private var var_670:IssueMessageData = null;
      ...
      public function IssueBundle(param1:int, param2:IssueMessageData)
      {
         ...
         this.var_2100 = param2.pickerUserId;
         this.var_2101 = param2.pickerUserName;
         this.var_1488 = param2.reportedUserId;
      ...
      private function addIssue(param1:IssueMessageData) : void
      {
         ...
         this.var_1029 += param1.priority;
         if(param1.message != null && param1.message != "")
         {
            ++this.var_1028;
         }
         if(this.var_671 == null || param1.timeStamp < this.var_671.timeStamp)
         {
            this.var_671 = param1;
         }
         if(this.var_670 == null || param1.priority > this.var_670.timeStamp)
         {
            this.var_670 = param1;
         }
      }
      ...
      public function removeIssue(param1:int) : IssueMessageData
      {
         ...
         if(_loc2_ != null)
         {
            this.var_1029 -= _loc2_.priority;
            if(_loc2_.message != null && _loc2_.message != "")
            {
               --this.var_1028;
            }
            if(this.var_671 == _loc2_)
            {
               this.var_671 = null;
            }
      ...
      public function getHighestPriorityIssue() : IssueMessageData
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         var _loc1_:IssueMessageData = this.var_670;
         if(_loc1_ == null)
         {
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IssueMessageData = this.var_671;
         if(_loc2_ == null)
         {
