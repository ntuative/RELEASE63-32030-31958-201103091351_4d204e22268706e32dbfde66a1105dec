package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuSoundSettingsSlider
   {
      ...
      private var var_1159:MeMenuSoundSettingsView;
      ...
      public function set min(param1:Number) : void
      {
         ...
         this.setValue(this.var_1159.volume);
      }
      ...
      private function buttonProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_1159.saveVolume(this.getValue(param2.x),false);
      }
      ...
      private function displaySlider() : void
      {
         ...
         if(_loc3_ != null && this.var_704 != null)
         {
            _loc3_.bitmap = new BitmapData(this.var_704.width,this.var_704.height,true,16777215);
            _loc3_.bitmap.copyPixels(this.var_704,this.var_704.rect,new Point(0,0),null,null,true);
         }
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null && this.var_705 != null)
               {
                  ...
                  this.var_1653 = _loc1_.width - _loc3_.width;
               }
            }
         }
      }
