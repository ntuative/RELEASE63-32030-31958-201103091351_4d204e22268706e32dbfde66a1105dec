package com.sulake.habbo.widget.memenu
{
   ...
   public class EffectView
   {
      ...
      private const const_1979:int = 1000;
      ...
      {
         super();
         this.var_204 = new Timer(this.const_1979);
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         if(this.var_171.isActive)
         {
            ...
            this.var_830.width = _loc2_ * this.var_311;
         }
         else
         {
      ...
      private function setTimeLeft() : void
      {
         ...
         {
            this.var_677 = this._window.findChildByName("time_left") as ITextWindow;
            if(this.var_677 == null)
            {
               return;
            }
         ...
         if(!this.var_171.isActive)
         {
            this.var_677.caption = "${widgets.memenu.effects.activate}";
            return;
         }
         this.var_677.caption = "${widgets.memenu.effects.active.timeleft}";
         var _loc1_:String = this.var_677.text;
         var _loc2_:int = this.var_171.secondsLeft;
      ...
      private function createWindow(param1:String) : void
      {
         ...
         else
         {
            ...
            this.var_831 = this._window.findChildByName("effect_hilite");
         ...
         if(this.var_830 != null)
         {
            this.var_311 = this.var_830.width;
            this.var_204.start();
            this.onUpdate();
         }
