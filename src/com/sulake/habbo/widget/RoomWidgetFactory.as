package com.sulake.habbo.widget
{
   ...
   public class RoomWidgetFactory extends Component implements IRoomWidgetFactory
   {
      ...
      private var var_2799:IAssetLibrary;
      ...
      public function RoomWidgetFactory(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_2799 = param1.root.assets;
      ...
      public function createWidget(param1:String) : IRoomWidget
      {
         ...
         switch(param1)
         {
            case RoomWidgetEnum.const_342:
               _loc2_ = new RoomChatWidget(this._windowManager,assets,this.var_75,this.var_152,this.var_2240++,this);
               break;
            case RoomWidgetEnum.CHAT_INPUT_WIDGET:
               _loc2_ = new RoomChatInputWidget(this._windowManager,assets,this.var_75,this);
               break;
            case RoomWidgetEnum.const_427:
               _loc2_ = new InfostandWidget(this._windowManager,assets,this.var_75,this.var_152,this._catalog);
               break;
            case RoomWidgetEnum.const_485:
               _loc2_ = new MeMenuWidget(this._windowManager,assets,this.var_75,events,this.var_152);
               break;
            ...
            case RoomWidgetEnum.const_469:
               _loc2_ = new TeaserFurniWidget(this._windowManager,assets,this.var_75,this.var_152,this._inventory);
               break;
            ...
            case RoomWidgetEnum.const_509:
               _loc2_ = new LoadingBarWidget(this._windowManager,assets,this.var_75,this.var_152);
               break;
            case RoomWidgetEnum.const_843:
               _loc2_ = new RoomQueueWidget(this._windowManager,assets,this.var_75,this.var_152);
               break;
            case RoomWidgetEnum.const_117:
               _loc2_ = new VoteWidget(this._windowManager,assets,this.var_75,this.var_152);
               break;
