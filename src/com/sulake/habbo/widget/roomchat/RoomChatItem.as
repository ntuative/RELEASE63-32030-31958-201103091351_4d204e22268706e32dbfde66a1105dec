package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatItem
   {
      ...
      private static const const_959:Number = 18;
      
      private static const const_607:int = 6;
      
      private static const const_1347:int = 6;
      
      private static const const_958:int = 35;
      
      private static const const_589:String = "name";
      
      private static const const_957:String = "message";
      
      private static const const_1348:String = "pointer";
      ...
      public function RoomChatItem(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:String, param5:IHabboLocalizationManager, param6:String)
      {
         ...
         if(!var_428)
         {
            var_428 = this._windowManager.buildFromXML(this._assetLibrary.getAssetByName("bubble_shout").content as XML,1) as IRegionWindow;
         ...
         if(!var_368)
         {
            var_368 = this._windowManager.buildFromXML(this._assetLibrary.getAssetByName("bubble_whisper").content as XML,1) as IRegionWindow;
            var_368.tags.push("roomchat_bubble");
            var_368.x = 0;
            var_368.y = 0;
            var_368.width = 0;
            var_368.background = true;
            var_368.mouseThreshold = 0;
            var_223.setParamFlag(WindowParam.WINDOW_PARAM_FORCE_CLIPPING,true);
         }
      }
      ...
      {
         this.var_1421 = param1.chatType;
         this.var_1154 = param1.userId;
         this.var_946 = param1.userName;
         this.var_1153 = param1.userCategory;
         this._message = param1.text;
         this.var_367 = param1.links;
         this.var_1816 = param1.userX;
         this.var_257 = param1.userImage;
         this.var_2541 = param1.userColor;
      ...
      public function set y(param1:Number) : void
      {
         ...
         if(this._window != null)
         {
            this._window.y = param1 - this.var_750;
         }
      }
      ...
      {
         var _loc5_:Rectangle = new Rectangle(this._x,this.var_145,this.width,const_959);
      ...
      public function renderView() : void
      {
         ...
         var textWindow:ITextWindow = this._window.findChildByName(const_957) as ITextWindow;
         var pointerWindow:IBitmapWrapperWindow = this._window.findChildByName(const_1348) as IBitmapWrapperWindow;
         ...
         if(this.var_257 && !isRespect)
         {
            ...
            if(userIconWindow)
            {
               ...
               userIconWindow.x = x1;
               userIconWindow.y = y1;
               this.var_750 = Math.max(0,(this.var_257.height - background.height) / 2);
         ...
         if(this.var_1421 == RoomWidgetChatUpdateEvent.const_312)
         {
            textWindow.text = this.var_75.registerParameter("widgets.chatbubble.respect","username",this.var_946);
            this._width = const_958;
         }
         else if(this.var_1421 == RoomWidgetChatUpdateEvent.const_305)
         {
            textWindow.text = this.var_75.registerParameter("widget.chatbubble.petrespect","petname",this.var_946);
            this._width = const_958;
         }
         ...
         if(textWindow.visible)
         {
            ...
            textWindow.y += this.var_750;
            messageWidth = textWindow.textWidth;
            textWindow.width = messageWidth + const_1347;
         ...
         if(pointerWindow != null && pointerWindow.visible)
         {
            ...
            pointerWindow.y += this.var_750;
         }
         var bitmap:BitmapData = this.buildBubbleImage(nameWindow.width + textWindow.width,background.height,this.var_2541,isRespect);
         this._window.width = bitmap.width;
         this._window.y -= this.var_750;
         this._width = this._window.width;
         background.bitmap = bitmap;
         background.y = this.var_750;
      }
      ...
      {
         var _loc5_:int = 0;
         var _loc3_:ITextWindow = this._window.getChildByName(const_957) as ITextWindow;
         ...
         if(_loc4_ > -1)
         {
            ...
            while(_loc5_ < this.var_751.length)
            {
               if(_loc4_ >= this.var_751[_loc5_][0] && _loc4_ <= this.var_751[_loc5_][1])
               {
                  ...
                  {
                     HabboWebTools.openWebPage(this.var_1815 + this.var_367[_loc5_][0],"habboMain");
                  }
                  else
                  {
                     HabboWebTools.openWebPage(this.var_1815 + this.var_367[_loc5_][0]);
                  }
                  return true;
               }
               _loc5_++;
      ...
      private function onBubbleMouseClick(param1:WindowMouseEvent) : void
      {
         ...
         this._widget.onItemMouseClick(this.var_1154,this.var_946,this.var_1153,this._roomId,this._roomCategory,param1);
      }
      
      private function onBubbleMouseDown(param1:WindowMouseEvent) : void
      {
         this._widget.onItemMouseDown(this.var_1154,this.var_1153,this._roomId,this._roomCategory,param1);
      }
      
      private function onBubbleMouseOver(param1:WindowMouseEvent) : void
      {
         this._widget.onItemMouseOver(this.var_1154,this.var_1153,this._roomId,this._roomCategory,param1);
      }
      
      private function onBubbleMouseOut(param1:WindowMouseEvent) : void
      {
         this._widget.onItemMouseOut(this.var_1154,this.var_1153,this._roomId,this._roomCategory,param1);
      }
