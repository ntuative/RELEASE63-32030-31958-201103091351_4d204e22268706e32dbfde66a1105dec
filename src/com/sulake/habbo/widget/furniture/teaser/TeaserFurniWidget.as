package com.sulake.habbo.widget.furniture.teaser
{
   ...
   public class TeaserFurniWidget extends RoomWidgetBase
   {
      ...
      private const const_1716:int = 0;
      
      private const const_1717:int = 1;
      ...
      private const const_2018:int = 1;
      
      private const const_2021:int = 2;
      
      private const const_2023:int = 3;
      
      private const const_2017:int = 4;
      
      private const const_2019:int = 5;
      
      private const const_1719:String = "deco_img";
      ...
      public function TeaserFurniWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager, param5:IHabboInventory)
      {
         ...
         this.var_1447 = this.var_152.getKey("image.library.url","http://images.habbo.com/c_images/");
         this.var_1447 += "Viral/";
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_539,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_702,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_721,this.onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetTeaserDataUpdateEvent.const_539,this.onObjectUpdate);
      }
      ...
      private function onObjectUpdate(param1:RoomWidgetTeaserDataUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetTeaserDataUpdateEvent.const_539:
               _loc2_ = this.const_1716;
               this._shareId = null;
               break;
            case RoomWidgetTeaserDataUpdateEvent.const_721:
               ...
               break;
            case RoomWidgetTeaserDataUpdateEvent.const_702:
               _loc2_ = this.const_1717;
               this.var_364 = param1.objectId;
         ...
         if(this._window && (this.var_1450 != _loc2_ || _loc3_ != this.var_182))
         {
            this._window.dispose();
            this._window = null;
         }
         this.var_182 = _loc3_;
         this.var_1450 = _loc2_;
         this.mainWindow;
         this.showInterface();
      }
         ...
         if(!this._window)
         {
            switch(this.var_1450)
            {
               ...
               case this.const_1717:
                  if(this.var_388 == this.const_2015)
                  {
                  ...
                  else if(this.var_388 == this.const_2018)
                  {
                  ...
                  else if(this.var_388 == this.const_2021)
                  {
                  ...
                  else if(this.var_388 == this.const_2023)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                  ...
                  else if(this.var_388 == this.const_2017)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_182,"client.show.not_enough_fb_friends");
                  ...
                  else if(this.var_388 == this.const_2019)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
            ...
            _loc5_ = this.const_2022.replace("%campaign%",this.var_182);
            this.setDecoImage(_loc5_,this.const_1713);
            _loc2_ = _loc2_.replace("%campaign%",this.var_182);
            this.setDecoImage(_loc2_,this.const_1719);
            if(_loc3_)
            {
      ...
      private function onTeaserOkButton(param1:WindowEvent) : void
      {
         ...
         {
            _loc2_ = new RoomWidgetViralFurniMessage(RoomWidgetViralFurniMessage.const_827);
      ...
      private function onOpenButton(param1:WindowEvent) : void
      {
         ...
         if(messageListener != null)
         {
            _loc2_ = new RoomWidgetViralFurniMessage(RoomWidgetViralFurniMessage.const_165);
            _loc2_.objectId = this.var_364;
            messageListener.processWidgetMessage(_loc2_);
         }
         this.hideInterface();
         if(this._inventory)
         {
            if(this.var_1448 != 0)
            {
               this._inventory.toggleInventoryPage(this.var_1448 == 1 ? "null" : InventoryCategory.const_131);
            }
         }
      ...
      private function sendConversionPoint(param1:String, param2:String, param3:String = "") : void
      {
         ...
         if(messageListener != null)
         {
            _loc4_ = new RoomWidgetConversionPointMessage(RoomWidgetConversionPointMessage.const_639,"ViralGift",param1,param2,param3);
      ...
      private function setDecoImage(param1:String, param2:String) : void
      {
         ...
         if(!_loc4_)
         {
            this.var_1449.push(new ImageDownloader(this,_assets,this.var_182,this.var_1447,param1,param2));
            return;
         }
