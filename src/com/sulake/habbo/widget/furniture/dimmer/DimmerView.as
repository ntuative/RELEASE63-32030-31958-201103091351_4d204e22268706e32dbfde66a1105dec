package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private var var_578:DimmerViewColorGrid;
      ...
      private function createWindow() : void
      {
         ...
         this._window = this._widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_63,HabboWindowStyle.const_31,0 | 0,new Rectangle(const_1297,const_1296,2,2),null,0) as IWindowContainer;
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc5_ != null)
            {
               this.var_578 = new DimmerViewColorGrid(this,_loc5_ as IItemGridWindow,this._widget.windowManager,this._widget.assets);
            }
         }
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         this.var_1329 = _loc2_.light;
         if(this.var_406 != null)
         {
            this.var_406.setValue(this.var_1329);
         }
         this.var_473 = this.colors.indexOf(_loc2_.color);
         if(this.var_578 != null)
         {
            this.var_578.setSelectedColorIndex(this.var_473);
         }
      ...
      private function get windowXML() : XML
      {
         ...
         this.var_1328 = XML(_loc1_.content);
         return this.var_1328;
      }
      ...
      public function set selectedColorIndex(param1:int) : void
      {
         ...
         if(this.var_578 != null)
         {
            this.var_578.setSelectedColorIndex(param1);
         }
         this._widget.previewCurrentSetting();
      }
