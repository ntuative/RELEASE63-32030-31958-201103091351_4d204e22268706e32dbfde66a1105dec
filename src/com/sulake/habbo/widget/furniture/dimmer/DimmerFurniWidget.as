package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerFurniWidget extends RoomWidgetBase
   {
      ...
      private static const const_1315:Array = new Array(7665141,21495,15161822,15353138,15923281,8581961,0);
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetDimmerUpdateEvent.const_726,this.onPresets);
         param1.addEventListener(RoomWidgetDimmerUpdateEvent.const_830,this.onHide);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetDimmerUpdateEvent.const_726,this.onPresets);
         param1.removeEventListener(RoomWidgetDimmerUpdateEvent.const_830,this.onHide);
      ...
      private function onDimmerState(param1:RoomWidgetDimmerStateUpdateEvent) : void
      {
         ...
         this.var_2128 = param1.presetId;
         this.var_1099 = param1.effectId;
         this._color = param1.color;
         this.var_1097 = param1.brightness;
         if(this.var_17 != null)
         {
            this.var_17.update();
         }
         if(!this.validateBrightness(this.var_1097,this.var_1099))
         {
            return;
         }
         _loc2_ = new RoomWidgetDimmerPreviewMessage(this._color,this.var_1097,this.var_1099 == 2);
      ...
      public function removePreview() : void
      {
         ...
         _loc1_ = new RoomWidgetDimmerPreviewMessage(this._color,this.var_1097,this.var_1099 == 2);
         messageListener.processWidgetMessage(_loc1_);
      }
