package com.sulake.habbo.widget.loadingbar
{
   ...
   public class LoadingBarWidget extends RoomWidgetBase
   {
      ...
      private var var_513:Sprite = null;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_513.removeEventListener(MouseEvent.CLICK,this.clickHandler);
            this.var_513 = null;
         }
         if(this.var_45 != null)
         {
      ...
      private function onShowInterstitial(param1:RoomWidgetInterstitialUpdateEvent) : void
      {
         ...
         if(this.var_513 == null)
         {
            this.var_513 = new Sprite();
            this.var_513.addChild(new Bitmap(this.var_45));
            this.var_513.addEventListener(MouseEvent.CLICK,this.clickHandler);
         }
         else
         {
            _loc5_ = this.var_513.getChildAt(0) as Bitmap;
            if(_loc5_ != null)
            {
               _loc5_.bitmapData = this.var_45;
            }
         }
         _loc2_.setDisplayObject(this.var_513);
      ...
      private function clickHandler(param1:Event) : void
      {
         if(this.var_1255 != "")
         {
            HabboWebTools.openWebPage(this.var_1255);
         }
      }
   }
}
