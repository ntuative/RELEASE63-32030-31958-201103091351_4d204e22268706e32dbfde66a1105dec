package com.sulake.habbo.widget.chooser
{
   ...
   public class ChooserView
   {
      ...
      private const const_1697:uint = 0;
      ...
      public function populate(param1:Array, param2:Boolean) : void
      {
         ...
         while(_loc6_ < param1.length)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               _loc5_.color = !!(_loc6_ % 2) ? uint(this.const_1697) : uint(this.const_1696);
      ...
      {
         var _loc2_:* = null;
         if(this._itemList == null || param1 < 0 || param1 > this._itemList.numListItems || param1 == this.var_844)
         {
            return;
         }
         if(this.var_844 != -1)
         {
            _loc2_ = this._itemList.getListItemAt(this.var_844) as IWindowContainer;
            if(_loc2_ != null)
            {
               _loc2_.color = !!(this.var_844 % 2) ? uint(this.const_1697) : uint(this.const_1696);
            }
         }
      ...
      public function removeItem(param1:int, param2:int) : void
      {
         ...
         this.populate(this._items,this.var_1584);
      }
