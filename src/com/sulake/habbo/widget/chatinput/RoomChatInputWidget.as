package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputWidget extends RoomWidgetBase
   {
      ...
      private var var_738:Timer = null;
      ...
      public function sendChat(param1:String, param2:int, param3:String = "") : void
      {
         ...
         var _loc4_:RoomWidgetChatMessage = new RoomWidgetChatMessage(RoomWidgetChatMessage.const_779,param1,param2,param3);
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetChatInputContentUpdateEvent.const_823,this.onChatInputUpdate);
         param1.addEventListener(RoomWidgetUserInfoUpdateEvent.const_142,this.onUserInfo);
         param1.addEventListener(RoomWidgetChatInputDisplayEvent.const_651,this.onSettings);
         param1.addEventListener(RoomWidgetFloodControlEvent.const_680,this.onFloodControl);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetChatInputContentUpdateEvent.const_823,this.onChatInputUpdate);
         param1.removeEventListener(RoomWidgetChatInputDisplayEvent.const_651,this.onSettings);
         param1.removeEventListener(RoomWidgetUserInfoUpdateEvent.const_142,this.onUserInfo);
         param1.removeEventListener(RoomWidgetFloodControlEvent.const_680,this.onFloodControl);
      }
      ...
      private function onChatInputUpdate(param1:RoomWidgetChatInputContentUpdateEvent) : void
      {
         ...
         switch(param1.messageType)
         {
            case RoomWidgetChatInputContentUpdateEvent.const_1174:
               ...
               break;
            case RoomWidgetChatInputContentUpdateEvent.const_1474:
         }
      }
      
      private function onSettings(param1:RoomWidgetChatInputDisplayEvent) : void
      {
         this.var_2226 = param1.allowPaste;
      }
      ...
      public function onFloodControl(param1:RoomWidgetFloodControlEvent) : void
      {
         ...
         {
            this.var_738 = new Timer(1000,this.var_739);
            this.var_738.addEventListener(TimerEvent.TIMER,this.onReleaseTimerTick);
            this.var_738.addEventListener(TimerEvent.TIMER_COMPLETE,this.onReleaseTimerComplete);
         }
         this.var_738.start();
         if(this._visualization != null)
         {
