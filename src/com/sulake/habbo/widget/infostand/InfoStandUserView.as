package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandUserView
   {
      ...
      private var var_1139:TagListRenderer;
      
      private var var_134:IBorderWindow;
      
      private var var_2709:int;
      
      private const const_977:int = 5;
      
      private const const_1736:int = 39;
      
      private const const_1735:int = 7829367;
      ...
      public function InfoStandUserView(param1:InfostandWidget, param2:String)
      {
         ...
         this.var_1139 = new TagListRenderer(param1,this.onTagSelected);
      }
      ...
      public function set realName(param1:String) : void
      {
         ...
         _loc2_.height = _loc2_.textHeight + this.const_977;
      ...
      public function setMotto(param1:String, param2:Boolean) : void
      {
         ...
         if(param2)
         {
            if(param1 == "")
            {
               ...
               _loc3_.textColor = this.const_1735;
            }
            else
            {
         ...
         _loc3_.text = param1;
         _loc3_.height = _loc3_.textHeight + this.const_977;
         if(param2)
         {
            _loc3_.addEventListener(WindowKeyboardEvent.const_401,this.onMottoKeyboard);
            _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onMottoClicked);
         }
         else
         {
            _loc3_.removeEventListener(WindowKeyboardEvent.const_401,this.onMottoClicked);
         }
         this.updateWindow();
      }
      ...
      public function setTags(param1:Array, param2:Array = null) : void
      {
         ...
         if(param1.length != 0)
         {
            _loc3_.height = this.var_1139.renderTags(param1,_loc3_,param2);
            _loc4_.height = 1;
         }
         else
         {
      ...
      protected function setTradeButtonTooltip(param1:int) : void
      {
         ...
         switch(param1)
         {
            case RoomWidgetUserInfoUpdateEvent.const_1230:
               _loc2_ = "${infostand.button.trade.tooltip.shutdown}";
               break;
            case RoomWidgetUserInfoUpdateEvent.const_1190:
      ...
      protected function onMottoKeyboard(param1:WindowKeyboardEvent) : void
      {
         ...
         {
            _loc5_ = getTimer();
            if(_loc5_ - this.var_2709 > this.const_2027 && _loc3_ != this._widget.localizations.getKey("infostand.motto.change"))
            {
               ...
               this.var_2709 = _loc5_;
            }
         }
         else
         {
            _loc2_.textColor = this.const_1735;
            if(_loc3_.length >= this.const_1736)
            {
               _loc2_.text = _loc3_.substring(0,this.const_1736 - 1);
            }
         }
      }
      ...
      private function badgesEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            if(param2.name == "button.give")
            {
               ...
               if(_loc4_)
               {
                  _loc3_ = _loc4_.getGridItemIndex(this.var_637);
               }
               if(_loc3_ <= -1)
               {
                  return;
