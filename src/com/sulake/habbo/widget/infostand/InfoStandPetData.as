package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetData
   {
      ...
      public function setData(param1:RoomWidgetPetInfoUpdateEvent) : void
      {
         ...
         this.var_2053 = param1.petRace;
         this.var_45 = param1.image;
         this.var_2061 = param1.isOwnPet;
         this.var_2060 = param1.ownerId;
         this._ownerName = param1.ownerName;
         this._canOwnerBeKicked = param1.canOwnerBeKicked;
         this.var_1460 = param1.level;
         this.var_2055 = param1.levelMax;
         this.var_2058 = param1.experience;
         this.var_2059 = param1.experienceMax;
         this._energy = param1.energy;
         this.var_2057 = param1.energyMax;
         this._nutrition = param1.nutrition;
         this.var_2054 = param1.nutritionMax;
         this._petRespect = param1.petRespect;
         this.var_2056 = param1.roomIndex;
