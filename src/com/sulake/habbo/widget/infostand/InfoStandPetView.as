package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_1990:int = 152;
      
      private const const_2001:int = 16;
      
      private const const_1310:int = 4;
      
      private const const_1993:uint = 14342874;
      
      private const const_1997:uint = 3815994;
      
      private const const_1996:uint = 2085362;
      
      private const const_2000:uint = 39616;
      
      private const const_1998:uint = 10513106;
      
      private const const_1992:uint = 8734654;
      
      private const const_1999:uint = 9094430;
      
      private const const_1994:uint = 6200576;
      
      private const const_1995:String = "happiness";
      
      private const const_1991:String = "experience";
      
      private const const_2002:String = "energy";
      ...
      {
         if(this.var_53 == null || this.var_194 == null || this.var_67 == null)
         {
            return;
         }
         ...
         this._window.width = Math.max(this.var_194.width,this.var_67.width);
         this._window.height = this._window.scrollableRegion.height;
         if(this.var_194.width < this.var_67.width)
         {
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(this.const_1995,param1.nutrition,param1.nutritionMax,this.const_2000,this.const_1996);
         this.updateStateElement(this.const_1991,param1.experience,param1.experienceMax,this.const_1992,this.const_1998);
         this.updateStateElement(this.const_2002,param1.energy,param1.energyMax,this.const_1994,this.const_1999);
      ...
      private function createPercentageBar(param1:int, param2:int, param3:uint, param4:uint) : BitmapData
      {
         ...
         var _loc7_:BitmapData = new BitmapData(this.const_1990,this.const_2001,false);
         _loc7_.fillRect(new Rectangle(0,0,_loc7_.width,_loc7_.height),this.const_1993);
         var _loc8_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,_loc7_.height - 2);
         _loc7_.fillRect(_loc8_,this.const_1997);
         var _loc9_:Rectangle = new Rectangle(1,1 + this.const_1310,_loc7_.width - 2,_loc7_.height - 2 - this.const_1310);
         _loc9_.width = _loc5_ * _loc9_.width;
         _loc7_.fillRect(_loc9_,param3);
         var _loc10_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,this.const_1310);
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_195 && this.var_195.getPetId() == this.var_528)
               {
            ...
            case "btn_buy_food":
               if(this._catalog)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_1486,true);
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_562,this._widget.petData.ownerId);
