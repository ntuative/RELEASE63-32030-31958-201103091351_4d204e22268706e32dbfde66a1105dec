package com.sulake.habbo.avatar
{
   ...
   public class AvatarAssetDownloadManager extends EventDispatcher
   {
      ...
      private var var_426:AssetLoaderStruct;
      
      private var var_944:Timer;
      ...
      private const const_2012:int = 100;
      
      private const const_1580:int = 2;
      ...
      public function AvatarAssetDownloadManager(param1:IAssetLibrary, param2:String, param3:String, param4:AvatarStructure)
      {
         ...
         if(_loc6_ == null)
         {
            this.var_426 = this._assets.loadAssetFromFile("figuremap",_loc5_,"text/xml");
         ...
         this.var_944 = new Timer(this.const_2012,1);
         this.var_944.addEventListener(TimerEvent.TIMER_COMPLETE,this.onNextDownloadTimeout);
      }
      ...
      private function addMapLoaderEventListeners() : void
      {
         if(this.var_426)
         {
            this.var_426.addEventListener(AssetLoaderEvent.const_27,this.onConfigurationComplete);
            this.var_426.addEventListener(AssetLoaderEvent.const_47,this.onConfigurationError);
         }
      }
      ...
      private function removeMapLoaderEventListeners() : void
      {
         if(this.var_426)
         {
            this.var_426.removeEventListener(AssetLoaderEvent.const_27,this.onConfigurationComplete);
            this.var_426.removeEventListener(AssetLoaderEvent.const_47,this.onConfigurationError);
         }
      }
      ...
      private function onConfigurationError(param1:Event) : void
      {
         ...
         else
         {
            ...
            if(this.var_1420.indexOf("?") > 0)
            {
               _loc2_ = this.var_1420 + "&retry=" + this.var_943;
            }
            else
            {
               _loc2_ = this.var_1420 + "?retry=" + this.var_943;
            ...
            this.var_426 = this._assets.loadAssetFromFile("figuremap",_loc3_,"text/xml");
            this.addMapLoaderEventListeners();
         }
      }
      ...
      private function loadFigureMapData(param1:XML) : void
      {
         ...
         this.var_1814 = true;
         for each(_loc2_ in this.var_1151)
         {
      ...
      private function generateMap(param1:XML) : void
      {
         ...
         for each(_loc2_ in param1.lib)
         {
            ...
            for each(_loc4_ in _loc2_.part)
            {
               ...
               _loc6_ = this.var_1152[_loc5_];
               if(_loc6_ == null)
               {
                  _loc6_ = [];
               }
               _loc6_.push(_loc3_);
               this.var_1152[_loc5_] = _loc6_;
            }
         }
      }
      ...
      public function loadFigureSetData(param1:IAvatarFigureContainer, param2:IAvatarImageListener) : void
      {
         ...
         if(!this.var_1814)
         {
            this.var_1151.push([param1,param2]);
            return;
         }
         ...
         if(_loc4_.length > 0)
         {
            ...
            {
               _loc6_ = this.var_526[_loc3_];
               if(_loc6_ == null)
               {
                  _loc6_ = [];
               }
               _loc6_.push(param2);
               this.var_526[_loc3_] = _loc6_;
            }
      ...
      {
         var _loc1_:* = null;
         while(this.var_748.length > 0 && this.var_749.length < this.const_1580)
         {
            _loc1_ = this.var_748[0];
            _loc1_.startDownloading();
            this.var_749.push(this.var_748.shift());
         }
      }
      
      private function addToQueue(param1:AvatarAssetDownloadLibrary) : void
      {
         if(!param1.isReady && this.var_748.indexOf(param1) == -1 && this.var_749.indexOf(param1) == -1)
         {
