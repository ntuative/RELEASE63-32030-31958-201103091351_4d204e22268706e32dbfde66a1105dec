package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1284:String = "Default";
      
      private static const const_1285:int = 2;
      
      private static const const_1286:String = AvatarSetType.const_35;
      ...
      protected var var_788:Boolean;
      
      protected var var_699:Array;
      
      protected var _assets:AssetAliasCollection;
      
      protected var var_246:AvatarImageCache;
      ...
      protected var var_1246:Boolean = false;
      ...
      private var var_2205:String = null;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:AvatarFigureContainer, param4:String)
      {
         ...
         this._figure = param3;
         this.var_246 = new AvatarImageCache(this._structure,this,this._assets,this._scale);
         this.setDirection(const_1286,const_1285);
         this.var_322 = new Array();
         this.var_904 = new ActiveActionData(AvatarAction.const_397);
         this.var_904.definition = this._structure.getActionDefinition(const_1284);
         this.resetActions();
      ...
      {
         return this._structure.getBodyPartData(param1.animation.id,this.var_561,param1.id);
      }
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_240.length == 1 && this.var_89 == this.var_2006)
         {
            return this.var_89 + this.var_465 + this.var_561 % 4;
         }
         if(this.var_240.length == 2)
         {
            for each(_loc1_ in this.var_240)
            {
               ...
               {
                  return this.var_89 + this.var_465 + 0;
               }
               if(_loc1_.actionType == "fx" && (_loc1_.actionParameter == "38" || _loc1_.actionParameter == "39"))
               {
                  _loc2_ = this.var_561 % 11;
                  return this.var_89 + "_" + this.var_2006 + this.var_465 + _loc2_;
               }
            }
         }
         return null;
      ...
      {
         if(param3 != this.var_2207 || param2 != this.var_2205 || param1 != this.var_2206)
         {
            this.var_2207 = param3;
            this.var_2205 = param2;
            this.var_2206 = param1;
            this.var_1600 = this._structure.getBodyParts(param1,param2,param3);
         }
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         if(this.var_1246 || this.var_45 == null || (this.var_45.width != _loc5_.width || this.var_45.height != _loc5_.height))
         {
            if(this.var_45 != null && !this.var_1246)
            {
               this.var_45.dispose();
            }
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc9_ = _loc4_.getImageContainer(_loc8_,this.var_561);
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc8_ = _loc2_.getImageContainer(_loc7_,this.var_561);
            if(_loc8_ != null)
            {
               _loc9_ = _loc8_.image;
               if(_loc9_ == null)
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_322.push(new ActiveActionData(param1,param2,this.var_561));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.var_276 = this.var_904;
         this.var_276.definition = this.var_904.definition;
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_465 = "";
         this.var_240 = this._structure.sortActions(this.var_322);
         if(this.var_240 == null)
         {
            this.var_699 = new Array(0,0,0);
            if(this.var_1308 != "")
            {
               _loc1_ = true;
               this.var_1308 = "";
         ...
         {
            this.var_699 = this._structure.getCanvasOffsets(this.var_240,this._scale,this.var_89);
            for each(_loc4_ in this.var_240)
            {
               this.var_465 += _loc4_.actionType + _loc4_.actionParameter;
               if(_loc4_.actionType == AvatarAction.const_297)
               {
            ...
            if(this.var_1308 != this.var_465)
            {
               _loc1_ = true;
               this.var_1308 = this.var_465;
            }
         }
         this.var_1309 = true;
         return _loc1_;
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_240)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               {
                  this.var_850 = _loc1_.definition.isAnimated(_loc1_.actionParameter);
                  _loc2_ = this._structure.getAnimation(_loc1_.definition.state + "." + _loc1_.actionParameter);
                  if(_loc2_ != null)
                  {
                     ...
                     {
                        this.var_1599 = _loc2_.directionData.offset;
                     }
               ...
               if(_loc1_.actionType == AvatarAction.const_292 || _loc1_.actionType == AvatarAction.const_223 || _loc1_.actionType == AvatarAction.const_344)
               {
                  this.var_850 = true;
               }
            }
