package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1995:int = 6710886;
      ...
      private var var_524:ITabSelectorWindow;
      
      private var _catalog:IHabboCatalog;
      
      private var var_525:IFrameWindow;
      ...
      private var var_2725:Boolean = true;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog, param4:Array, param5:Boolean)
      {
         ...
         var _loc8_:* = null;
         this.var_1219 = [];
         this.var_1476 = [AvatarEditorFigureCategory.const_724,AvatarEditorFigureCategory.const_51,AvatarEditorFigureCategory.const_269,AvatarEditorFigureCategory.const_700,AvatarEditorFigureCategory.HOTLOOKS,AvatarEditorFigureCategory.const_109];
         super();
         ...
         if(param4 == null)
         {
            param4 = this.var_1476;
         }
         for each(_loc6_ in param4)
         {
            this.var_1219.push(_loc6_);
         }
      ...
      public function validateAvailableCategories(param1:Array) : Boolean
      {
         ...
         if(param1 == null)
         {
            return this.validateAvailableCategories(this.var_1476);
         }
         if(param1.length != this.var_1219.length)
         {
            return false;
         }
         for each(_loc2_ in param1)
         {
            if(this.var_1219.indexOf(_loc2_) < 0)
            {
               return false;
            }
         }
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         {
            this.var_2724 = this.canChangeOutfit();
            this.var_442.stop();
            if(this._window)
            {
      ...
      private function createWindow(param1:Boolean) : void
      {
         ...
         this.var_524 = this._window.findChildByName("mainTabs") as ITabSelectorWindow;
         var _loc2_:int = this.var_524.numSelectables - 1;
         while(_loc2_ >= 0)
         {
            _loc4_ = this.var_524.getSelectableAt(_loc2_);
            if(_loc4_ != null && this.var_1219.indexOf(_loc4_.name) < 0)
            {
               _loc5_ = this.var_524.removeSelectable(_loc4_);
               _loc6_ = _loc2_ + 1;
               while(_loc6_ < this.var_524.numSelectables)
               {
                  this.var_524.getSelectableAt(_loc6_).x = this.var_524.getSelectableAt(_loc6_).x - _loc5_.width;
                  _loc6_++;
               }
            }
            _loc2_--;
      ...
      private function attachImages() : void
      {
         ...
         var _loc1_:Array = this.var_1476;
      ...
      public function update() : void
      {
         ...
         if(this._controller.sessionData && this._controller.sessionData.hasUserRight("fuse_use_wardrobe",HabboClubLevelEnum.const_41) && (this.var_1937 == AvatarEditorSideCategory.const_109 || this.var_2725))
         {
         ...
         this.setViewToCategory(this.var_341);
      }
      ...
      {
         if(this.var_1937 == AvatarEditorSideCategory.const_109)
         {
            this.var_2725 = false;
            this.setSideContent(AvatarEditorSideCategory.const_687);
         }
         else
         {
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorSideCategory.const_687:
               break;
            case AvatarEditorSideCategory.const_492:
               _loc3_ = this._controller.getSideContentWindowContainer(AvatarEditorSideCategory.const_492);
               break;
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         this.var_341 = param1;
         this.var_524.setSelected(this.var_524.getSelectableByName(param1));
      ...
      private function displayStripClubDialog() : void
      {
         ...
         if(!this.var_525)
         {
            ...
            this.var_525 = this._windowManager.buildFromXML(_loc2_,2) as IFrameWindow;
            this.var_525.procedure = this.stripClubDialogEventProc;
            this.var_525.center();
         }
         else
         {
