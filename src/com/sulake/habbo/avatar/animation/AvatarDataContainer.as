package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_1841:Number = 1.0;
      
      private var var_1842:Number = 1.0;
      
      private var var_1840:Number = 1.0;
      ...
      {
         super();
         this.var_1619 = parseInt(param1.@ink);
         var _loc2_:String = String(param1.@foreground);
         _loc2_ = _loc2_.replace("#","");
         var _loc3_:String = String(param1.@background);
         _loc3_ = _loc3_.replace("#","");
         this.var_2224 = parseInt(_loc2_,16);
         this.var_2222 = parseInt(_loc3_,16);
         ...
         this.var_1661 = new ColorTransform(this.var_1841,this.var_1842,this.var_1840,this._alphaMultiplier);
         this.var_1070 = this.generatePaletteMapForGrayscale(this.var_2222,this.var_2224);
      }
      ...
      {
         return this.var_1070.getValue("reds") as Array;
      }
      
      public function get greens() : Array
      {
         return this.var_1070.getValue("greens") as Array;
      }
      
      public function get blues() : Array
      {
         return this.var_1070.getValue("blues") as Array;
      }
      
      public function get alphas() : Array
      {
         return this.var_1070.getValue("alphas") as Array;
      }
