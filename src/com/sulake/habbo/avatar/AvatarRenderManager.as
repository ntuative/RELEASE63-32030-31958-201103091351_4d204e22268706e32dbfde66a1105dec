package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private const const_2011:String = "hd-99999-99999";
      ...
      private var var_1813:AvatarFigureContainer;
      ...
      public function AvatarRenderManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_544 = RenderMode.const_1425;
         ...
         this.var_102.add(AvatarType.const_118,_loc4_);
         ...
         this.var_102.add(AvatarType.const_67,_loc4_);
         ...
         this.var_747 = new PaletteManager(param1.assets as AssetLibraryCollection);
      ...
      private function onAllModulesReadyAndRunning(param1:Event) : void
      {
         ...
         this.var_303.init();
         this.var_747.init();
         _loc2_ = this.var_102.getValue(AvatarType.const_118) as AvatarStructure;
         if(_loc2_)
         {
         ...
         _loc2_ = this.var_102.getValue(AvatarType.const_67) as AvatarStructure;
         if(_loc2_)
         {
            _loc2_.resetPartOffsets(context.assets);
         }
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            _loc3_ = this.var_102.getValue(AvatarType.const_118) as AvatarStructure;
            if(_loc3_ != null)
            {
               ...
               _loc5_.addEventListener(AvatarStructureDownload.const_1005,this.onFigureDataDownloadDone);
      ...
      private function checkIfReady() : void
      {
         if(!this.var_868)
         {
            if(this.var_2536 && this.var_2538 && this.var_2537)
            {
      ...
      {
         var _loc5_:AvatarStructure = this.var_102.getValue(AvatarType.const_118) as AvatarStructure;
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         if(!this.var_1813)
         {
            this.var_1813 = new AvatarFigureContainer(this.const_2011);
         }
         this.var_222.loadFigureSetData(_loc6_,param4);
         return new PlaceholderAvatarImage(_loc5_,this._aliasCollection,this.var_1813,param2);
      }
      ...
      public function getPetFigureString(param1:String) : String
      {
         ...
         return this.var_303.createPetFigureString(_loc3_,_loc4_,_loc5_);
      }
      ...
      public function createPetImage(param1:int, param2:int, param3:uint, param4:String, param5:IPetImageListener = null) : IAvatarImage
      {
         var _loc9_:* = null;
         var _loc6_:* = false;
         if(this.mode != RenderMode.const_1528)
         {
            _loc6_ = !this.var_303.assetsReady(param1,param4);
         }
         var _loc7_:String = this.var_303.createPetFigureString(param1,param2,param3);
         var _loc8_:AvatarStructure = this.var_102.getValue(AvatarType.const_67) as AvatarStructure;
         if(_loc8_ == null)
         {
            return null;
         }
      ...
      public function resetPetData() : void
      {
         ...
         var _loc2_:AvatarStructure = this.var_102.getValue(AvatarType.const_67);
      ...
      {
         var _loc3_:AvatarStructure = this.var_102.getValue(AvatarType.const_118) as AvatarStructure;
      ...
      public function injectFigureData(param1:String, param2:XML) : void
      {
         ...
         switch(param1)
         {
            ...
            case AvatarType.const_67:
               _loc3_ = this.var_102.getValue(AvatarType.const_67) as AvatarStructure;
               break;
            default:
