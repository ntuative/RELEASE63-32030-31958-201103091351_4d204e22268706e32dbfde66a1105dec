package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridPartItem implements IAvatarImageListener
   {
      ...
      private var var_701:IFigurePartSet;
      ...
      private const const_1987:int = 16777215;
      ...
      public function AvatarEditorGridPartItem(param1:IWindowContainer, param2:IAvatarEditorCategoryModel, param3:IFigurePartSet, param4:Array, param5:Boolean = true)
      {
         ...
         this.var_701 = param3;
         this._window = param1;
         this.var_1327 = this._window.findChildByTag("BG_COLOR");
         this._colors = param4;
         ...
         if(param3 != null)
         {
            ...
            {
               this.var_1638 = Math.max(this.var_1638,_loc6_.colorLayerIndex);
            }
         }
         this.var_405 = this.var_68.controller.avatarRenderManager;
      ...
      private function updateThumbVisualization() : void
      {
         ...
         if(_loc1_)
         {
            if(this.var_658 != null && !this.var_1637)
            {
               _loc3_ = this.var_658;
            }
            else
            ...
            if(this.var_701)
            {
               switch(this.var_701.clubLevel)
               {
                  ...
                  case HabboClubLevelEnum.const_44:
                     _loc2_.style = HabboIconType.const_674;
               }
            }
            else
            {
         ...
         if(this.isSelected)
         {
            this.var_1327.color = this.const_1986;
         }
         else
         {
            this.var_1327.color = this.const_1987;
         }
      ...
      private function analyzePartLayers() : Boolean
      {
         ...
         for each(_loc2_ in this.partSet.parts)
         {
            if(_loc7_)
            {
               _loc3_ = "undefined_undefined_" + _loc2_.type + "_" + _loc2_.id + "_" + this.const_329[_loc6_] + "_" + FigureData.const_135;
      ...
      private function renderThumb() : BitmapData
      {
         ...
         if(this.var_574 == null)
         {
            if(!this.analyzePartLayers())
            {
               if(!this.var_1639)
               {
                  ...
                  this.var_1639 = _loc9_.content as BitmapData;
               }
         ...
         _loc1_ = new BitmapData(this.var_574.width,this.var_574.height,true,16777215);
         var _loc6_:int = 0;
         var _loc7_:Boolean = false;
         ...
         for each(_loc2_ in _loc8_)
         {
            ...
            if(_loc4_)
            {
               ...
               _loc10_ = -1 * _loc4_.offset.x - this.var_574.x;
               _loc11_ = -1 * _loc4_.offset.y - this.var_574.y;
               if(this.var_1637 && _loc2_.colorLayerIndex > 0)
               {
