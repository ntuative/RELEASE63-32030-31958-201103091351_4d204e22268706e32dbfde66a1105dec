package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private var var_1265:IAvatarImage;
      ...
      private var var_339:IActiveActionData;
      ...
      private var var_2290:ByteArray;
      
      private var var_2291:ImageData;
      
      private var var_838:PaletteMap;
      
      private var var_875:Array;
      
      private var var_876:Point;
      ...
      public function setGeometryType(param1:String) : void
      {
         ...
         if(this.var_702 == GeometryType.const_986 && param1 == GeometryType.const_1164 || this.var_702 == GeometryType.const_1164 && param1 == GeometryType.const_986)
         {
            this.var_702 = param1;
            this.var_87 = null;
            return;
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
         ...
         this.var_339 = this._bodyPartCache.getAction();
         var _loc5_:IActiveActionData = this.var_339;
         var _loc6_:* = [];
         var _loc7_:Dictionary = new Dictionary();
         var _loc8_:Point = new Point();
         if(!(!this.var_339 || !this.var_339.definition))
         {
            if(this.var_339.definition.isAnimation)
            {
               _loc11_ = _loc3_;
               _loc12_ = this._structure.getAnimation(this.var_339.definition.state + "." + this.var_339.actionParameter);
               _loc13_ = param2 - this.var_339.startFrame;
               if(_loc12_ != null)
               {
                  _loc14_ = _loc12_.getLayerData(_loc13_,param1,this.var_339.overridingAction);
                  if(_loc14_ != null)
                  {
                     ...
                     {
                        this.var_339 = _loc14_.action;
                     }
                     if(_loc14_.type == AnimationLayerData.const_746)
                     {
                        if(_loc14_.action != null)
                        {
                     ...
                     else if(_loc14_.type == AnimationLayerData.const_515)
                     {
                        _loc3_ = _loc11_;
                     }
         ...
         if(_loc10_ == null)
         {
            _loc15_ = this._structure.getParts(param1,this.var_1265.getFigure(),_loc5_,this.var_702,_loc3_,_loc6_,_loc7_);
         ...
         if(this.var_389 == null)
         {
            ...
            this.var_389 = this.renderBodyPart(_loc3_,_loc16_,_loc4_,this.var_339);
            if(this.var_389 == null)
            {
               return null;
            }
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         if(!this.var_87)
         {
            this.var_87 = this._structure.getCanvas(this._scale,this.var_702);
            if(!this.var_87)
            {
               return null;
            }
            this.var_2289 = new Point(0,this.var_87.height - int(this.var_87.width / 4));
         }
         var _loc5_:int = param1;
         var _loc6_:Boolean = AvatarDirectionAngle.const_1672[param1];
         var _loc9_:String = param4.definition.assetPartDefinition;
         var _loc10_:String = param4.definition.state;
         var _loc11_:Boolean = _loc10_ == AvatarAction.const_759 || _loc10_ == AvatarAction.const_344;
         ...
         while(_loc8_ >= 0)
         {
            ...
            {
               this.var_1331 = this.var_107.bodyPartId;
               this.var_174 = this.var_107.partType;
               this.var_1646 = this.var_107.partId;
               ...
               if(_loc6_)
               {
                  ...
                  else
                  {
                     ...
                     if(this.var_107.flippedPartType != this.var_174)
                     {
                        this.var_174 = this.var_107.flippedPartType;
                     }
                  }
               }
               this.var_1332 = this._scale + "_" + this.var_107.action.assetPartDefinition + "_" + this.var_174 + "_" + this.var_1646 + "_" + _loc5_ + "_" + this._frame;
               this.var_407 = this._assets.getAssetByName(this.var_1332) as BitmapDataAsset;
               if(this.var_407 == null)
               {
                  this.var_1332 = this._scale + "_std_" + this.var_174 + "_" + this.var_1646 + "_" + _loc5_ + "_0";
                  this.var_407 = this._assets.getAssetByName(this.var_1332) as BitmapDataAsset;
               }
               if(!(!this.var_407 || !this.var_407.content))
               {
                  ...
                  {
                     this.var_838 = this._structure.renderManager.paletteManager.getPalette(this.var_107.paletteMapId);
                     if(this.var_838 != null)
                     {
                        this.var_877 = this.var_407.content as BitmapData;
                        this.var_175 = new BitmapData(this.var_877.width,this.var_877.height);
                        this.var_2290 = this.var_838.colorize(this.var_877.getPixels(this.var_877.rect));
                        this.var_175.setPixels(this.var_175.rect,this.var_2290);
                     }
                     else
                     {
                  ...
                  if(_loc11_ && (this.var_1331 == AvatarBodyPartType.const_269 || this.var_1331 == AvatarBodyPartType.const_1667 || this.var_1331 == AvatarBodyPartType.const_1600) && this.var_107.color != null)
                  {
                     _loc16_ = 0.7;
                  ...
                  {
                     this.var_175.colorTransform(this.var_175.rect,this.var_107.color.colorTransform);
                  }
                  if(this.var_107.isBlendable)
                  {
                     this.var_175.colorTransform(this.var_175.rect,this.var_107.blendTransform);
                  }
                  this.var_876 = this.var_407.offset.clone();
                  if(_loc7_)
                  {
                     if(this._scale == AvatarScaleType.const_57)
                     {
                  ...
                  this.var_2291 = new ImageData(this.var_175,this.var_876,_loc7_);
                  this.var_875.push(this.var_2291);
               }
            }
            _loc8_--;
         }
         ...
         var _loc13_:ImageData = this.createUnionImage(this.var_875,_loc6_);
         var _loc14_:Point = new Point(-1 * _loc13_.regpoint.x,this.var_2289.y - _loc13_.regpoint.y);
         if(_loc6_)
         {
            if(this._scale == AvatarScaleType.const_57)
            {
         ...
         _loc8_ = this.var_875.length - 1;
         while(_loc8_ >= 0)
         {
            _loc15_ = this.var_875.pop();
            if(_loc15_)
            {
               _loc15_.dispose();
            }
