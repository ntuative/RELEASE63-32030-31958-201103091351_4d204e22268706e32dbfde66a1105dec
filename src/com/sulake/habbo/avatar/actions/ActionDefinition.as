package com.sulake.habbo.avatar.actions
{
   ...
   public class ActionDefinition implements IActionDefinition
   {
      ...
      public function ActionDefinition(param1:XML)
      {
         ...
         this.var_2247 = parseInt(param1.@precedence);
         this.var_2245 = String(param1.@activepartset);
         this.var_2244 = String(param1.@assetpartdefinition);
         this.var_2248 = String(param1.@lay);
         this.var_702 = String(param1.@geometrytype);
         this.var_2147 = Boolean(parseInt(param1.@main));
         this.var_2242 = Boolean(parseInt(param1.@name_4));
         this.var_2243 = Boolean(parseInt(param1.@animation));
         this._preventHeadTurn = Boolean(String(param1.@preventheadturn == "HabboHelpCom_help_faq_entry_xml"));
         ...
         for each(_loc3_ in param1.param)
         {
            ...
            if(_loc5_ == "default")
            {
               this.var_2246 = _loc6_;
            }
            else
            {
               this.var_1628[_loc5_] = _loc6_;
            }
         }
      ...
      public function setOffsets(param1:String, param2:int, param3:Array) : void
      {
         ...
         {
            this.var_699.add(param1,new Map());
         }
         var _loc4_:Map = this.var_699.getValue(param1);
      ...
      public function getOffsets(param1:String, param2:int) : Array
      {
         ...
         var _loc3_:Map = this.var_699.getValue(param1) as Map;
         if(_loc3_ == null)
         {
            return null;
         }
      ...
      public function getParameterValue(param1:String) : String
      {
         ...
         var _loc2_:String = this.var_1628[param1];
         if(_loc2_ == null)
         {
            _loc2_ = this.var_2246;
         }
         return _loc2_;
      }
