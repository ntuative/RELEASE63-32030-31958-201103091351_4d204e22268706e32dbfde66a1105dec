package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_1080:RoomCreateViewCtrl;
      ...
      private var var_2273:RoomThumbnailRenderer;
      
      private var var_840:GuestRoomPasswordInput;
      
      private var var_301:GuestRoomDoorbell;
      
      private var var_1079:OfficialRoomEntryManager;
      
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         this.var_2272 = new Array();
         ...
         this.var_1080 = new RoomCreateViewCtrl(this);
         this.var_2273 = new RoomThumbnailRenderer(this);
         this.var_840 = new GuestRoomPasswordInput(this);
         this.var_301 = new GuestRoomDoorbell(this);
         this.var_399 = new Tabs(this);
         this.var_1079 = new OfficialRoomEntryManager(this);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = IBitmapWrapperWindow(this._windowManager.createWindow(param1,"",HabboWindowType.const_294,HabboWindowStyle.const_42,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6));
      ...
      private function setHabboToolbarIcon() : void
      {
         ...
         {
            this.var_179.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_134,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.homeRoomId > 0)
            {
               this.var_179.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_134,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      public function animateWindowOpen(param1:IWindowContainer) : void
      {
         ...
         {
            this.var_179.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_53,HabboToolbarIconEnum.NAVIGATOR,param1));
         }
      }
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_286.startSearch(Tabs.const_222,Tabs.const_392,param1);
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_286.startSearch(Tabs.const_323,Tabs.const_220);
         this.var_399.getTab(Tabs.const_323).tabPageDecorator.tabSelected();
      }
