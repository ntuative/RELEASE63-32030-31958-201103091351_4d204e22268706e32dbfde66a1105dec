package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_1229:TextFieldManager;
      
      private var var_44:Array;
      
      private var var_1230:RoomLayout;
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(this.var_1230.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!this.var_1949 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            this.var_1949 = true;
            _loc3_.y = 1;
      ...
      private function prepare() : void
      {
         ...
         this.var_1229 = new TextFieldManager(this._navigator,ITextFieldWindow(this.var_185.findChildByName("room_name_input")),25,null,this._navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      {
         this.var_1229.goBackToInitialState();
         this.var_1229.input.textBackgroundColor = 4294967295;
         this.var_1230 = this.var_44[0];
         this.refreshRoomThumbnails();
      ...
      {
         return Boolean(this.var_1229.checkMandatory(this._navigator.getText("navigator.createroom.nameerr")));
      }
      ...
      {
         var _loc2_:String = this.var_1229.getText();
         var _loc3_:String = "model_" + this.var_1230.name;
