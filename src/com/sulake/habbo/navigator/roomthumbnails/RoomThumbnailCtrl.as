package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private var var_2352:IWindowContainer;
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         this.var_1690 = IButtonWindow(this.find("bg_tab"));
         this.var_1692 = IButtonWindow(this.find("top_tab"));
         this.var_1691 = IButtonWindow(this.find("obj_tab"));
         this.var_2353 = IWindowContainer(this.find("tile_grid"));
         this.var_2352 = IWindowContainer(this.find("now_editing_container"));
         Util.setProcDirectly(this.find("save"),this.onSaveButton);
         Util.setProcDirectly(this.find("cancel"),this.onCancelButton);
         Util.setProcDirectly(this.var_1690,this.onBgTabButton);
         Util.setProcDirectly(this.var_1692,this.onTopTabButton);
         Util.setProcDirectly(this.var_1691,this.onObjTabButton);
      }
      ...
      private function onBgTabButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_68.mode = ThumbnailEditorModel.const_38;
         this.reload();
      }
      ...
      {
         this.setEnabled(this.var_1690,this.var_68.mode != ThumbnailEditorModel.const_38);
         this.setEnabled(this.var_1692,this.var_68.mode != ThumbnailEditorModel.const_60);
         this.setEnabled(this.var_1691,this.var_68.mode != ThumbnailEditorModel.const_34);
      }
      
      private function refreshEditArea() : void
      {
         var _loc1_:IWindowContainer = this.var_2352;
         Util.hideChildren(_loc1_);
         this.refreshEditImg(_loc1_,"edit_bg",this.var_68.mode == ThumbnailEditorModel.const_38);
      ...
      private function refreshPositionGrid() : void
      {
         ...
         {
            while(_loc3_ <= RoomThumbnailRenderer.const_577)
            {
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            _loc11_ = IRegionWindow(this._navigator.windowManager.createWindow("img_" + _loc8_,"",WindowType.const_435,HabboWindowStyle.const_42,0 | 0,new Rectangle(_loc9_ * 66,0,66,66),this.onImgSel,_loc10_.id));
            _loc11_.mouseThreshold = 0;
            _loc12_ = IBitmapWrapperWindow(this._navigator.windowManager.createWindow("img_" + _loc8_,"",HabboWindowType.const_294,HabboWindowStyle.const_42,HabboWindowParam.const_58,new Rectangle(0,0,66,66),this.onImgSel,_loc10_.id));
