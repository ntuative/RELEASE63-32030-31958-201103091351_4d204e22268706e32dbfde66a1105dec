package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailRenderer
   {
      ...
      public static const const_577:int = 10;
      
      private static const const_942:int = 32;
      
      private static const const_1304:int = 8;
      
      private static const const_1302:int = -16;
      
      private static const const_1303:int = 40;
      ...
      public function RoomThumbnailRenderer(param1:HabboNavigator)
      {
         ...
         this.var_881 = new ThumbnailImageConfigurations(this._navigator);
      ...
      private function initScreenLocsByPositions() : void
      {
         ...
         this.var_2298 = _loc1_;
      }
      
      private function getLoc(param1:int, param2:int) : Point
      {
         var _loc3_:int = param2 % 2 == 0 ? 0 : int(const_942 / 2);
         return new Point(param1 * const_942 + _loc3_,param2 * const_1304);
      }
      ...
      public function refreshThumbnail(param1:IWindowContainer, param2:RoomThumbnailData, param3:Boolean) : void
      {
         ...
         if(_loc5_ == null)
         {
            ...
            _loc5_ = IBitmapWrapperWindow(this._navigator.windowManager.createWindow("bitmap","",HabboWindowType.const_294,HabboWindowStyle.const_42,0 | (!!param3 ? HabboWindowParam.const_39 : HabboWindowParam.const_42),new Rectangle(0,0,_loc7_.width,_loc7_.height)));
      ...
      private function refreshBg(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_881.getImage(ThumbnailEditorModel.const_38,param2);
         if(_loc3_ == null)
         {
            Logger.log("Unknown bg image id: " + param2);
            _loc3_ = this.var_881.getImage(ThumbnailEditorModel.const_38,1);
         }
      ...
      private function refreshFront(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_881.getImage(ThumbnailEditorModel.const_60,param2);
         if(_loc3_ == null)
         {
      ...
      private function refreshCover(param1:BitmapData) : void
      {
         ...
         {
            this.var_1338 = this._navigator.getButtonImage("rico_rnd");
         }
         param1.copyPixels(this.var_1338,this.var_1338.rect,new Point(0,0),null,null,true);
      }
      ...
      private function refreshObj(param1:BitmapData, param2:RoomThumbnailObjectData) : void
      {
         ...
         param1.copyPixels(_loc5_,_loc5_.rect,new Point(_loc4_.x + const_1302,_loc4_.y + const_1303 - _loc5_.height),null,null,true);
      }
      
      public function getScreenLocForPos(param1:int) : Point
      {
         return Point(this.var_2298[param1]);
      }
   }
}
