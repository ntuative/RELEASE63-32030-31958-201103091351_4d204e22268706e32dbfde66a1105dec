package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener
   {
      ...
      private var var_289:CatalogViewer;
      
      private var var_352:ICatalogNavigator;
      
      private var var_101:Purse;
      
      private var var_92:RecyclerLogic;
      
      private var var_126:IMarketPlace;
      ...
      private var var_2398:GiftWrappingConfiguration;
      
      private var var_1113:ClubGiftController;
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this._communication.addHabboConnectionMessageEvent(new RecyclerPrizesMessageEvent(this.method_5));
      ...
      public function openCatalogPageById(param1:int, param2:int) : void
      {
         ...
         {
            this.toggleCatalog(true);
            this.var_352.openPageById(param1,param2);
         }
         else
         {
            this.toggleCatalog();
      ...
      public function openCreditsHabblet() : void
      {
         ...
         var _loc1_:* = this.var_184.getKey("client.credits.embed.enabled","false") == "HabboHelpCom_help_faq_entry_xml";
         if(false && _loc1_)
         {
      ...
      {
         return this.var_287.getProductData(param1);
      }
      
      public function getFurnitureData(param1:int, param2:String) : IFurnitureData
      {
         var _loc3_:* = null;
         if(param2 == ProductTypeEnum.const_93)
         {
            _loc3_ = this.var_287.getFloorItemData(param1);
         }
         if(param2 == ProductTypeEnum.const_82)
         {
            _loc3_ = this.var_287.getWallItemData(param1);
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:Array = this.var_721.getValue(param1);
         if(_loc2_ != null)
         {
            return _loc2_.slice();
         }
      ...
      {
         this.var_179.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_134,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         if(!this.var_783)
         {
            if(!this.var_287.loadProductData(this))
            {
               return;
            }
            this.init();
         ...
         {
            this.var_179.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_53,HabboToolbarIconEnum.CATALOGUE,this._mainContainer));
         }
         if(this._mainContainer.visible)
         {
      ...
      private function getCurrentLayoutCode() : String
      {
         ...
         return this.var_289.getCurrentLayoutCode();
      }
      ...
      private function createCatalogNavigator() : void
      {
         ...
         this.var_352 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      private function createCatalogViewer() : void
      {
         ...
         this.var_289 = new CatalogViewer(this,_loc1_,this._roomEngine);
         this.var_289.habboCatalog = this;
      }
      ...
      private function createMainWindow() : void
      {
         ...
         _loc3_.setParamFlag(WindowParam.const_258,false);
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_88:
               this.var_1720 = param1.session.isPrivateRoom;
               if(this.var_92 != null)
               {
      ...
      private function createMarketPlace() : void
      {
         ...
         {
            this.var_126 = new MarketPlaceLogic(this,this._windowManager,this._roomEngine);
         }
      }
      ...
      private function createClubGiftController() : void
      {
         ...
         {
            this.var_1113 = new ClubGiftController(this);
         }
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         this.var_352.buildCatalogIndex(_loc2_);
         if(this.var_720 && this.var_720 != "")
         {
            this.var_352.openPage(this.var_720);
            this.var_720 = "";
            this.var_917 = -1;
         }
         else if(this.var_917 > -1)
         {
            this.var_352.openPageById(this.var_917,this.var_1721);
            this.var_917 = -1;
            this.var_1721 = -1;
            this.var_720 = "";
         }
      ...
      private function onCatalogPage(param1:IMessageEvent) : void
      {
         ...
         this.var_289.showCatalogPage(_loc4_,_loc5_,_loc8_,_loc3_.offers,_loc9_);
      }
      ...
      {
         if(param1 == null || this.var_289 == null)
         {
            return;
         }
         var _loc2_:ApproveNameMessageParser = param1.getParser();
         this.var_289.dispatchWidgetEvent(new CatalogWidgetApproveNameResultEvent(_loc2_.result));
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2397 && this.var_504 != null)
         {
            this.var_504.playSound(HabboSoundTypesEnum.const_1112);
         }
         this.var_2397 = false;
         if(this.var_288 != null)
         {
         ...
         events.dispatchEvent(new PurseEvent(PurseEvent.const_64,this.var_101.credits));
      }
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2396 && this.var_504 != null)
         {
            this.var_504.playSound(HabboSoundTypesEnum.const_1125);
         }
         this.var_2396 = false;
         if(this.var_288 != null)
         {
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         this.var_1113.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function onRentableBotDefinitions(param1:IMessageEvent) : void
      {
         ...
         this.var_289.dispatchWidgetEvent(new RentableBotDefinitionWidgetEvent(_loc2_.rentableBots));
      }
      ...
      private function onMarketPlaceOwnOffers(param1:IMessageEvent) : void
      {
         if(this.var_126 != null)
         {
            this.var_126.onOwnOffers(param1);
         }
      }
      ...
      private function onMarketPlaceBuyResult(param1:IMessageEvent) : void
      {
         if(this.var_126 != null)
         {
            this.var_126.onBuyResult(param1);
         }
      }
      ...
      private function onMarketPlaceCancelResult(param1:IMessageEvent) : void
      {
         if(this.var_126 != null)
         {
            this.var_126.onCancelResult(param1);
         }
      }
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         this.var_2398 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function onMarketplaceConfiguration(param1:MarketplaceConfigurationEvent) : void
      {
         ...
         this.var_126.averagePricePeriod = _loc2_.averagePricePeriod;
      }
      ...
      private function onSellableBreeds(param1:SellablePetBreedsMessageEvent) : void
      {
         ...
         this.var_721.remove(_loc2_.productCode);
         var _loc3_:Array = _loc2_.sellableBreeds;
         if(_loc3_ != null)
         {
            this.var_721.add(_loc2_.productCode,_loc3_.slice());
            this.var_289.dispatchWidgetEvent(new CatalogWidgetSellablePetBreedsEvent(_loc2_.productCode,_loc3_.slice()));
         }
      }
      ...
      private function noCreditsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:Event) : void
      {
         ...
         {
            if(false && "HabboHelpCom_help_faq_entry_xml" == this.var_184.getKey("client.credits.embed.enabled"))
            {
               ExternalInterface.call("FlashExternalInterface.openHabblet","credits");
            }
            else
