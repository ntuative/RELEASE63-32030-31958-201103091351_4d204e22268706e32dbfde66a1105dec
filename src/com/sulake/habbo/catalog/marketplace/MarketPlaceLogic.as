package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketPlaceLogic implements IMarketPlace
   {
      ...
      public const const_1849:int = 1;
      
      public const const_1819:int = 2;
      
      public const const_2034:int = 3;
      ...
      private var var_2474:MarketplaceItemStats;
      ...
      {
         this.requestOffers(this.var_2476,this.var_2472,this.var_2450,this.var_2475);
      }
      ...
      public function buyOffer(param1:int) : void
      {
         ...
         this.showConfirmation(this.const_1849,_loc2_);
      }
      ...
      public function onOwnOffers(param1:IMessageEvent) : void
      {
         ...
         this.var_2473 = _loc3_.creditsWaiting;
         for each(_loc4_ in _loc3_.offers)
         {
      ...
      {
         if(param1.furniCategoryId != this.var_2429 || param1.furniTypeId != this.var_2430)
         {
            return;
         }
      ...
      private function isPosterItem(param1:IMarketPlaceOfferData) : Boolean
      {
         ...
         if(param1.furniType == 2 && param1.stuffData != null)
         {
            ...
            {
               _loc4_ = _loc3_.name;
               if(_loc4_ != null && _loc4_ == const_1343)
               {
                  _loc2_ = true;
               }
            }
