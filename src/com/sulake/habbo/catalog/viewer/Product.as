package com.sulake.habbo.catalog.viewer
{
   ...
   public class Product extends ProductGridItem implements IProduct, IGetImageListener
   {
      ...
      private var var_1786:IProductData;
      ...
      {
         super();
         this.var_1788 = param1.productType;
         this.var_1787 = param1.furniClassId;
         this.var_1407 = param1.extraParam;
         this.var_1406 = param1.productCount;
         this.var_1789 = param1.expiration;
