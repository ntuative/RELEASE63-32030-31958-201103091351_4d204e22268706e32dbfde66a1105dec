package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      {
         return this._localization.getLinks(this.var_1038);
      }
      
      public function get hasLinks() : Boolean
      {
         return this._localization.hasLinks(this.var_1038);
      }
      ...
      protected function createWindow(param1:String) : void
      {
         ...
         this.var_2002 = _loc3_.content as XML;
         this._window = this.viewer.catalog.windowManager.buildFromXML(this.var_2002) as IWindowContainer;
         if(this._window == null)
         {
      ...
      private function createWidget(param1:IWindowContainer) : void
      {
         ...
         switch(param1.name)
         {
            case CatalogWidgetEnum.const_1431:
               if(this.var_1039 == null)
               {
                  this.var_1039 = new ItemGridCatalogWidget(param1);
                  this.var_48.push(this.var_1039);
               }
               break;
            ...
            case CatalogWidgetEnum.const_1568:
               ...
               break;
            case CatalogWidgetEnum.const_1542:
            ...
            case CatalogWidgetEnum.const_1424:
               ...
               break;
            case CatalogWidgetEnum.const_1508:
            ...
            case CatalogWidgetEnum.const_1522:
               ...
               break;
            case CatalogWidgetEnum.const_1614:
