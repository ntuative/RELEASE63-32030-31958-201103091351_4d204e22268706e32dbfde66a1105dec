package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private const const_1703:int = 1;
      
      private const const_1704:int = 2;
      
      private const const_2003:int = 40;
      
      private const const_2004:int = 10;
      
      private var var_717:Array;
      
      private var var_1357:MarketPlaceOfferData;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_481)
         {
            this.var_481.removeEventListener(TimerEvent.TIMER,this.onPopulationTimer);
            this.var_481 = null;
         }
      }
      ...
      private function selectSearchCategory(param1:String) : void
      {
         ...
         switch(param1)
         {
            ...
            case "search_by_activity":
               _loc5_ = "marketplace_search_simple";
               this.var_717 = [3,4,5,6];
               break;
            case "search_advanced":
               _loc5_ = "marketplace_search_advanced";
               this.var_717 = [1,2,3,4,5,6];
               break;
            default:
               return;
         }
         ...
         if(_loc7_ != null)
         {
            _loc7_.populate(this.getSortKeys(this.var_717));
            _loc7_.selection = 0;
         }
      }
      ...
      private function updateList() : void
      {
         ...
         this.updateStatusDisplay(this.const_1704,_loc2_.length);
         if(!this.var_481)
         {
            this.var_481 = new Timer(25);
            this.var_481.addEventListener(TimerEvent.TIMER,this.onPopulationTimer);
         }
         this.var_1109 = 0;
         this.populateList();
         this.var_481.start();
      ...
      private function populateList() : Boolean
      {
         ...
         while(_loc1_ < 5)
         {
            if(this.var_1109 >= this._offers.length)
            {
               return true;
            }
            this.addListItem(this._offers.getWithIndex(this.var_1109));
            ++this.var_1109;
            _loc1_++;
         }
         return false;
      ...
      {
         var _loc5_:* = null;
         this.updateStatusDisplay(this.const_1703);
         var _loc1_:int = -1;
         var _loc2_:int = -1;
         var _loc3_:String = "";
         var _loc4_:int = 1;
         ...
         if(_loc6_ && _loc6_.selection >= 0 && _loc6_.selection < this.var_717.length)
         {
            _loc4_ = this.var_717[_loc6_.selection];
         }
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "back_button":
                  ...
                  break;
               case "buy_button":
                  this.marketPlace.buyOffer(this.var_1357.offerId);
            }
            return;
         }
         if(param1.type == WindowEvent.const_61)
