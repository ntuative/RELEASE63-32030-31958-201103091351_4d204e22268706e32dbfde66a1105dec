package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private static const const_211:String = "floor";
      
      private static const const_210:String = "wallpaper";
      ...
      private var var_351:BitmapData = null;
      ...
      private function onClick(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc2_.name)
         {
            ...
            case "ctlg_wall_color_next":
               ...
               break;
            case "ctlg_buy_wall":
               _loc3_ = this.var_1370[this.var_413];
               if(_loc3_ != null)
               {
            ...
            case "ctlg_buy_landscape":
               _loc3_ = this.var_1371[this.var_414];
               if(_loc3_ != null)
               {
      ...
      private function updateConfiguration() : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:* = null;
         var _loc2_:String = this.var_913[this.var_413];
         ...
         var _loc5_:String = this._activeFloorPatterns[this.var_416];
         ...
         _loc6_ = this.var_1372[this.var_416];
         if(_loc6_ != null)
         {
         ...
         var _loc7_:String = this.var_915[this.var_414];
         for each(_loc1_ in this.var_184.landscapes.pattern)
         {
            if(_loc1_.@id == _loc7_)
            {
               _loc13_ = _loc1_.children()[this.var_483];
               if(_loc13_ != null)
               {
                  this.var_1574 = _loc13_.@id;
               }
            }
         }
         _loc8_ = this.var_1371[this.var_414];
         if(_loc8_ != null)
         {
      ...
      private function changePattern(param1:String, param2:int) : void
      {
         ...
         switch(param1)
         {
            case const_210:
               ...
               if(this.var_413 < 0)
               {
                  this.var_413 = this.var_913.length - 1;
               }
               if(this.var_413 == this.var_913.length)
               {
                  this.var_413 = 0;
               }
               this.var_415 = 0;
               this.var_916 = 0;
               _loc5_ = this.var_913[this.var_413];
               for each(_loc8_ in this.var_184.walls.pattern)
               {
                  if(_loc8_.@id == _loc5_)
                  {
                     this.var_916 = _loc8_.children().length();
                  }
               }
            ...
            case const_211:
               ...
               if(this.var_416 < 0)
               {
                  this.var_416 = this._activeFloorPatterns.length - 1;
               }
               if(this.var_416 >= this._activeFloorPatterns.length)
               {
                  this.var_416 = 0;
               }
               this.var_484 = 0;
               this.var_912 = 0;
               _loc6_ = this._activeFloorPatterns[this.var_416];
               for each(_loc9_ in this.var_184.floors.pattern)
               {
                  if(_loc9_.@id == _loc6_)
                  {
                     this.var_912 = _loc9_.children().length();
                  }
               }
            ...
            case const_95:
               ...
               if(this.var_414 < 0)
               {
                  this.var_414 = this.var_915.length - 1;
               }
               if(this.var_414 >= this.var_915.length)
               {
                  this.var_414 = 0;
               }
               this.var_483 = 0;
               this.var_914 = 0;
               _loc7_ = this.var_915[this.var_414];
               for each(_loc10_ in this.var_184.landscapes.pattern)
               {
                  if(_loc10_.@id == _loc7_)
                  {
                     this.var_914 = _loc10_.children().length();
                  }
               }
      ...
      private function retrieveSpacesPreview() : void
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc2_:ImageResult = page.viewer.roomEngine.getRoomImage(this._floorType,this.var_1575,this.var_1574,64,this,"window_romantic_wide");
         ...
         {
            this.var_1718 = _loc2_.id;
            this.var_1719 = _loc3_.id;
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         if(this.var_351 != null && this.var_350 != null)
         {
            this.setRoomImage(this.var_351,this.var_350);
         }
      }
   }
}
