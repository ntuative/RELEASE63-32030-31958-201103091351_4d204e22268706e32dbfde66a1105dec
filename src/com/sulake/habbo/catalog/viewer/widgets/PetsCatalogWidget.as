package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class PetsCatalogWidget extends CatalogWidget implements ICatalogWidget, IPetDataListener, IPetImageListener
   {
      ...
      override public function init() : Boolean
      {
         ...
         events.addEventListener(WidgetEvent.const_621,this.onApproveNameResult);
      ...
      public function onDropMenuEvent(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowEvent.const_61)
         {
            ...
            if(this.var_193 == null || _loc3_ >= this.var_193.length)
            {
               return;
            }
            this.var_706 = _loc3_;
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         if(this.var_473 < 0 || this.var_473 > this.var_342.length)
         {
            this.var_473 = 0;
         }
         this.updateImage();
      ...
      private function onSellablePetBreeds(param1:CatalogWidgetSellablePetBreedsEvent) : void
      {
         ...
         {
            this.var_193 = this.parseSellableBreeds(param1.sellableBreeds);
            this.var_706 = 0;
      ...
      private function updateBreedSelections() : void
      {
         ...
         {
            _loc5_ = this.var_193[_loc3_] as int;
      ...
      private function updateImage() : void
      {
         ...
         if(this.var_193 == null || this.var_706 >= this.var_193.length)
         {
            return;
         }
         var _loc2_:* = 0;
         if(this.var_473 >= 0 && this.var_473 < this.var_342.length)
         {
            _loc7_ = this.var_342[this.var_473] as IPetColor;
            if(_loc7_ != null)
            {
               _loc2_ = uint(_loc7_.rgb);
            }
         }
         var _loc3_:int = this.var_193[this.var_706] as int;
         var _loc4_:IAvatarImage = (page.viewer.catalog as HabboCatalog).avatarRenderManager.createPetImage(this.var_503,_loc3_,_loc2_,AvatarScaleType.const_57,this);
         if(_loc4_ == null)
         {
            return;
         }
         _loc4_.initActionAppends();
         _loc4_.appendAction(AvatarAction.const_316,AvatarAction.const_627);
      ...
      private function getPurchaseParameters() : String
      {
         ...
         if(this.var_473 >= this.var_342.length)
         {
            return "";
         }
         var petColor:IPetColor = this.var_342[this.var_473] as IPetColor;
         var color:uint = petColor.rgb;
         var breed:int = this.var_193[this.var_706] as int;
      ...
      private function updateAvailableBreeds(param1:String) : void
      {
         ...
         if(this.var_193 == null)
         {
            ...
            this.var_193 = this.parseSellableBreeds(_loc2_);
            this.var_706 = 0;
            if(this.var_193 != null)
            {
               this.updateBreedSelections();
