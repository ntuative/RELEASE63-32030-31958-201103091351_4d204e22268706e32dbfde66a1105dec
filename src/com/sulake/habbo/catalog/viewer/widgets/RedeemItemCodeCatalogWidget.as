package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_835:ITextFieldWindow;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_836.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
            this.var_836 = null;
         }
         if(this.var_835 != null)
         {
            this.var_835.removeEventListener(WindowKeyboardEvent.const_194,this.windowKeyEventProcessor);
            this.var_835 = null;
         }
      }
      ...
      override public function init() : Boolean
      {
         ...
         this.var_836 = _window.findChildByName("redeem") as IButtonWindow;
         if(this.var_836 != null)
         {
            this.var_836.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
         }
         this.var_835 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(this.var_835 != null)
         {
            this.var_835.addEventListener(WindowKeyboardEvent.const_194,this.windowKeyEventProcessor);
         }
         return true;
      }
