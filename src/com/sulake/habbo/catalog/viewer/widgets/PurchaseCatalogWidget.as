package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class PurchaseCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         ...
         events.removeEventListener(WidgetEvent.const_718,this.onSetParameter);
      ...
      override public function init() : Boolean
      {
         ...
         if(_loc1_ != null)
         {
            this.var_2201 = _loc1_.content as XML;
         }
         var _loc2_:XmlAsset = page.viewer.catalog.assets.getAssetByName("purchaseWidgetPixelsStub") as XmlAsset;
         if(_loc2_ != null)
         {
            this.var_2202 = _loc2_.content as XML;
         }
         var _loc3_:XmlAsset = page.viewer.catalog.assets.getAssetByName("purchaseWidgetCreditsPixelsStub") as XmlAsset;
         if(_loc3_ != null)
         {
            this.var_2200 = _loc3_.content as XML;
         }
         var _loc4_:XmlAsset = page.viewer.catalog.assets.getAssetByName("purchaseWidgetCreditsOrCreditsAndPixelsStub") as XmlAsset;
         events.addEventListener(WidgetEvent.CWE_SELECT_PRODUCT,this.onSelectProduct);
         events.addEventListener(WidgetEvent.const_718,this.onSetParameter);
      ...
      private function attachStub(param1:String) : void
      {
         ...
         switch(param1)
         {
            case Offer.const_682:
               _loc2_ = page.viewer.catalog.windowManager.buildFromXML(this.var_2201) as IWindowContainer;
               break;
            case Offer.const_1032:
               _loc2_ = page.viewer.catalog.windowManager.buildFromXML(this.var_2202) as IWindowContainer;
               break;
            case Offer.const_1203:
               _loc2_ = page.viewer.catalog.windowManager.buildFromXML(this.var_2200) as IWindowContainer;
               break;
            default:
               Logger.log("Unknown price-type, can\'t attach..." + this.var_90.method_3);
         }
         if(_loc2_ != null)
         {
            if(this.var_851 != null)
            {
               _window.removeChild(this.var_851);
         ...
         this.var_1597 = _window.findChildByName("ctlg_price_credits") as ITextWindow;
         this.var_1596 = _window.findChildByName("ctlg_price_pixels") as ITextWindow;
         this.var_1595 = _window.findChildByName("ctlg_price_credits_pixels") as ITextWindow;
         this.var_2795 = _window.findChildByName("ctlg_special_txt") as ITextWindow;
         this.var_558 = window.findChildByName("ctlg_buy_button") as IButtonWindow;
         if(this.var_558 != null)
         {
            if(this.var_1306 != null)
            {
               this.var_558.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.var_1306);
            }
            else
            {
               this.var_558.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.var_1306);
      ...
      private function onSelectProduct(param1:SelectProductEvent) : void
      {
         ...
         if(this.var_1596 != null)
         {
            ...
            this.var_1596.caption = _loc2_.getKey(_loc4_);
         }
         if(this.var_1595 != null)
         {
            ...
            this.var_1595.caption = _loc2_.getKey(_loc4_);
         }
      ...
      {
         this.var_2203 = param1.parameter;
      }
      ...
      private function onPurchase(param1:WindowMouseEvent) : void
      {
         if(this.var_90 != null)
         {
            ...
            (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(this.var_90,page.pageId,this.var_2203);
         }
      }
   }
}
