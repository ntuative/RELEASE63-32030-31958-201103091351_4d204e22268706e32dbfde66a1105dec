package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1555:Point;
      
      private var var_458:IItemGridWindow;
      
      private var var_1285:IScrollbarWindow;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_826 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         this.var_1031 = _window.findChildByName("ctlg_description") as ITextWindow;
         this.var_85 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         this.var_1555 = new Point(this.var_85.x,this.var_85.y);
         this.var_458 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         this.var_1285 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         this.var_826.text = _loc4_;
         this.var_1031.text = _loc5_;
         this.var_826.height = this.var_826.textHeight + 5;
         this.var_1031.y = this.var_826.y + this.var_826.height;
         this.var_1031.height = Math.max(130,this.var_1031.textHeight + 5);
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_529:
                  ...
                  if(this.var_458 != null)
                  {
                     ...
                     _loc10_.populateItemGrid(this.var_458,this.var_1285,this.var_1950);
                     ...
                     case ProductTypeEnum.const_239:
                        ...
                        if(_loc15_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc16_ != null)
                           {
                              ...
                              _loc16_.appendAction(AvatarAction.const_316,AvatarAction.const_560);
                              _loc16_.appendAction(AvatarAction.const_297,_loc8_.productClassId);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2105)
         {
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_85 != null && true)
         {
            ...
            this.var_85.x = this.var_1555.x;
            this.var_85.y = this.var_1555.y;
            if(param3 != null)
            {
