package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class NewPetsCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_193:Array = null;
      ...
      override public function init() : Boolean
      {
         ...
         if(this.var_193 != null && this.var_193.length > 0)
         {
            this.var_376 = this.var_193[0];
         }
         else
         {
            this.var_376 = -1;
      ...
      private function initializeBreedSelection() : void
      {
         ...
         if(this.var_193 != null)
         {
            _loc1_ = [];
            _loc2_ = 0;
            while(_loc2_ < const_1370 && _loc2_ < this.var_193.length)
            {
               _loc3_ = (page.viewer.catalog as HabboCatalog).roomEngine.getPetColor(this.var_503,this.var_193[_loc2_]);
               if(_loc3_ != null)
               {
      ...
      private function selectedBreed(param1:int) : void
      {
         if(this.var_193 != null && this.var_193.length > 0)
         {
            ...
            this.var_376 = this.var_193[param1];
            this.updateImage();
         }
      }
      ...
      private function getPetLocalization() : String
      {
         ...
         if(page != null && false)
         {
            ...
            {
               return _loc1_.localization.getKey(this.getRaceLocalizationKey(this.var_503,this.var_376),this.getRaceLocalizationKey(this.var_503,this.var_376));
            }
         }
         return this.getRaceLocalizationKey(this.var_503,this.var_376);
      }
