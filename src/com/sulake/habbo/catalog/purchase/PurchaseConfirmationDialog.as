package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_1696:uint = 4.293848814E9;
      
      private const const_1697:uint = 4.294967295E9;
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            this.var_1612 = _loc1_.stuffTypes;
            this.var_697 = _loc1_.boxTypes;
            this.var_696 = _loc1_.ribbonTypes;
            this.var_1066 = this.var_1612[0];
            this.var_334 = this.var_697[0];
            this.var_336 = this.var_696[0];
            this.initColorGrid();
      ...
      private function updatePreview() : void
      {
         ...
         if(this.var_336 < 0)
         {
            this.var_336 = this.var_696.length - 1;
         }
         if(this.var_336 > this.var_696.length - 1)
         {
            this.var_336 = 0;
         }
         if(this.var_334 < 0)
         {
            this.var_334 = this.var_697.length - 1;
         }
         if(this.var_334 > this.var_697.length - 1)
         {
            this.var_334 = 0;
         }
         var _loc1_:int = this.var_697[this.var_334] * 1000 + this.var_696[this.var_336];
         if(this._window == null)
         {
            return;
         }
         var _loc2_:IRoomEngine = this.var_90.page.viewer.roomEngine;
         _loc3_ = _loc2_.getFurnitureImage(this.var_1066,new Vector3d(180),64,this,0,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
         this.var_1317 = _loc3_.id;
      ...
      private function initColorGrid() : void
      {
         ...
         var _loc3_:Array = this.var_1612;
         for each(_loc6_ in _loc3_)
         {
            _loc4_ = this._catalog.getFurnitureData(_loc6_,ProductTypeEnum.const_93);
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(this.var_1066);
         var _loc8_:int = !!_loc6_ ? 0 : int(this.var_697[this.var_334]);
         var _loc9_:int = !!_loc6_ ? 0 : int(this.var_696[this.var_336]);
         this._catalog.purchaseProductAsGift(this._pageId,this.var_90,this.var_1316,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               this._catalog.purchaseProduct(this._pageId,this.var_90.offerId,this.var_1316);
               this.dispose();
               break;
            case "cancel_button":
         ...
         switch(param1.type)
         {
            case WindowEvent.const_104:
               ...
               for each(_loc7_ in this.var_212)
               {
                  ...
                  if(_loc5_.length >= this.const_1983)
                  {
                     break;
                  }
               }
               this.updateSuggestions(_loc5_);
               this.var_2216 = _loc3_.text;
               break;
            case WindowMouseEvent.const_45:
               ...
               break;
            case WindowKeyboardEvent.const_401:
               _loc6_ = param1 as WindowKeyboardEvent;
               switch(_loc6_.keyCode)
               {
                  case Keyboard.UP:
                     this.highlightSuggestion(this.var_335 - 1);
                     break;
                  case Keyboard.DOWN:
                     this.highlightSuggestion(this.var_335 + 1);
                     break;
      ...
      private function selectHighlighted() : void
      {
         ...
         var _loc2_:IWindowContainer = _loc1_.getListItemAt(this.var_335) as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(this.var_565 == null)
         {
            this.var_565 = this.createWindow("suggestion_list_item") as IWindowContainer;
            this.var_565.procedure = this.suggestionsEventHandler;
         }
         if(this.var_242 == null || this.var_565 == null)
         {
            return;
         }
         ...
         {
            _loc5_ = this.var_565.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         _loc3_ = _loc2_.getListItemAt(this.var_335) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = this.getColor(this.var_335);
         }
         this.var_335 = param1;
         if(this.var_335 < 0)
         {
            this.var_335 = _loc2_.numListItems - 1;
         }
         if(this.var_335 >= _loc2_.numListItems)
         {
            this.var_335 = 0;
         }
         _loc3_ = _loc2_.getListItemAt(this.var_335) as IWindowContainer;
      ...
      {
         return param1 % 2 == 0 ? uint(this.const_1696) : uint(this.const_1697);
      }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == this.var_1066;
               }
            }
            _loc4_++;
         }
