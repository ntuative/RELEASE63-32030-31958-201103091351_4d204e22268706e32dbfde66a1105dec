package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_974:uint = 11;
      ...
      private var var_1201:IHabboWindowManager;
      ...
      private var var_268:PerformanceTracker = null;
      
      private var var_635:FramerateTracker = null;
      
      private var var_269:LatencyTracker = null;
      
      private var var_634:LagWarningLogger = null;
      
      private var var_633:ToolbarClickTracker = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_268 = new PerformanceTracker();
         this.var_635 = new FramerateTracker();
         this.var_269 = new LatencyTracker();
         this.var_634 = new LagWarningLogger();
         this.var_633 = new ToolbarClickTracker(this);
         this.var_1480 = new Array(const_974);
         var _loc4_:int = 0;
         while(_loc4_ < const_974)
         {
            this.var_1480[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1605,new Date().getTime().toString());
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1656,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1475,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_828,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1170,String(0));
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_1201)
            {
               this.var_1201.release(new IIDHabboWindowManager());
               this.var_1201 = null;
            }
            if(this.var_300)
            {
            ...
            if(this.var_203)
            {
               if(!this.var_203.disposed)
               {
                  ...
                  Component(this.var_203).events.removeEventListener(HabboFriendListTrackingEvent.const_390,this.onFriendlistTrackingEvent);
               }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_184)
         {
            if(this.var_269 != null)
            {
               this.var_269.configuration = this.var_184;
            }
            if(this.var_268 != null)
            {
               this.var_268.configuration = this.var_184;
            }
            ...
            if(this.var_184)
            {
               ...
               {
                  this.var_634.configure(this.var_184);
               }
               if(this.var_635 != null)
               {
                  this.var_635.configure(this.var_184);
               }
               if(this.var_633 != null)
               {
                  this.var_633.configure(this.var_184);
               }
            }
         }
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_781,this.onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboHotelViewEvent.const_699,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_66,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_489,this.onHotelViewEvent);
      }
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_634 != null)
            {
               this.var_634.connection = param1;
            }
         }
      }
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_699)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1463);
         }
         else if(param1.type == HabboHotelViewEvent.const_489)
         {
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               this.trackLoginStep(HabboLoginTrackingStep.const_1472);
               break;
            case HabboCommunicationEvent.const_781:
               this.trackLoginStep(HabboLoginTrackingStep.const_1589,String(this._communication.port));
               break;
      ...
      {
         this.var_1201 = IHabboWindowManager(param2);
         if(this.var_1201)
         {
         ...
         if(param1.critical && !this._crashed)
         {
            ...
            if(this.var_184)
            {
               if(this.var_184.keyExists("client.fatal.error.url"))
               {
                  ...
                  _loc8_ = "";
                  for each(_loc9_ in this.var_1480)
                  {
                  ...
                  if(this.var_268 != null)
                  {
                     _loc4_["null"] = this.var_268.flashVersion;
                     _loc4_["null"] = this.var_268.averageUpdateInterval;
                  }
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(this.var_203).events.addEventListener(HabboFriendListTrackingEvent.const_390,this.onFriendlistTrackingEvent);
      }
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_390:
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         if(!this.var_2692)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1415);
            this.var_2692 = true;
         }
         var _loc2_:RoomEntryInfoMessageParser = RoomEntryInfoMessageEvent(param1).getParser();
         if(_loc2_.guestRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1170,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_828,String(true));
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_300.events.addEventListener(AdEvent.const_541,this.onRoomAdLoad);
      }
      ...
      private function onToolbarClick(param1:HabboToolbarEvent) : void
      {
         if(this.var_633)
         {
            this.var_633.track(param1.iconName);
         }
      }
      ...
      {
         this.var_634.chatLagDetected(param1);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            ++this.var_1902;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_1902);
         }
         if(this.var_512 > -1 && _loc2_ - this.var_512 > 15000)
         {
            ++this.var_1901;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + this.var_1901);
         }
         this.var_512 = _loc2_;
         if(this.var_268 != null)
         {
            this.var_268.update(param1,this.var_512);
         }
         if(this.var_269 != null)
         {
            this.var_269.update(param1,this.var_512);
         }
         if(this.var_635 != null)
         {
            this.var_635.trackUpdate(param1,this,this.var_512);
         }
         if(this.var_634 != null)
         {
            this.var_634.update(this.var_512);
         }
      }
   }
}
