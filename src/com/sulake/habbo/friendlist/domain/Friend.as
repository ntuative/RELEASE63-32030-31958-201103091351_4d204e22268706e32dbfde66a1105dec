package com.sulake.habbo.friendlist.domain
{
   ...
   public class Friend implements IFriend, IDisposable
   {
      ...
      public static const const_1843:int = "F".charCodeAt(0);
      ...
      private var var_1192:BitmapData;
      ...
      public function Friend(param1:FriendData)
      {
         ...
         this.var_929 = param1.gender;
         this.var_688 = param1.online;
         this.var_1548 = param1.followingAllowed && param1.online;
         this._figure = param1.figure;
         this.var_1890 = param1.motto;
         this.var_1592 = param1.lastAccess;
         this.var_1445 = param1.categoryId;
         this.var_1591 = param1.realName;
