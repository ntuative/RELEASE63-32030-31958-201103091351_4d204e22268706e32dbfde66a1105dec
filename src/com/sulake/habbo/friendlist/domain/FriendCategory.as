package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      public static const const_360:int = 100;
      ...
      {
         return Math.ceil(this.var_212.length / const_360);
      }
      
      public function getStartFriendIndex() : int
      {
         this.checkPageIndex();
         return this.var_870 * const_360;
      }
      
      public function getEndFriendIndex() : int
      {
         this.checkPageIndex();
         return Math.min((this.var_870 + 1) * const_360,this.var_212.length);
      }
