package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      private var var_1068:IAvatarRenderManager;
      
      private var var_698:ISessionDataManager;
      
      private var var_2218:FriendListLookAndFeel;
      
      private var var_399:FriendListTabs;
      
      private var var_17:FriendListView;
      
      private var var_1616:OpenedToWebPopup;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_566.stop();
            this.var_566.removeEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_566 = null;
         }
         ...
         if(this.var_1068)
         {
            this.var_1068.release(new IIDAvatarRenderManager());
            this.var_1068 = null;
         }
         if(this.var_941)
         {
            this.var_941.release(new IIDHabboNotifications());
            this.var_941 = null;
         }
         if(this.var_179)
         {
         ...
         if(this.var_698)
         {
            this.var_698.release(new IIDSessionDataManager());
            this.var_698 = null;
         }
         super.dispose();
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_1616 = new OpenedToWebPopup(this);
         }
         this.var_1616.show(x,y);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_294,HabboWindowStyle.const_42,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var _loc2_:IAvatarImage = this.var_1068.createAvatarImage(param1,AvatarScaleType.const_90,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      public function isEmbeddedMinimailEnabled() : Boolean
      {
         ...
         return _loc1_ == "HabboHelpCom_help_faq_entry_xml";
      }
      ...
      private function onAvatarRenderedReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1068 = param2 as IAvatarRenderManager;
      ...
      {
         this.var_941 = param2 as IHabboNotifications;
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_97.addCategory(new FriendCategory(FriendCategory.const_1217,this.getText("friendlist.friends")));
         ...
         if(!this.var_566)
         {
            this.var_566 = new Timer(120000);
            this.var_566.addEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_566.start();
         }
         this.getBuddyRequests();
         this.registerListeners();
         this.var_179.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_134,HabboToolbarIconEnum.FRIENDLIST));
      ...
      private function toggleWindow() : void
      {
         ...
         else
         {
            ...
            if(_loc1_ == null)
            {
               events.dispatchEvent(new Event(HabboFriendListTrackingEvent.const_390));
            }
            else
            {
               switch(_loc1_.id)
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_1615.searchReceived(_loc2_.friends,_loc2_.method_1);
      ...
      {
         if(!this.var_698 || !this.var_337)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_698.hasUserRight("fuse_super_extended_buddylist",HabboClubLevelEnum.const_44))
         {
            _loc2_ = this.var_337.vipLimit;
         }
         else if(this.var_698.hasUserRight("fuse_extended_buddylist",HabboClubLevelEnum.const_41))
         {
