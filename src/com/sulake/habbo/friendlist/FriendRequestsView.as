package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_1721:String = "no_reqs_info";
      ...
      private var var_1851:IContainerButtonWindow;
      ...
      {
         this.var_1851 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         this.var_1852 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         this.var_1852.procedure = this.onDismissAllButtonClick;
         this.var_1851.procedure = this.onAcceptAllButtonClick;
         this.refreshButtons();
      }
      ...
      private function onDismissAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_398 && _loc4_.state != FriendRequest.const_384)
            {
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_1851,_loc1_);
         this.setEnabled(this.var_1852,_loc1_);
      }
