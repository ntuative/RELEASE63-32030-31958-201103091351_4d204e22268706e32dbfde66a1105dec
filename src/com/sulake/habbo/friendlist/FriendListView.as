package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1712:String = "noconvinfo";
      
      private static const const_1711:String = "messageinput";
      ...
      private function prepare() : void
      {
         ...
         this.var_893 = IWindowContainer(this.var_16.content.findChildByName("main_content"));
         this.var_244 = IWindowContainer(this.var_16.content.findChildByName("footer"));
         this.var_1418.prepare(this.var_893);
         this.var_16.procedure = this.onWindow;
         this.var_16.content.setParamFlag(HabboWindowParam.const_1207,false);
         this.var_16.content.setParamFlag(HabboWindowParam.const_1166,true);
         this.var_16.header.setParamFlag(HabboWindowParam.const_890,false);
         this.var_16.header.setParamFlag(HabboWindowParam.const_701,true);
         this.var_16.content.setParamFlag(HabboWindowParam.const_890,false);
         ...
         this.var_1419 = ITextWindow(this.var_16.findChildByName("info_text"));
         this.var_1419.text = "";
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = this.var_1808 == -1 ? 0 : int(this.var_16.height - this.var_1808);
         var _loc4_:int = this.var_1809 == -1 ? 0 : int(this.var_16.width - this.var_1809);
      ...
      private function refreshWindowSize() : void
      {
         ...
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1218,this._friendList.tabs.findSelectedTab() != null);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_890,false);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1207,false);
         ...
         this.var_1808 = this.var_16.height;
         this.var_1809 = this.var_16.width;
