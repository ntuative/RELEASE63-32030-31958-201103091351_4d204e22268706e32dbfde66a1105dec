package com.sulake.habbo.friendlist
{
   ...
   public class SearchView implements ITabView, ISearchView
   {
      ...
      private var var_727:ITextFieldWindow;
      ...
      public function getEntryCount() : int
      {
         ...
         return this._friendList.searchResults.friends.length + this._friendList.searchResults.method_1.length;
      }
      ...
      {
         this.var_727 = ITextFieldWindow(param1.findChildByName("search_str"));
         this.var_727.procedure = this.onSearchInput;
         this.var_727.addEventListener(WindowKeyboardEvent.const_194,this.onSearchStrInput);
      ...
      public function refreshList() : void
      {
         ...
         while(true)
         {
            ...
            else if(_loc2_ <= _loc1_.friends.length + _loc1_.method_1.length + 1)
            {
               _loc4_ = _loc1_.method_1[_loc2_ - 2 - _loc1_.friends.length];
      ...
      private function refreshShading() : void
      {
         ...
         {
            this.var_60.getListItemAt(_loc1_).color = this._friendList.laf.getRowShadingColor(FriendListTab.const_406,_loc1_ % 2 == 1);
            _loc1_++;
         }
      }
      ...
      {
         if(this._friendList.searchResults.method_1.length == 0)
         {
            return "${friendlist.search.noothersfound}";
         }
         this._friendList.registerParameter("friendlist.search.otherscaption","cnt","" + this._friendList.searchResults.method_1.length);
      ...
      private function onSearchEntry(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            this.var_437.setData(_loc3_.isAvatarOnline,_loc3_.avatarName,_loc3_.avatarMotto,_loc3_.avatarFigure,_loc3_.lastOnlineDate,_loc3_.realName);
            this.var_437.showPopup(this._friendList.view.mainWindow,IWindowContainer(param2));
         }
      ...
      private function onSearchStrInput(param1:Event) : void
      {
         ...
         {
            _loc5_ = 25;
            _loc6_ = this.var_727.text;
            if(_loc6_.length > _loc5_)
            {
               this.var_727.text = _loc6_.substring(0,_loc5_);
            }
         }
      }
      ...
      {
         var _loc1_:String = this.var_727.text;
