package com.sulake.habbo.quest
{
   ...
   public class Quest implements IDisposable
   {
      ...
      private var var_1366:uint = 7645971;
      
      private var var_1714:uint = 6710886;
      ...
      public function update(param1:QuestMessageData) : void
      {
         ...
         this.var_1674 = param1.roomItemTypeName;
         this.var_1675 = param1.rewardCurrencyAmount;
         this.var_1713 = new Date();
         this.var_1713.setTime(param1.endDateTimeStamp);
         this.var_713 = param1.localizationCode;
         this.var_2331 = param1.questBadgeAchievementTypeId;
         this.updateView();
      }
      ...
      private function createView() : void
      {
         switch(this.var_388)
         {
            case QuestStatusEnum.const_46:
               ...
               break;
            case QuestStatusEnum.const_422:
            ...
            case QuestStatusEnum.const_191:
               ...
               break;
            case QuestStatusEnum.const_713:
         ...
         if(_loc1_ != null)
         {
            this.var_1366 = _loc1_.color;
         }
         var _loc2_:IWindow = this.var_17.findChildByTag("SELECTION_BORDER");
         if(_loc2_ != null)
         {
            this.var_1714 = _loc2_.color;
            this.var_194 = _loc2_;
         }
         else
         {
            this.var_194 = this.var_17;
         }
         this.var_194.color = this.var_1366;
      }
      ...
      private function updateView() : void
      {
         ...
         var _loc3_:String = ["quest",this.var_61.code,this.var_713].join("_");
      ...
      private function itemGridEventProc(param1:Event, param2:IWindow = null) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            if(!this.var_189)
            {
               this.var_194.color = this.var_1714;
            }
         }
