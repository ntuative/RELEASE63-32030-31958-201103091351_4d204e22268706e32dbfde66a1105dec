package com.sulake.habbo.quest
{
   ...
   public class IncomingMessages implements IDisposable
   {
      ...
      private var var_1569:IAlertDialog;
      ...
      public function IncomingMessages(param1:HabboQuestEngine)
      {
         super();
         this.var_64 = param1;
         this._communication = this.var_64.communication;
      ...
      private function onQuestList(param1:IMessageEvent) : void
      {
         ...
         this.var_64.controller.openCampaign(_loc2_.campaignCode,_loc2_.activityPointType,_loc2_.quests);
      }
      ...
      private function onQuestAccepted(param1:IMessageEvent) : void
      {
         ...
         this.var_64.controller.questAccepted(_loc2_.campaignCode,_loc2_.questData);
      }
      ...
      private function onQuestCompleted(param1:IMessageEvent) : void
      {
         ...
         this.var_64.controller.questCompleted(_loc2_.campaignCode,_loc2_.questData);
      }
      ...
      private function onAvailableQuestCampaigns(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:String = this.var_64.configuration.getKey("questing.excludedCampaignCode","");
         if(this.var_64.defaultCampaignCode == _loc4_)
         {
            this.var_64.defaultCampaignCode = "";
         }
         ...
         else
         {
            ...
            this.var_64.controller.openCampaigns(_loc3_);
         }
      }
      ...
      private function onExpiredQuestCampaigns(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_64.controller.openCampaigns(_loc2_.campaignCodes,true);
         }
      }
      
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         if(this.var_64.toolbar != null && this.var_64.configuration != null)
         {
            this.var_64.defaultCampaignCode = this.getCampaignCode();
      ...
      {
         var _loc1_:String = this.var_64.configuration.getKey("questing.defaultCampaign","");
         var _loc2_:String = this.var_64.configuration.getKey("questing.defaultCampaign.override","");
         var _loc3_:String = this.var_64.configuration.getKey("questing.excludedCampaignCode","");
      ...
      private function setQuestingEnabled(param1:Boolean) : void
      {
         ...
         var _loc4_:* = null;
         if(this.var_64.toolbar != null)
         {
            if(param1)
            {
               _loc2_ = this.var_64.defaultCampaignCode;
               _loc3_ = _loc2_.length > 0 && _loc2_ == this.var_64.configuration.getKey("questing.defaultCampaign.override","");
               _loc4_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_92,HabboToolbarIconEnum.QUESTS);
               _loc4_.iconState = "0";
               this.var_64.toolbar.events.dispatchEvent(_loc4_);
               if(this.var_64.habboHelp && _loc3_)
               {
                  this.var_64.habboHelp.setWelcomeScreenCategory(HabboToolbarIconEnum.QUESTS,"welcome.screen.title.questing","welcome.screen.message.questing");
               }
               this._communication.getHabboMainConnection(null).send(new GetExpiredQuestCampaignsMessageComposer());
            }
            else
            {
               this.var_64.toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_149,HabboToolbarIconEnum.QUESTS));
            }
         }
      }
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.var_64.controller.updatePurse();
      }
