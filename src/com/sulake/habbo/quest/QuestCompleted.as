package com.sulake.habbo.quest
{
   ...
   public class QuestCompleted implements IDisposable
   {
      ...
      {
         this.var_215 = IFrameWindow(this.var_61.controller.questEngine.getXmlWindow("QuestCompletedDialog"));
         ...
         this.var_215.findChildByName("description").caption = this.var_61.controller.questEngine.localization.getKey(_loc4_ + ".completed.desc");
         this.var_215.findChildByName("reward.currency.desc").caption = this.var_61.controller.questEngine.localization.getKey(_loc3_ + ".completed.currency");
