package com.sulake.habbo.quest
{
   ...
   public class QuestController implements IDisposable
   {
      ...
      {
         if(this.var_544 != MODE_TABS)
         {
            this.var_544 = MODE_NO_TABS;
         }
         this.detachCampaign();
      ...
      private function attachCampaign() : void
      {
         ...
         this.var_292.attachTo(this.var_1119);
      ...
      private function prepareWindow() : void
      {
         ...
         this._window.center();
         this.var_1119 = this._window.findChildByName("content") as IWindowContainer;
      }
      ...
      private function refreshTabs() : void
      {
         ...
         for each(_loc4_ in this.var_156.getKeys())
         {
            ...
            if(!_loc2_)
            {
               ...
               _loc2_ = this.var_64.windowManager.createWindow("tab_" + _loc4_,"${" + _loc6_ + "}",WindowType.const_426) as ITabButtonWindow;
               if(_loc3_.expired)
               {
               ...
               _loc2_.addEventListener(WindowEvent.const_61,this.onTabSelect);
            }
            _loc5_ = 4287150640;
            if(_loc3_.expired)
            {
