package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      public function RoomManager(param1:IContext, param2:uint = 0)
      {
         ...
         this.var_598 = [];
         this.var_597 = [];
         events.addEventListener(RoomContentLoadedEvent.const_391,this.onContentLoaded);
         events.addEventListener(RoomContentLoadedEvent.const_425,this.onContentLoaded);
         events.addEventListener(RoomContentLoadedEvent.const_811,this.onContentLoaded);
      }
      ...
      {
         var _loc1_:* = null;
         if(this.var_596 == null || this.var_491 == null)
         {
            return;
         }
      ...
      public function initialize(param1:XML, param2:IRoomManagerListener) : Boolean
      {
         ...
         while(_loc4_ < _loc3_.length)
         {
            ...
            if(this.var_598.indexOf(_loc5_) < 0)
            {
               this.var_50.loadObjectContent(_loc5_,events);
               this.var_598.push(_loc5_);
            }
            _loc4_++;
         }
      ...
      private function processInitialContentLoad(param1:String) : void
      {
         ...
         if(this._state == const_663)
         {
            return;
         }
         if(this.var_50 == null)
         {
            this._state = const_663;
            return;
         }
         if(this.var_50.getGraphicAssetCollection(param1) != null)
         {
      ...
      private function updateObjectContent(param1:String) : void
      {
         ...
         if(this.var_50 == null || this.var_491 == null)
         {
            return;
         }
                        ...
                        if(_loc16_ == param1)
                        {
                           ...
                           if(_loc19_ != null)
                           {
                              ...
                              else
                              {
                                 ...
                                 if(this.var_157 != null)
                                 {
                                    this.var_157.objectInitialized(_loc8_,_loc14_.getId(),_loc11_);
                                 }
                              }
                           }
                           else
