package com.sulake.room.renderer.cache
{
   ...
   public class RoomObjectLocationCacheItem
   {
      ...
      {
         this.var_1106 = new Vector3d();
         super();
         this._roomObjectVariableAccurateZ = param1;
         this.var_346 = new Vector3d();
      }
      ...
      public function getScreenLocation(param1:IRoomObject, param2:IRoomGeometry) : IVector3d
      {
         ...
         if(param2.updateId != this.var_1696 || param1.getUpdateID() != this.var_2363)
         {
            this.var_2363 = param1.getUpdateID();
            if(param2.updateId != this.var_1696 || _loc4_.x != this.var_1106.x || _loc4_.y != this.var_1106.y || _loc4_.z != this.var_1106.z)
            {
               this.var_1696 = param2.updateId;
               this.var_1106.assign(_loc4_);
               _loc3_ = true;
            }
         }
         this.var_2364 = _loc3_;
         if(_loc3_)
         {
            ...
            if(isNaN(_loc6_) || _loc6_ == 0)
            {
               ...
               if(_loc7_.x != _loc4_.x || _loc7_.y != _loc4_.y)
               {
                  ...
                  if(_loc8_ != null)
                  {
                     this.var_346 = new Vector3d(_loc5_.x,_loc5_.y,_loc8_.z);
                  }
                  else
                  {
                     this.var_346.assign(_loc5_);
                  }
               }
               else
               {
            ...
            this.var_346.x = Math.round(this.var_346.x);
            this.var_346.y = Math.round(this.var_346.y);
         }
         return this.var_346;
      }
   }
