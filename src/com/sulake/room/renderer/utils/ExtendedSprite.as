package com.sulake.room.renderer.utils
{
   ...
   public class ExtendedSprite extends Bitmap
   {
      ...
      {
         if(param1 != this.var_1609 || param2 != this.var_1608)
         {
      ...
      {
         if(this.var_1313 > 255 || bitmapData == null)
         {
            return false;
         }
