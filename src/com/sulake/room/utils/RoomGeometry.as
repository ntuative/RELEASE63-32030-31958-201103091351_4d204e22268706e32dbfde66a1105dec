package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_786:Number = 64;
      
      public static const const_1036:Number = 32;
      ...
      private var var_2816:Number = -500.0;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         this.x_scale = 1;
         this.y_scale = 1;
         this.var_1796 = Math.sqrt(0.5) / Math.sqrt(0.75);
         this.z_scale = 1;
      ...
      {
         return new Vector3d(this.var_82.x * this.var_425,this.var_82.y * this.var_424,this.var_82.z * this.var_423);
      }
      
      public function get direction() : IVector3d
      {
         return new Vector3d(this.var_255.x,this.var_255.y,this.var_255.z);
      }
      
      public function set x_scale(param1:Number) : void
      {
         if(this.var_425 != param1 * this.var_1795)
         {
            this.var_425 = param1 * this.var_1795;
            ++this.var_159;
         }
      }
      ...
      {
         if(this.var_424 != param1 * this.var_1797)
         {
            this.var_424 = param1 * this.var_1797;
            ++this.var_159;
         }
      }
      ...
      {
         if(this.var_423 != param1 * this.var_1796)
         {
            this.var_423 = param1 * this.var_1796;
            ++this.var_159;
         }
      }
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         var _loc2_:Number = this.var_82.x;
         var _loc3_:Number = this.var_82.y;
         var _loc4_:Number = this.var_82.z;
         this.var_82.assign(param1);
         this.var_82.x /= this.var_425;
         this.var_82.y /= this.var_424;
         this.var_82.z /= this.var_423;
         if(this.var_82.x != _loc2_ || this.var_82.y != _loc3_ || this.var_82.z != _loc4_)
         {
            ++this.var_159;
         }
      }
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         var _loc2_:Number = this.var_255.x;
         var _loc3_:Number = this.var_255.y;
         var _loc4_:Number = this.var_255.z;
         this.var_255.assign(param1);
         if(this.var_255.x != _loc2_ || this.var_255.y != _loc3_ || this.var_255.z != _loc4_)
         {
            ++this.var_159;
         }
      ...
      private function getDisplacenent(param1:IVector3d) : IVector3d
      {
         ...
         if(this.var_495 != null)
         {
            ...
            return this.var_495.getValue(_loc2_);
         }
         return null;
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            this.var_1144.assign(_loc22_);
         }
         else
         {
            this.var_1144.assign(_loc17_);
         }
         ++this.var_159;
      }
      ...
      {
         var _loc2_:Vector3d = Vector3d.dif(param1,this.var_82);
         _loc2_.x *= this.var_425;
         _loc2_.y *= this.var_424;
         _loc2_.z *= this.var_423;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,this.var_1144);
         if(_loc3_ < this.var_2816 || _loc3_ > this.var_2817)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            _loc2_ = Vector3d.dif(param1,this.var_82);
            _loc2_.add(_loc6_);
            _loc2_.x *= this.var_425;
            _loc2_.y *= this.var_424;
            _loc2_.z *= this.var_423;
            _loc3_ = Vector3d.scalarProjection(_loc2_,this.var_1144);
         }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc8_:Vector3d = new Vector3d(this.var_82.x * this.var_425,this.var_82.y * this.var_424,this.var_82.z * this.var_423);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = this.var_144;
         var _loc11_:Vector3d = new Vector3d(param2.x * this.var_425,param2.y * this.var_424,param2.z * this.var_423);
         var _loc12_:Vector3d = new Vector3d(param3.x * this.var_425,param3.y * this.var_424,param3.z * this.var_423);
         var _loc13_:Vector3d = new Vector3d(param4.x * this.var_425,param4.y * this.var_424,param4.z * this.var_423);
      ...
      public function performZoom() : void
      {
         if(this.isZoomedIn())
         {
            this.scale = const_1036;
         }
         else
         {
            this.scale = const_786;
         }
      }
      
      public function isZoomedIn() : Boolean
      {
         return this.scale == const_786;
      }
