package com.sulake.room.object
{
   ...
   public class RoomObjectModel implements IRoomObjectModelController
   {
      ...
      public function dispose() : void
      {
         ...
         {
            for(_loc1_ in this.var_550)
            {
               delete this.var_550[_loc1_];
            }
            this.var_550 = null;
         }
      ...
      {
         var _loc2_:Array = this.var_552[param1];
         if(_loc2_ != null)
         {
            _loc2_ = _loc2_.slice();
         }
      ...
      {
         var _loc2_:Array = this.var_551[param1];
         if(_loc2_ != null)
         {
            _loc2_ = _loc2_.slice();
         }
      ...
      {
         if(this.var_1300.indexOf(param1) >= 0)
         {
            return;
         }
         if(param3)
         ...
         if(this.var_550[param1] != param2)
         {
            this.var_550[param1] = param2;
            ++this._updateID;
         }
      }
      ...
      {
         if(this.var_1299.indexOf(param1) >= 0)
         {
            return;
         }
         if(param3)
      ...
      public function setNumberArray(param1:String, param2:Array, param3:Boolean = false) : void
      {
         ...
         var _loc6_:Array = this.var_552[param1];
      ...
      public function setStringArray(param1:String, param2:Array, param3:Boolean = false) : void
      {
         ...
         var _loc6_:Array = this.var_551[param1];
         var _loc7_:Boolean = true;
         if(_loc6_ != null && _loc6_.length == _loc4_.length)
         {
            _loc5_ = _loc4_.length - 1;
