package com.sulake.room.object.logic
{
   ...
   public class ObjectLogicBase implements IRoomObjectEventHandler
   {
      ...
      private var var_359:IRoomObjectController;
      ...
      {
         if(this.var_359 == param1)
         {
            return;
         }
         if(this.var_359 != null)
         {
            this.var_359.setEventHandler(null);
         }
         if(param1 == null)
         {
            this.dispose();
         ...
         {
            this.var_359 = param1;
            this.var_359.setEventHandler(this);
         }
      }
      ...
      public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         if(param1 != null)
         {
            if(this.var_359 != null)
            {
               this.var_359.setLocation(param1.loc);
               this.var_359.setDirection(param1.dir);
            }
         }
      }
   }
